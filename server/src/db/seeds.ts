...
function seedAddons(db: Database.Database): void {
  try {
    const defaultAddons = [
      ...
      { id: 'google_list_import', name: 'Google Maps List Import', description: 'Import places from a shared Google Maps list URL. Uses an unofficial Google endpoint — disable if needed.', type: 'integration', icon: 'List', enabled: 1, sort_order: 13 },
