...
function seedAddons(db: Database.Database): void {
  try {
    const defaultAddons = [
      ...
      { id: 'elevation', name: 'Elevation', description: 'Show elevation profile chart on OSRM routes', type: 'trip', icon: 'TrendingUp', enabled: 1, sort_order: 3 },
      ...
      { id: 'google_list_import', name: 'Google Maps List Import', description: 'Import places from a shared Google Maps list URL. Uses an unofficial Google endpoint — disable if needed.', type: 'feature', icon: 'List', enabled: 1, sort_order: 13 },
      { id: 'link_preview', name: 'Link Previews', description: 'Fetch metadata for URLs shared in Collab. The server makes outbound requests to external sites.', type: 'feature', icon: 'Link2', enabled: 1, sort_order: 14 },
