...
export function createPlace(
  ...
  body: {
    ...
    category_id?: number; price?: number; currency?: string; price_level?: number;
  ...
  const {
    name, description, lat, lng, address, category_id, price, currency, price_level,
    place_time, end_time,
  ...
  const result = db.prepare(`
    INSERT INTO places (trip_id, name, description, lat, lng, address, category_id, price, currency, price_level,
      place_time, end_time,
  ...
  `).run(
    ...
    category_id || null, price || null, currency || null, price_level || null,
...
export function updatePlace(
  ...
  `).run(
    ...
    currency || null,
    price_level !== undefined ? price_level : existingPlace.price_level,
