        ...
        {form.type === 'hotel' && (
          <>
            ...
            <div className="grid grid-cols-4 gap-3">
              ...
              <div>
                <label style={labelStyle}>{t('day.checkInUntil')}</label>
                <CustomTimePicker value={form.meta_check_in_end_time} onChange={v => set('meta_check_in_end_time', v)} placeholder="22:00" />
              </div>
              <div>
