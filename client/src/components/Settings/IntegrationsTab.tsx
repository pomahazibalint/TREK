...
import { Trash2, Copy, Terminal, Plus, Check, RefreshCw, ExternalLink } from 'lucide-react'
import { authApi } from '../../api/client'
import { oauthApi, type OAuthSessionInfo } from '../../api/oauthApi'
      ...
      {mcpEnabled && (
        <Section title={t('settings.mcp.title')} icon={Terminal}>
          ...
          <div>
            ...
            {sessionsLoading ? (
              <p className="text-sm py-3 text-center" style={{ color: 'var(--text-tertiary)' }}>Loading…</p>
            ) : sessions.length === 0 ? (
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <div>
                ...
                <span className="ml-2 text-xs px-1.5 py-0.5 rounded"
                  ...
                  {t('settings.mcp.legacyDeprecated')}
                </span>
              </div>
            ...
            <p className="text-xs mb-2" style={{ color: 'var(--text-tertiary)' }}>{t('settings.mcp.apps.legacyNotice')}</p>
            ...
            {!mcpCreatedToken ? (
              ...
              <>
                ...
                <div className="relative">
                  <pre className="p-3 pr-10 rounded-lg text-xs font-mono break-all border whitespace-pre-wrap"
                    style={{ background: 'var(--bg-secondary)', borderColor: 'var(--border-primary)', color: 'var(--text-primary)' }}>
                    {mcpCreatedToken}
                  </pre>
