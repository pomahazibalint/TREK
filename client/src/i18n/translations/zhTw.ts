const zhTw: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.showPlaceDescription': '顯示地點描述',
  ...
  'forgotPassword.title': '重置密碼',
  'forgotPassword.subtitle': '輸入您的信箱，我們將發送重置連結。',
  'forgotPassword.email': '電子郵件地址',
  'forgotPassword.submit': '發送重置連結',
  'forgotPassword.sending': '發送中…',
  'forgotPassword.successTitle': '請查看您的收件匣',
  'forgotPassword.successMsg': '如果該信箱已註冊帳號，重置連結已發送。',
  'forgotPassword.backToLogin': '← 返回登入',
  'resetPassword.title': '設定新密碼',
  'resetPassword.subtitle': '在下方輸入您的新密碼。',
  'resetPassword.password': '新密碼',
  'resetPassword.submit': '設定密碼',
  'resetPassword.submitting': '設定密碼中…',
  'resetPassword.successTitle': '密碼已更新',
  'resetPassword.successMsg': '您的密碼已更改。您現在可以登入了。',
  'resetPassword.signIn': '前往登入',
  'resetPassword.invalidToken': '此重置連結無效或已過期。',
  'resetPassword.mfaRequired': '您的帳戶已啟用雙重認證。',
  'resetPassword.mfaCode': '驗證器代碼',
  ...
  'admin.mapsKillSwitches': 'API 開關',
  'admin.mapsAutocompleteDisabled': '停用地點搜尋',
  'admin.mapsAutocompleteDisabledHint': '封鎖所有傳送至 Google 和 Nominatim 的自動完成/搜尋請求',
  'admin.mapsDetailsDisabled': '停用地點詳情',
  'admin.mapsDetailsDisabledHint': '封鎖地點詳情查詢（評分、評論、營業時間）',
  ...
  // File Types
  'admin.authMethods': '驗證方式',
  'admin.passwordLogin': '密碼登入',
  'admin.passwordLoginHint': '允許用戶使用郵箱和密碼登入',
  'admin.oidcLogin': 'SSO 登入',
  'admin.oidcLoginHint': '允許用戶通過已設定的 OIDC 提供商登入',
  'admin.oidcRegistration': 'SSO 註冊',
  'admin.oidcRegistrationHint': '允許在首次 SSO 登入時建立新用戶',
  'admin.envOverrideHint': '密碼登入由 OIDC_ONLY 環境變數控制，無法在此更改。',
  'admin.defaultLanguage': '預設語言',
  'admin.defaultLanguageHint': '顯示給未登入用戶的語言。訪客仍可自行更改。',
  'admin.defaultLanguageAuto': '自動偵測（瀏覽器語言）',
  ...
  'admin.collab.chat': '即時聊天',
  'admin.collab.chatHint': '為所有成員提供即時旅行聊天',
  'admin.collab.notes': '共享筆記',
  'admin.collab.notesHint': '附加到旅行的協作筆記',
  'admin.collab.polls': '投票',
  'admin.collab.pollsHint': '建立並投票決定團隊事項',
  'admin.bagTracking.subtitle': '為打包物品啟用重量和行李分配',
  'admin.atlas.geoTitle': '區域邊界資料',
  'admin.atlas.geoHint': '更新地圖集上使用的區域邊界 GeoJSON 檔案',
  'admin.atlas.geoRefresh': '立即更新',
  'admin.atlas.geoRefreshing': '更新中…',
  'admin.atlas.geoRefreshed': '區域邊界資料已更新',
  'admin.atlas.geoRefreshError': '區域邊界資料更新失敗',
  ...
  'admin.addons.integrationHint': '後端服務和 API 整合',
  ...
  'vacay.inviteCalendarName': '日曆：',
  'vacay.calendars': '日曆',
  'vacay.myCalendar': '我的日曆',
  'vacay.newCalendar': '新增日曆',
  'vacay.calendarName': '日曆名稱',
  'vacay.calendarNamePlaceholder': '例如 工作團隊、家庭',
  'vacay.createCalendar': '建立',
  'vacay.leaveCalendar': '離開日曆',
  'vacay.deleteCalendar': '刪除日曆',
  'vacay.leaveCalendarHint': '將自己從此共用日曆中移除。你的個人條目不受影響。',
  'vacay.deleteCalendarHint': '永久刪除此日曆並移除所有成員。',
  'vacay.leaveAction': '離開',
  'vacay.deleteAction': '刪除',
  'vacay.shareDetailsDefault': '在共用日曆中共用詳情',
  'vacay.shareDetailsDefaultHint': '適用於新條目。現有條目不會更改。',
  'vacay.busyOnly': '忙碌',
  'vacay.eventName': '活動名稱',
  'vacay.location': '地點',
  'vacay.note': '備註',
  'vacay.optional': '可選',
  'vacay.shareDetails': '共用詳情',
  'vacay.shareDetailsHint': '活動名稱、地點和備註對其他日曆成員可見',
  'vacay.removeEntry': '移除',
  'vacay.markThrough': '標記至',
  'vacay.daysSelected': '{n} 天',
  'vacay.mixedValues': '多個屬性…',
  'vacay.fusedWith': '已合併',
  'vacay.you': '你',
  'vacay.noData': '暫無資料',
  ...
  'dayplan.duplicateDay': '複製當天',
  'dayplan.pdfError': 'PDF 匯出失敗',
  'dayplan.transportWalking': '步行',
  'dayplan.transportCycling': '騎行',
  'dayplan.transportDriving': '駕車',
  ...
  'places.formPhone': '電話',
  'places.formPrice': '價格',
  'places.formPriceVisit': '價格（本次遇覽）',
  'places.whoIsGoing': '誰去？',
  'places.everyoneGoing': '所有人都去 — 點擊排除某人',
  'places.formDuration': '預計遊覽時長（分鐘）',
  'places.formTransportMode': '前往方式',
  'places.transportWalking': '步行',
  'places.transportCycling': '騎行',
  'places.transportDriving': '駕車',
  ...
  'memories.dateSyncLabel': '日期同步',
  'memories.lastSynced': '上次同步',
  'memories.photos': '張照片',
  ...
  'dashboard.dayCountHint': '未設定旅行日期時，計劃的天數。',
  'settings.tabs.display': '顯示',
  'settings.tabs.map': '地圖',
  'settings.tabs.notifications': '通知',
  'settings.tabs.integrations': '整合',
  'settings.tabs.account': '帳號',
  'settings.tabs.about': '關於',
  'settings.about.reportBug': '回報問題',
  'settings.about.reportBugHint': '發現問題了嗎？讓我們知道',
  'settings.about.featureRequest': '功能請求',
  'settings.about.featureRequestHint': '建議一個新功能',
  'settings.about.wikiHint': '文件與指南',
  'settings.about.description': 'TREK 是一款自架旅行規劃工具，從最初的想法到最後的回憶，幫助你組織旅行。日程規劃、預算、打包清單、照片等——全在一個地方，在你自己的伺服器上。',
  'settings.about.madeWith': '由',
  'settings.about.madeBy': '由 Maurice 和不斷壯大的開源社群製作。',
  'atlas.confirmUnmarkRegion': '將此地區從已訪問清單中移除？',
  'atlas.markRegionVisitedHint': '將此地區加入已訪問清單',
  'trip.tabs.lists': '清單',
  ...
  'reservations.budgetHint': '儲存時將自動建立預算項目。',
  'reservations.departureDate': '出發日',
  'reservations.arrivalDate': '到達日',
  'reservations.departureTime': '出發時間',
  'reservations.arrivalTime': '到達時間',
  'reservations.pickupDate': '取車日',
  'reservations.returnDate': '還車日',
  ...
  'settings.notificationPreferences.noChannels': '未設定通知渠道。請聯絡管理員設定電子郵件或 Webhook 通知。',
  'settings.webhookUrl.label': 'Webhook URL',
  'settings.webhookUrl.placeholder': 'https://discord.com/api/webhooks/...',
  'settings.webhookUrl.hint': '輸入你的 Discord、Slack 或自訂 Webhook URL 以接收通知。',
  ...
  'admin.notifications.inappPanel.hint': '應用內通知始終啟用，無法全域停用。',
  'admin.notifications.adminWebhookPanel.title': '管理員 Webhook',
  'admin.notifications.adminWebhookPanel.hint': '此 Webhook 專用於管理員通知（如版本更新）。它與每位使用者的 Webhook 獨立，設定後會自動觸發。',
  ...
  'admin.notifications.adminWebhookPanel.alwaysOnHint': '設定 URL 後，管理員 Webhook 始終觸發',
  'admin.notifications.adminNotificationsHint': '設定哪些渠道傳送管理員專用通知（如版本更新）。',
  'admin.tabs.notifications': '通知',
  'notifications.versionAvailable.title': '有更新可用',
  ...
  'notif.test.boolean.text': '你接受這則測試通知嗎？',
  ...
  'notif.todo_due.title': '今日待辦到期',
  'notif.todo_due.text': '{name} 今天在 {trip} 中到期。',
  'notif.vacay_invite.title': 'Vacay 融合邀請',
  'notif.vacay_invite.text': '{actor} 邀請你合併假期計劃',
  ...
  'notif.packing_tagged.title': '行李清單指派',
  'notif.packing_tagged.text': '{actor} 將你指派至 {trip} 中的 {category}',
  ...
  'notif.dev.unknown_event.text': '事件類型 "{event}" 未在 EVENT_NOTIFICATION_CONFIG 中登記',
  'budget.linkedToReservation': '已關聯預訂 — 請在那裡編輯名稱',
  'packing.saveAsTemplate': '儲存為範本',
  'packing.templateName': '範本名稱',
  'packing.templateSaved': '打包清單已儲存為範本',
  'nav.offline': '離線',
  'dashboard.settlementCurrency': '結算貨幣',
  'dashboard.settlementCurrencyHint': '所有多貨幣費用將轉換為此貨幣進行結算。一旦存在外幣費用，則無法更改。',
  'places.importCsv': 'CSV',
  'places.csvImported': '已從 CSV 匯入 {count} 個地點',
  'places.csvError': 'CSV 匯入失敗',
  'budget.table.members': '成員',
  'budget.addExpense': '新增費用',
  'budget.editExpense': '編輯費用',
  'budget.modal.owes': '欠款',
  'budget.modal.paid': '已付',
  'budget.modal.tip': '小費',
  'budget.modal.equalSplit': '平均分攤',
  'budget.modal.remaining': '剩餘',
  'budget.modal.balanced': '已平衡',
  'budget.modal.notReconciled': '尚未對帳',
  'budget.modal.originalAmount': '原始金額',
  'budget.modal.referenceAmount': '參考金額',
  'budget.modal.exchangeRate': '匯率',
  'budget.modal.fetchRate': '取得匯率',
  'budget.modal.currency': '貨幣',
  'budget.modal.receipts': '收據',
  'budget.modal.uploadReceipt': '附件',
  'budget.modal.noReceipts': '沒有附加收據',
  'budget.charged': '已收費',
  'budget.balance': '餘額',
  'planner.mayBeClosed': '此時可能已關閉',
  'memories.notConnectedMultipleHint': '請在設定中連接以下任一照片提供商：{provider_names}，以便為此行程新增照片。',
  ...
  'undo.importCsv': 'CSV 匯入',
  'budget.settle': '結算預算',
  'budget.settledBadge': '由 {name} 於 {date} 結算',
  'budget.settledBanner': '此預算已結算。費用為唯讀狀態。',
  'budget.settlement.previewTitle': '結算預算',
  'budget.settlement.previewSubtitle': '查看誰需要支付多少，然後通知所有人。',
  'budget.settlement.flows': '所需付款',
  'budget.settlement.noFlows': '全部平衡——無需付款。',
  'budget.settlement.unresolvedDrafts': '未解決的草稿',
  'budget.settlement.unresolvedDraftsHint': '結算前請先處理這些計劃費用。',
  'budget.settlement.convertDraft': '轉換',
  'budget.settlement.discardDraft': '捨棄',
  'budget.settlement.settleBtn': '結算並通知',
  'budget.settlement.confirmText': '此操作永久且不可撤銷。費用將變為唯讀。',
  'budget.settlement.confirmBtn': '確認',
  'budget.settlement.alreadySettled': '此預算已經結算。',
  'budget.settlement.hasDrafts': '結算前請先處理所有草稿。',
  'notif.budget_settlement.title': '預算已結算',
  'notif.budget_settlement.text': '{actor} 已結算 {trip} 的預算',
  'notif.action.ive_paid': '我已付款',
  'notif.action.dismiss': '忽略',
  'notif.action.view_budget': '查看預算',
  'settings.notifyBudgetSettlement': '預算結算',
  'tripBadge.budgetUnsettled': '預算未結算',
  'tripBadge.budgetUnsettled.detail': '此行程已結束，但預算尚未結算。',
  'tripBadge.budgetUnsettled.action': '查看預算',
  'tripBadge.calendarConflict': '日曆衝突',
  'tripBadge.calendarConflict.detail': '您的日曆中有與此行程日期重疊的事件。',
  'tripBadge.calendarConflict.action': '查看日曆',
  'tripBadge.missingDates': '缺少日期',
  'tripBadge.missingDates.detail': '新增旅行日期以偵測衝突並啟用提醒。',
  'tripBadge.missingDates.action': '編輯行程',
  'tripBadge.upcomingSoon': '{days} 天後出發',
  'tripBadge.upcomingSoon.detail': '您的行程為空——是時候計劃了！',
  'tripBadge.upcomingSoon.action': '開啟規劃器',
  'tripBadge.emptyItinerary': '暫無行程',
  'tripBadge.emptyItinerary.detail': '沒有為任何一天計劃活動。',
  'tripBadge.emptyItinerary.action': '開啟規劃器',
  'tripBadge.more': '+{count} 更多',
  'trip.loading.budget': '載入預算中...',
  'trip.loading.reservations': '載入預訂中...',
  'trip.loading.packing': '載入打包清單中...',
  'trip.loading.files': '載入檔案中...',
  'trip.loading.collab': '載入訊息中...',
  'trip.loading.memories': '載入回憶中...',
  'trip.myPreferences': '我的偏好',
  'trip.addToCalendar': '新增至我的日曆',
  'trip.addToCalendarHint': '在您的個人假期日曆中封鎖這些日期。',
  'trip.calendarSyncing': '同步中...',
  'settings.notifyTodoDue': '待辦事項今日到期',
  'collab.notes.expand': '展開',
  'dayplan.dayDetail': '日程詳情',
  'dayplan.toast.routeError': '路線計算失敗',
  'trip.toast.loadError': '載入行程失敗',
  'trip.toast.tripUpdated': '行程已更新',
  'admin.mapsAutocompleteNominatimOnly': '使用 Nominatim 進行自動完成',
  'admin.mapsAutocompleteNominatimOnlyHint': '即使設定了 Google 金鑰，也將自動完成路由到 OpenStreetMap，以降低 API 成本',
  'settings.mcp.tabs.apps': 'OAuth 2.1 應用程式',
  'settings.mcp.tabs.legacyTokens': '舊版令牌',
  'settings.mcp.tabs.sessions': '活躍工作階段',
  'settings.mcp.apps.empty': '尚無 OAuth 應用程式。建立一個以安全連接 AI 用戶端。',
  'settings.mcp.apps.create': '建立應用程式',
  'settings.mcp.apps.name': '應用程式名稱',
  'settings.mcp.apps.namePlaceholder': '如 Claude.ai、我的自動化',
  'settings.mcp.apps.redirectUris': '重新導向 URI',
  'settings.mcp.apps.redirectUrisHint': '每行一個。必須使用 https://、http://localhost 或自訂通訊協定。',
  'settings.mcp.apps.isPublic': '公開用戶端（無密鑰，僅 PKCE）',
  'settings.mcp.apps.scopes': '允許的權限',
  'settings.mcp.apps.preset': '預設：',
  ...
  'settings.mcp.apps.preset.readOnly': '唯讀',
  'settings.mcp.apps.created': '應用程式已建立',
  'settings.mcp.apps.createError': '建立應用程式失敗',
  'settings.mcp.apps.deleted': '應用程式已刪除',
  'settings.mcp.apps.deleteError': '刪除應用程式失敗',
  'settings.mcp.apps.secretOnce': '用戶端密鑰（僅顯示一次）',
  'settings.mcp.apps.secretWarning': '請立即儲存此密鑰——無法找回。',
  'settings.mcp.apps.rotated': '密鑰已輪換',
  'settings.mcp.apps.rotateError': '輪換密鑰失敗',
  'settings.mcp.apps.rotate': '輪換密鑰',
  'settings.mcp.apps.delete': '刪除',
  'settings.mcp.apps.publicBadge': '公開',
  'settings.mcp.apps.confidentialBadge': '機密',
  'settings.mcp.apps.legacyNotice': '新連線應使用上方的 OAuth 2.1 應用程式。',
  'settings.mcp.apps.modal.createTitle': '建立 OAuth 應用程式',
  'settings.mcp.apps.modal.done': '完成',
  'settings.mcp.apps.modal.creating': '建立中…',
  'settings.mcp.apps.modal.deleteTitle': '刪除應用程式',
  'settings.mcp.apps.modal.deleteMessage': '此應用程式的所有令牌和工作階段將立即撤銷。',
  'settings.mcp.sessions.empty': '無活躍 OAuth 工作階段。',
  'settings.mcp.sessions.revoke': '撤銷',
  'settings.mcp.sessions.revoked': '工作階段已撤銷',
  'settings.mcp.sessions.revokeError': '撤銷工作階段失敗',
  'settings.mcp.sessions.scopes': '權限',
  'settings.mcp.sessions.expires': '過期',
  'settings.mcp.legacyDeprecated': '已棄用',
  'settings.mcp.oauthAppsAdminNote': 'AI 用戶端的 OAuth 2.1 應用程式在管理面板中設定。',
  'admin.tabs.oauthApps': 'OAuth 2.1 應用程式',
  'admin.oauthApps.title': 'OAuth 2.1 應用程式',
  'admin.oauthApps.subtitle': '註冊 OAuth 用戶端，使 AI 工具（Claude.ai、ChatGPT 等）能夠連線到 MCP 端點。',
  'admin.oauthApps.registered': '已註冊的應用程式',
}
