const ru: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.showPlaceDescription': 'Показывать описание места',
  ...
  'forgotPassword.email': 'Адрес электронной почты',
  ...
  'forgotPassword.successMsg': 'Если аккаунт с таким email существует, ссылка для сброса была отправлена.',
  'forgotPassword.backToLogin': '← Вернуться к входу',
  'resetPassword.title': 'Установить новый пароль',
  'resetPassword.subtitle': 'Введите новый пароль ниже.',
  'resetPassword.password': 'Новый пароль',
  'resetPassword.submit': 'Установить пароль',
  'resetPassword.submitting': 'Установка пароля\u2026',
  'resetPassword.successTitle': 'Пароль обновлён',
  'resetPassword.successMsg': 'Ваш пароль изменён. Теперь вы можете войти.',
  'resetPassword.signIn': 'Перейти ко входу',
  'resetPassword.invalidToken': 'Эта ссылка для сброса недействительна или истекла.',
  'resetPassword.mfaRequired': 'На вашем аккаунте включена двухфакторная аутентификация.',
  'resetPassword.mfaCode': 'Код аутентификатора',
  ...
  'admin.mapsKillSwitches': 'Аварийное отключение API',
  'admin.mapsAutocompleteDisabled': 'Отключить поиск мест',
  'admin.mapsAutocompleteDisabledHint': 'Блокировать все запросы автодополнения/поиска к Google и Nominatim',
  'admin.mapsDetailsDisabled': 'Отключить детали мест',
  'admin.mapsDetailsDisabledHint': 'Блокировать запросы деталей мест (рейтинги, отзывы, часы работы)',
  ...
  // File Types
  'admin.authMethods': 'Методы аутентификации',
  'admin.passwordLogin': 'Вход по паролю',
  'admin.passwordLoginHint': 'Разрешить пользователям входить с email и паролем',
  'admin.oidcLogin': 'Вход через SSO',
  'admin.oidcLoginHint': 'Разрешить вход через настроенный OIDC-провайдер',
  'admin.oidcRegistration': 'Регистрация через SSO',
  'admin.oidcRegistrationHint': 'Разрешить создание новых пользователей при первом входе через SSO',
  'admin.envOverrideHint': 'Вход по паролю управляется переменной среды OIDC_ONLY и не может быть изменён здесь.',
  'admin.defaultLanguage': 'Язык по умолчанию',
  'admin.defaultLanguageHint': 'Язык для неавторизованных пользователей. Посетители могут его изменить.',
  'admin.defaultLanguageAuto': 'Автоопределение (язык браузера)',
  ...
  'admin.collab.chat': 'Живой чат',
  'admin.collab.chatHint': 'Чат путешествия в реальном времени для всех участников',
  'admin.collab.notes': 'Общие заметки',
  'admin.collab.notesHint': 'Общие заметки, прикреплённые к путешествию',
  'admin.collab.polls': 'Опросы',
  'admin.collab.pollsHint': 'Создавать групповые решения и голосовать за них',
  'admin.bagTracking.subtitle': 'Включить вес и привязку к багажу для вещей',
  'admin.atlas.geoTitle': 'Данные границ регионов',
  'admin.atlas.geoHint': 'Обновляет файл GeoJSON границ регионов, используемый на карте Атласа',
  'admin.atlas.geoRefresh': 'Обновить сейчас',
  'admin.atlas.geoRefreshing': 'Обновление…',
  'admin.atlas.geoRefreshed': 'Данные границ регионов обновлены',
  'admin.atlas.geoRefreshError': 'Не удалось обновить данные границ регионов',
  ...
  'admin.addons.integrationHint': 'Фоновые сервисы и API-интеграции',
  ...
  'vacay.inviteCalendarName': 'Календарь:',
  'vacay.calendars': 'Календари',
  'vacay.myCalendar': 'Мой Календарь',
  'vacay.newCalendar': 'Новый Календарь',
  'vacay.calendarName': 'Название календаря',
  'vacay.calendarNamePlaceholder': 'напр. Рабочая команда, Семья',
  'vacay.createCalendar': 'Создать',
  'vacay.leaveCalendar': 'Покинуть Календарь',
  'vacay.deleteCalendar': 'Удалить Календарь',
  'vacay.leaveCalendarHint': 'Удалить себя из этого общего календаря. Ваши личные записи не затрагиваются.',
  'vacay.deleteCalendarHint': 'Окончательно удалить этот календарь и убрать всех участников.',
  'vacay.leaveAction': 'Покинуть',
  'vacay.deleteAction': 'Удалить',
  'vacay.shareDetailsDefault': 'Делиться подробностями в общих календарях',
  'vacay.shareDetailsDefaultHint': 'Применяется к новым записям. Существующие записи не изменяются.',
  'vacay.busyOnly': 'Занят',
  'vacay.eventName': 'Название события',
  'vacay.location': 'Место',
  'vacay.note': 'Заметка',
  'vacay.optional': 'Необязательно',
  'vacay.shareDetails': 'Поделиться деталями',
  'vacay.shareDetailsHint': 'Название, место и заметка видны другим участникам календаря',
  'vacay.removeEntry': 'Удалить',
  'vacay.markThrough': 'Отметить до',
  'vacay.daysSelected': '{n} дней',
  'vacay.mixedValues': 'Несколько значений…',
  ...
  'dayplan.duplicateDay': 'Дублировать день',
  'dayplan.pdfError': 'Ошибка экспорта PDF',
  'dayplan.transportWalking': 'Пешком',
  'dayplan.transportCycling': 'Велосипед',
  'dayplan.transportDriving': 'Машина',
  ...
  'places.formPhone': 'Телефон',
  'places.formPrice': 'Цена',
  'places.formPriceVisit': 'Цена (этот визит)',
  'places.whoIsGoing': 'Кто идёт?',
  'places.everyoneGoing': 'Все идут — нажмите, чтобы исключить кого-то',
  'places.formDuration': 'Длительность визита (мин)',
  'places.formTransportMode': 'Как добраться',
  'places.transportWalking': 'Пешком',
  'places.transportCycling': 'Велосипед',
  'places.transportDriving': 'На машине',
  ...
  'memories.dateSyncLabel': 'Синхронизация по датам',
  'memories.lastSynced': 'Последняя синхронизация',
  ...
  'notif.todo_due.title': 'Задача на сегодня',
  'notif.todo_due.text': '{name} истекает сегодня в {trip}.',
  ...
  'budget.linkedToReservation': 'Привязано к бронированию — редактируйте название там',
  ...
  'nav.offline': 'Офлайн',
  'dashboard.settlementCurrency': 'Расчётная валюта',
  'dashboard.settlementCurrencyHint': 'Все расходы в нескольких валютах будут конвертированы в эту валюту для расчёта. Нельзя изменить после добавления расходов в иностранной валюте.',
  'places.importCsv': 'CSV',
  'places.csvImported': '{count} мест импортировано из CSV',
  'places.csvError': 'Ошибка импорта CSV',
  'budget.table.members': 'Участники',
  'budget.addExpense': 'Добавить расход',
  'budget.editExpense': 'Изменить расход',
  'budget.modal.owes': 'Должен',
  'budget.modal.paid': 'Оплачено',
  'budget.modal.tip': 'Чаевые',
  'budget.modal.equalSplit': 'Равное разделение',
  'budget.modal.remaining': 'остаток',
  'budget.modal.balanced': 'Сбалансировано',
  'budget.modal.notReconciled': 'Ещё не согласовано',
  'budget.modal.originalAmount': 'Исходная сумма',
  'budget.modal.referenceAmount': 'Реф. сумма',
  'budget.modal.exchangeRate': 'Обменный курс',
  'budget.modal.fetchRate': 'Получить курс',
  'budget.modal.currency': 'Валюта',
  'budget.modal.receipts': 'Чеки',
  'budget.modal.uploadReceipt': 'Прикрепить',
  'budget.modal.noReceipts': 'Нет прикреплённых чеков',
  'budget.charged': 'Списано',
  'budget.balance': 'Баланс',
  'planner.mayBeClosed': 'Может быть закрыто в это время',
  'memories.notConnectedMultipleHint': 'Подключите любого из этих провайдеров фото: {provider_names} в настройках, чтобы добавлять фото к этой поездке.',
  ...
  'undo.importCsv': 'Импорт CSV',
  'budget.settle': 'Закрыть бюджет',
  'budget.settledBadge': 'Закрыто {date} пользователем {name}',
  'budget.settledBanner': 'Бюджет закрыт. Расходы доступны только для чтения.',
  'budget.settlement.previewTitle': 'Закрыть бюджет',
  'budget.settlement.previewSubtitle': 'Проверьте, кто сколько должен, и уведомите всех участников.',
  'budget.settlement.flows': 'Необходимые платежи',
  'budget.settlement.noFlows': 'Все сбалансировано — платежи не нужны.',
  'budget.settlement.unresolvedDrafts': 'Нерешённые черновики',
  'budget.settlement.unresolvedDraftsHint': 'Решите эти запланированные расходы перед закрытием.',
  'budget.settlement.convertDraft': 'Конвертировать',
  'budget.settlement.discardDraft': 'Отклонить',
  'budget.settlement.settleBtn': 'Закрыть и уведомить',
  'budget.settlement.confirmText': 'Это действие постоянное и не может быть отменено. Расходы станут доступны только для чтения.',
  'budget.settlement.confirmBtn': 'Подтвердить',
  'budget.settlement.alreadySettled': 'Этот бюджет уже закрыт.',
  'budget.settlement.hasDrafts': 'Решите все черновики перед закрытием.',
  'notif.budget_settlement.title': 'Бюджет закрыт',
  'notif.budget_settlement.text': '{actor} закрыл(а) бюджет поездки {trip}',
  'notif.action.ive_paid': 'Я заплатил(а)',
  'notif.action.dismiss': 'Закрыть',
  'notif.action.view_budget': 'Просмотр бюджета',
  'settings.notifyBudgetSettlement': 'Закрытие бюджета',
  'tripBadge.budgetUnsettled': 'Бюджет не закрыт',
  'tripBadge.budgetUnsettled.detail': 'Поездка завершилась с незакрытыми расходами.',
  'tripBadge.budgetUnsettled.action': 'Проверить бюджет',
  'tripBadge.calendarConflict': 'Конфликт календаря',
  'tripBadge.calendarConflict.detail': 'В вашем календаре есть события, пересекающиеся с датами поездки.',
  'tripBadge.calendarConflict.action': 'Просмотр календаря',
  'tripBadge.missingDates': 'Даты не указаны',
  'tripBadge.missingDates.detail': 'Добавьте даты поездки для обнаружения конфликтов и напоминаний.',
  'tripBadge.missingDates.action': 'Редактировать поездку',
  'tripBadge.upcomingSoon': 'Начинается через {days} дн.',
  'tripBadge.upcomingSoon.detail': 'Ваш маршрут пуст — пора планировать!',
  'tripBadge.upcomingSoon.action': 'Открыть планировщик',
  'tripBadge.emptyItinerary': 'Нет маршрута',
  'tripBadge.emptyItinerary.detail': 'Для ни одного дня не запланировано мероприятий.',
  'tripBadge.emptyItinerary.action': 'Открыть планировщик',
  'tripBadge.more': '+{count} ещё',
  'trip.loading.budget': 'Загрузка бюджета...',
  'trip.loading.reservations': 'Загрузка бронирований...',
  'trip.loading.packing': 'Загрузка списка вещей...',
  'trip.loading.files': 'Загрузка файлов...',
  'trip.loading.collab': 'Загрузка сообщений...',
  'trip.loading.memories': 'Загрузка воспоминаний...',
  'trip.myPreferences': 'Мои настройки',
  'trip.addToCalendar': 'Добавить в мой календарь',
  'trip.addToCalendarHint': 'Заблокируйте эти даты в личном календаре отпусков.',
  'trip.calendarSyncing': 'Синхронизация...',
  'settings.notifyTodoDue': 'Задача на сегодня',
  'collab.notes.expand': 'Развернуть',
  'dayplan.dayDetail': 'Детали дня',
  'dayplan.toast.routeError': 'Не удалось рассчитать маршрут',
  'trip.toast.loadError': 'Не удалось загрузить поездку',
  'trip.toast.tripUpdated': 'Поездка обновлена',
  'admin.mapsAutocompleteNominatimOnly': 'Использовать Nominatim для автодополнения',
  'admin.mapsAutocompleteNominatimOnlyHint': 'Перенаправлять автодополнение на OpenStreetMap даже при настроенном ключе Google, для снижения затрат на API',
  'settings.mcp.tabs.apps': 'Приложения OAuth 2.1',
  'settings.mcp.tabs.legacyTokens': 'Устаревшие токены',
  'settings.mcp.tabs.sessions': 'Активные сессии',
  'settings.mcp.apps.empty': 'Нет приложений OAuth. Создайте одно для безопасного подключения AI-клиентов.',
  'settings.mcp.apps.create': 'Создать приложение',
  'settings.mcp.apps.name': 'Название приложения',
  'settings.mcp.apps.namePlaceholder': 'напр. Claude.ai, Моя автоматизация',
  'settings.mcp.apps.redirectUris': 'URI перенаправления',
  'settings.mcp.apps.redirectUrisHint': 'Один на строку. Должен использовать https://, http://localhost или пользовательскую схему.',
  'settings.mcp.apps.isPublic': 'Публичный клиент (без секрета, только PKCE)',
  'settings.mcp.apps.scopes': 'Разрешённые права доступа',
  'settings.mcp.apps.preset': 'Предустановка:',
  ...
  'settings.mcp.apps.preset.readOnly': 'Только чтение',
  'settings.mcp.apps.created': 'Приложение создано',
  'settings.mcp.apps.createError': 'Не удалось создать приложение',
  'settings.mcp.apps.deleted': 'Приложение удалено',
  'settings.mcp.apps.deleteError': 'Не удалось удалить приложение',
  'settings.mcp.apps.secretOnce': 'Секрет клиента (показывается один раз)',
  'settings.mcp.apps.secretWarning': 'Сохраните этот секрет сейчас — его нельзя восстановить.',
  'settings.mcp.apps.rotated': 'Секрет обновлён',
  'settings.mcp.apps.rotateError': 'Не удалось обновить секрет',
  'settings.mcp.apps.rotate': 'Обновить секрет',
  'settings.mcp.apps.delete': 'Удалить',
  'settings.mcp.apps.publicBadge': 'Публичный',
  'settings.mcp.apps.confidentialBadge': 'Конфиденциальный',
  'settings.mcp.apps.legacyNotice': 'Для новых подключений используйте приложения OAuth 2.1 выше.',
  'settings.mcp.apps.modal.createTitle': 'Создать приложение OAuth',
  'settings.mcp.apps.modal.done': 'Готово',
  'settings.mcp.apps.modal.creating': 'Создание…',
  'settings.mcp.apps.modal.deleteTitle': 'Удалить приложение',
  'settings.mcp.apps.modal.deleteMessage': 'Все токены и сессии этого приложения будут немедленно отозваны.',
  'settings.mcp.sessions.empty': 'Нет активных сессий OAuth.',
  'settings.mcp.sessions.revoke': 'Отозвать',
  'settings.mcp.sessions.revoked': 'Сессия отозвана',
  'settings.mcp.sessions.revokeError': 'Не удалось отозвать сессию',
  'settings.mcp.sessions.scopes': 'Права доступа',
  'settings.mcp.sessions.expires': 'Истекает',
  'settings.mcp.legacyDeprecated': 'Устарело',
  'settings.mcp.oauthAppsAdminNote': 'Приложения OAuth 2.1 для AI-клиентов настраиваются в панели администратора.',
  'admin.tabs.oauthApps': 'Приложения OAuth 2.1',
  'admin.oauthApps.title': 'Приложения OAuth 2.1',
  'admin.oauthApps.subtitle': 'Зарегистрируйте OAuth-клиентов, чтобы AI-инструменты (Claude.ai, ChatGPT и др.) могли подключаться к MCP-эндпоинту.',
  'admin.oauthApps.registered': 'Зарегистрированные приложения',
}
