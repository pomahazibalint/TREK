const it: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.showPlaceDescription': 'Mostra descrizione del luogo',
  ...
  'forgotPassword.title': 'Reimposta la password',
  ...
  'forgotPassword.submit': 'Invia il link di ripristino',
  'forgotPassword.sending': 'Invio in corso\u2026',
  'forgotPassword.successTitle': 'Controlla la tua casella di posta',
  'forgotPassword.successMsg': 'Se esiste un account con quella email, è stato inviato un link di ripristino.',
  ...
  'resetPassword.password': 'Nuova password',
  'resetPassword.submit': 'Imposta la password',
  'resetPassword.submitting': 'Impostazione password\u2026',
  'resetPassword.successTitle': 'Password aggiornata',
  'resetPassword.successMsg': 'La tua password è stata cambiata. Ora puoi accedere.',
  'resetPassword.signIn': 'Vai al login',
  'resetPassword.invalidToken': 'Questo link di ripristino non è valido o è scaduto.',
  'resetPassword.mfaRequired': 'Il tuo account ha l\'autenticazione a due fattori abilitata.',
  'resetPassword.mfaCode': 'Codice autenticatore',
  ...
  'admin.mapsKillSwitches': 'Interruttori API',
  'admin.mapsAutocompleteDisabled': 'Disabilita ricerca luoghi',
  'admin.mapsAutocompleteDisabledHint': 'Blocca tutte le chiamate di completamento automatico/ricerca a Google e Nominatim',
  'admin.mapsDetailsDisabled': 'Disabilita dettagli luoghi',
  'admin.mapsDetailsDisabledHint': 'Blocca le ricerche dei dettagli (valutazioni, recensioni, orari)',
  ...
  // File Types
  'admin.authMethods': 'Metodi di autenticazione',
  'admin.passwordLogin': 'Accesso con password',
  'admin.passwordLoginHint': 'Consenti agli utenti di accedere con email e password',
  'admin.oidcLogin': 'Accesso SSO',
  'admin.oidcLoginHint': 'Consenti agli utenti di accedere tramite il provider OIDC configurato',
  'admin.oidcRegistration': 'Registrazione SSO',
  'admin.oidcRegistrationHint': 'Consenti la creazione di nuovi utenti al primo accesso SSO',
  'admin.envOverrideHint': 'L\'accesso con password è controllato dalla variabile d\'ambiente OIDC_ONLY e non può essere modificato qui.',
  'admin.defaultLanguage': 'Lingua predefinita',
  'admin.defaultLanguageHint': 'Lingua mostrata agli utenti non autenticati. I visitatori possono comunque cambiarla.',
  'admin.defaultLanguageAuto': 'Rilevamento automatico (lingua del browser)',
  ...
  'admin.collab.chat': 'Chat dal vivo',
  'admin.collab.chatHint': 'Chat di viaggio in tempo reale per tutti i membri',
  'admin.collab.notes': 'Note condivise',
  'admin.collab.notesHint': 'Note collaborative allegate al viaggio',
  'admin.collab.polls': 'Sondaggi',
  'admin.collab.pollsHint': 'Crea e vota le decisioni di gruppo',
  'admin.bagTracking.subtitle': 'Abilita il peso e l\'assegnazione della valigia per gli elementi della lista valigia',
  'admin.atlas.geoTitle': 'Dati confini regionali',
  'admin.atlas.geoHint': "Aggiorna il file GeoJSON dei confini regionali usato sulla mappa dell'Atlas",
  'admin.atlas.geoRefresh': 'Aggiorna ora',
  'admin.atlas.geoRefreshing': 'Aggiornamento…',
  'admin.atlas.geoRefreshed': 'Dati confini regionali aggiornati',
  'admin.atlas.geoRefreshError': 'Aggiornamento dati confini regionali non riuscito',
  ...
  'admin.addons.integrationHint': 'Servizi backend e integrazioni API',
  ...
  'vacay.calendars': 'Calendari',
  'vacay.myCalendar': 'Il mio Calendario',
  'vacay.newCalendar': 'Nuovo Calendario',
  'vacay.calendarName': 'Nome del calendario',
  'vacay.calendarNamePlaceholder': 'es. Team di Lavoro, Famiglia',
  'vacay.createCalendar': 'Crea',
  'vacay.leaveCalendar': 'Lascia il Calendario',
  'vacay.deleteCalendar': 'Elimina Calendario',
  'vacay.leaveCalendarHint': 'Rimuoviti da questo calendario condiviso. Le tue voci personali non saranno interessate.',
  'vacay.deleteCalendarHint': 'Elimina definitivamente questo calendario e rimuovi tutti i membri.',
  'vacay.leaveAction': 'Lascia',
  'vacay.deleteAction': 'Elimina',
  'vacay.shareDetailsDefault': 'Condividi dettagli nei calendari condivisi',
  'vacay.shareDetailsDefaultHint': 'Si applica alle nuove voci. Le voci esistenti non vengono modificate.',
  'vacay.busyOnly': 'Occupato',
  'vacay.eventName': 'Nome evento',
  'vacay.location': 'Luogo',
  'vacay.note': 'Nota',
  'vacay.optional': 'Opzionale',
  'vacay.shareDetails': 'Condividi dettagli',
  'vacay.shareDetailsHint': 'Nome, luogo e nota sono visibili agli altri membri del calendario',
  'vacay.removeEntry': 'Rimuovi',
  'vacay.markThrough': 'Segna fino al',
  'vacay.daysSelected': '{n} giorni',
  'vacay.mixedValues': 'Più valori…',
  ...
  'dayplan.duplicateDay': 'Duplica giorno',
  'dayplan.pdfError': 'Impossibile esportare il PDF',
  'dayplan.transportWalking': 'Piedi',
  ...
  'places.formPhone': 'Telefono',
  'places.formPrice': 'Prezzo',
  'places.formPriceVisit': 'Prezzo (questa visita)',
  'places.whoIsGoing': 'Chi viene?',
  'places.everyoneGoing': 'Tutti vengono — tocca per escludere qualcuno',
  'places.formDuration': 'Durata visita (min)',
  'places.formTransportMode': 'Come arrivare',
  'places.transportWalking': 'A piedi',
  'places.transportCycling': 'Bicicletta',
  'places.transportDriving': 'In auto',
  ...
  'memories.linkDateRange': 'Collega intervallo date',
  'memories.preview': 'Anteprima',
  'memories.enableAutoSync': 'Abilita sincronizzazione automatica',
  'memories.disableAutoSync': 'Disabilita sincronizzazione automatica',
  'memories.addDateSync': 'Aggiungi sincronizzazione per data',
  'memories.dateSyncLabel': 'Sincronizzazione per data',
  'memories.lastSynced': 'Ultima sincronizzazione',
  ...
  'notif.todo_due.title': 'Attività in scadenza oggi',
  'notif.todo_due.text': '{name} scade oggi in {trip}.',
  ...
  'nav.offline': 'Offline',
  'dashboard.settlementCurrency': 'Valuta di liquidazione',
  'dashboard.settlementCurrencyHint': 'Tutte le spese in valuta multipla verranno convertite in questa valuta per la liquidazione. Non può essere modificata una volta che esistono spese in valuta estera.',
  'places.importCsv': 'CSV',
  'places.csvImported': '{count} luoghi importati da CSV',
  'places.csvError': 'Importazione CSV fallita',
  'budget.table.members': 'Membri',
  'budget.addExpense': 'Aggiungi spesa',
  'budget.editExpense': 'Modifica spesa',
  'budget.modal.owes': 'Deve',
  'budget.modal.paid': 'Pagato',
  'budget.modal.tip': 'Mancia',
  'budget.modal.equalSplit': 'Divisione uguale',
  'budget.modal.remaining': 'rimanente',
  'budget.modal.balanced': 'Bilanciato',
  'budget.modal.notReconciled': 'Non ancora riconciliato',
  'budget.modal.originalAmount': 'Importo originale',
  'budget.modal.referenceAmount': 'Importo di rif.',
  'budget.modal.exchangeRate': 'Tasso di cambio',
  'budget.modal.fetchRate': 'Ottieni tasso',
  'budget.modal.currency': 'Valuta',
  'budget.modal.receipts': 'Scontrini',
  'budget.modal.uploadReceipt': 'Allega',
  'budget.modal.noReceipts': 'Nessuno scontrino allegato',
  'budget.charged': 'Addebitato',
  'budget.balance': 'Saldo',
  'planner.mayBeClosed': 'Potrebbe essere chiuso in questo momento',
  ...
  'undo.importCsv': 'Importazione CSV',
  'budget.settle': 'Saldare il budget',
  'budget.settledBadge': 'Saldato il {date} da {name}',
  'budget.settledBanner': 'Questo budget è stato saldato. Le spese sono di sola lettura.',
  'budget.settlement.previewTitle': 'Saldare il budget',
  'budget.settlement.previewSubtitle': 'Verifica chi deve pagare cosa e notifica tutti.',
  'budget.settlement.flows': 'Pagamenti richiesti',
  'budget.settlement.noFlows': 'Tutto in pareggio — nessun pagamento necessario.',
  'budget.settlement.unresolvedDrafts': 'Bozze non risolte',
  'budget.settlement.unresolvedDraftsHint': 'Risolvi queste spese pianificate prima di saldare.',
  'budget.settlement.convertDraft': 'Converti',
  'budget.settlement.discardDraft': 'Scarta',
  'budget.settlement.settleBtn': 'Salda e notifica',
  'budget.settlement.confirmText': "Questa azione è permanente e non può essere annullata. Le spese diventeranno di sola lettura.",
  'budget.settlement.confirmBtn': 'Conferma',
  'budget.settlement.alreadySettled': 'Questo budget è già stato saldato.',
  'budget.settlement.hasDrafts': 'Risolvi tutte le bozze prima di saldare.',
  'notif.budget_settlement.title': 'Budget saldato',
  'notif.budget_settlement.text': '{actor} ha saldato il budget per {trip}',
  'notif.action.ive_paid': 'Ho pagato',
  'notif.action.dismiss': 'Ignora',
  'notif.action.view_budget': 'Vedi budget',
  'settings.notifyBudgetSettlement': 'Liquidazioni budget',
  'tripBadge.budgetUnsettled': 'Budget non saldato',
  'tripBadge.budgetUnsettled.detail': 'Questo viaggio è terminato con spese non saldate.',
  'tripBadge.budgetUnsettled.action': 'Controlla il budget',
  'tripBadge.calendarConflict': 'Conflitto calendario',
  'tripBadge.calendarConflict.detail': 'Il tuo calendario ha eventi che si sovrappongono a queste date.',
  'tripBadge.calendarConflict.action': 'Vedi calendario',
  'tripBadge.missingDates': 'Date mancanti',
  'tripBadge.missingDates.detail': 'Aggiungi le date per rilevare conflitti e attivare promemoria.',
  'tripBadge.missingDates.action': 'Modifica viaggio',
  'tripBadge.upcomingSoon': 'Inizia tra {days} giorni',
  'tripBadge.upcomingSoon.detail': "L'itinerario è vuoto — è ora di pianificare!",
  'tripBadge.upcomingSoon.action': 'Apri pianificatore',
  'tripBadge.emptyItinerary': 'Nessun itinerario',
  'tripBadge.emptyItinerary.detail': 'Non sono pianificate attività per nessun giorno.',
  'tripBadge.emptyItinerary.action': 'Apri pianificatore',
  'tripBadge.more': '+{count} altri',
  'trip.loading.budget': 'Caricamento budget...',
  'trip.loading.reservations': 'Caricamento prenotazioni...',
  'trip.loading.packing': 'Caricamento lista bagagli...',
  'trip.loading.files': 'Caricamento file...',
  'trip.loading.collab': 'Caricamento messaggi...',
  'trip.loading.memories': 'Caricamento ricordi...',
  'trip.myPreferences': 'Le mie preferenze',
  'trip.addToCalendar': 'Aggiungi al mio calendario',
  'trip.addToCalendarHint': 'Blocca queste date nel tuo calendario vacanze personale.',
  'trip.calendarSyncing': 'Sincronizzazione...',
  'settings.notifyTodoDue': 'Attività in scadenza oggi',
  'collab.notes.expand': 'Espandi',
  'dayplan.dayDetail': 'Dettagli del giorno',
  'dayplan.toast.routeError': 'Impossibile calcolare il percorso',
  'trip.toast.loadError': 'Impossibile caricare il viaggio',
  'trip.toast.tripUpdated': 'Viaggio aggiornato',
  'admin.mapsAutocompleteNominatimOnly': 'Usa Nominatim per il completamento automatico',
  'admin.mapsAutocompleteNominatimOnlyHint': 'Reindirizzare il completamento automatico a OpenStreetMap anche se è configurata una chiave Google, per ridurre i costi API',
  'settings.mcp.tabs.apps': 'App OAuth 2.1',
  'settings.mcp.tabs.legacyTokens': 'Token legacy',
  'settings.mcp.tabs.sessions': 'Sessioni attive',
  'settings.mcp.apps.empty': 'Nessuna app OAuth ancora. Creane una per connettere client AI in modo sicuro.',
  'settings.mcp.apps.create': 'Crea app',
  'settings.mcp.apps.name': 'Nome app',
  'settings.mcp.apps.namePlaceholder': 'es. Claude.ai, La mia automazione',
  'settings.mcp.apps.redirectUris': 'URI di reindirizzamento',
  'settings.mcp.apps.redirectUrisHint': 'Uno per riga. Deve usare https://, http://localhost o uno schema personalizzato.',
  'settings.mcp.apps.isPublic': 'Client pubblico (senza segreto, solo PKCE)',
  'settings.mcp.apps.scopes': 'Autorizzazioni consentite',
  'settings.mcp.apps.preset': 'Preimpostazione:',
  ...
  'settings.mcp.apps.preset.readOnly': 'Solo lettura',
  'settings.mcp.apps.created': 'App creata',
  'settings.mcp.apps.createError': 'Creazione app non riuscita',
  'settings.mcp.apps.deleted': 'App eliminata',
  'settings.mcp.apps.deleteError': 'Eliminazione app non riuscita',
  'settings.mcp.apps.secretOnce': 'Segreto client (mostrato una volta)',
  'settings.mcp.apps.secretWarning': 'Salva questo segreto ora — non può essere recuperato.',
  'settings.mcp.apps.rotated': 'Segreto rinnovato',
  'settings.mcp.apps.rotateError': 'Rinnovo segreto non riuscito',
  'settings.mcp.apps.rotate': 'Rinnova segreto',
  'settings.mcp.apps.delete': 'Elimina',
  'settings.mcp.apps.publicBadge': 'Pubblico',
  'settings.mcp.apps.confidentialBadge': 'Riservato',
  'settings.mcp.apps.legacyNotice': 'Le nuove connessioni dovrebbero utilizzare le App OAuth 2.1 sopra.',
  'settings.mcp.apps.modal.createTitle': 'Crea app OAuth',
  'settings.mcp.apps.modal.done': 'Fatto',
  'settings.mcp.apps.modal.creating': 'Creazione…',
  'settings.mcp.apps.modal.deleteTitle': 'Elimina app',
  'settings.mcp.apps.modal.deleteMessage': 'Tutti i token e le sessioni di questa app verranno revocati immediatamente.',
  'settings.mcp.sessions.empty': 'Nessuna sessione OAuth attiva.',
  'settings.mcp.sessions.revoke': 'Revoca',
  'settings.mcp.sessions.revoked': 'Sessione revocata',
  'settings.mcp.sessions.revokeError': 'Revoca sessione non riuscita',
  'settings.mcp.sessions.scopes': 'Autorizzazioni',
  'settings.mcp.sessions.expires': 'Scade',
  'settings.mcp.legacyDeprecated': 'Deprecato',
  'settings.mcp.oauthAppsAdminNote': 'Le app OAuth 2.1 per client AI sono configurate nel pannello di amministrazione.',
  'admin.tabs.oauthApps': 'App OAuth 2.1',
  'admin.oauthApps.title': 'App OAuth 2.1',
  'admin.oauthApps.subtitle': 'Registra client OAuth in modo che gli strumenti AI (Claude.ai, ChatGPT, ecc.) possano connettersi all\'endpoint MCP.',
  'admin.oauthApps.registered': 'App registrate',
}
