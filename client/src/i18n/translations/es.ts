const es: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.showPlaceDescription': 'Mostrar descripción del lugar',
  ...
  'forgotPassword.subtitle': 'Introduce tu correo y te enviaremos un enlace para restablecer la contraseña.',
  ...
  'forgotPassword.successTitle': 'Revisa tu bandeja de entrada',
  'forgotPassword.successMsg': 'Si existe una cuenta con ese correo, se ha enviado un enlace de restablecimiento.',
  'forgotPassword.backToLogin': '← Volver al inicio de sesión',
  'resetPassword.title': 'Establecer nueva contraseña',
  'resetPassword.subtitle': 'Introduce tu nueva contraseña a continuación.',
  'resetPassword.password': 'Nueva contraseña',
  'resetPassword.submit': 'Establecer contraseña',
  'resetPassword.submitting': 'Estableciendo contraseña\u2026',
  'resetPassword.successTitle': 'Contraseña actualizada',
  'resetPassword.successMsg': 'Tu contraseña ha sido cambiada. Ahora puedes iniciar sesión.',
  'resetPassword.signIn': 'Ir al inicio de sesión',
  'resetPassword.invalidToken': 'Este enlace de restablecimiento no es válido o ha expirado.',
  'resetPassword.mfaRequired': 'Tu cuenta tiene la autenticación de dos factores activada.',
  'resetPassword.mfaCode': 'Código de autenticación',
  ...
  'admin.mapsKillSwitches': 'Interruptores de API',
  'admin.mapsAutocompleteDisabled': 'Deshabilitar búsqueda de lugares',
  'admin.mapsAutocompleteDisabledHint': 'Bloquear todas las llamadas de autocompletar/búsqueda a Google y Nominatim',
  'admin.mapsDetailsDisabled': 'Deshabilitar detalles de lugares',
  'admin.mapsDetailsDisabledHint': 'Bloquear consultas de detalles (calificaciones, reseñas, horarios)',
  ...
  // File Types
  'admin.authMethods': 'Métodos de autenticación',
  'admin.passwordLogin': 'Inicio de sesión con contraseña',
  'admin.passwordLoginHint': 'Permitir a los usuarios iniciar sesión con correo y contraseña',
  'admin.oidcLogin': 'Inicio de sesión SSO',
  'admin.oidcLoginHint': 'Permitir a los usuarios iniciar sesión mediante el proveedor OIDC configurado',
  'admin.oidcRegistration': 'Registro SSO',
  'admin.oidcRegistrationHint': 'Permitir que se creen nuevos usuarios en el primer inicio de sesión SSO',
  'admin.envOverrideHint': 'El inicio de sesión con contraseña está controlado por la variable de entorno OIDC_ONLY y no se puede cambiar aquí.',
  'admin.defaultLanguage': 'Idioma predeterminado',
  'admin.defaultLanguageHint': 'Idioma mostrado a usuarios no autenticados. Los visitantes pueden cambiarlo.',
  'admin.defaultLanguageAuto': 'Detectar automáticamente (idioma del navegador)',
  ...
  'admin.collab.chat': 'Chat en vivo',
  'admin.collab.chatHint': 'Chat de viaje en tiempo real para todos los miembros',
  'admin.collab.notes': 'Notas compartidas',
  'admin.collab.notesHint': 'Notas colaborativas adjuntas al viaje',
  'admin.collab.polls': 'Encuestas',
  'admin.collab.pollsHint': 'Crear y votar decisiones grupales',
  'admin.bagTracking.subtitle': 'Activar peso y asignación de equipaje para artículos de la lista',
  'admin.atlas.geoTitle': 'Datos de fronteras regionales',
  'admin.atlas.geoHint': 'Actualiza el archivo GeoJSON de fronteras regionales usado en el mapa del Atlas',
  'admin.atlas.geoRefresh': 'Actualizar ahora',
  'admin.atlas.geoRefreshing': 'Actualizando…',
  'admin.atlas.geoRefreshed': 'Datos de fronteras regionales actualizados',
  'admin.atlas.geoRefreshError': 'Error al actualizar los datos de fronteras regionales',
  ...
  'admin.addons.integrationHint': 'Servicios backend e integraciones de API',
  ...
  'vacay.inviteCalendarName': 'Calendario:',
  'vacay.calendars': 'Calendarios',
  'vacay.myCalendar': 'Mi Calendario',
  'vacay.newCalendar': 'Nuevo Calendario',
  'vacay.calendarName': 'Nombre del calendario',
  'vacay.calendarNamePlaceholder': 'p.ej. Equipo de Trabajo, Familia',
  'vacay.createCalendar': 'Crear',
  'vacay.leaveCalendar': 'Salir del Calendario',
  'vacay.deleteCalendar': 'Eliminar Calendario',
  'vacay.leaveCalendarHint': 'Eliminarte de este calendario compartido. Tus entradas personales no se verán afectadas.',
  'vacay.deleteCalendarHint': 'Eliminar permanentemente este calendario y eliminar a todos los miembros.',
  'vacay.leaveAction': 'Salir',
  'vacay.deleteAction': 'Eliminar',
  'vacay.shareDetailsDefault': 'Compartir detalles en calendarios compartidos',
  'vacay.shareDetailsDefaultHint': 'Se aplica a las nuevas entradas. Las entradas existentes no se modifican.',
  'vacay.busyOnly': 'Ocupado',
  'vacay.eventName': 'Nombre del evento',
  'vacay.location': 'Ubicación',
  'vacay.note': 'Nota',
  'vacay.optional': 'Opcional',
  'vacay.shareDetails': 'Compartir detalles',
  'vacay.shareDetailsHint': 'El nombre, ubicación y nota son visibles para otros miembros del calendario',
  'vacay.removeEntry': 'Eliminar',
  'vacay.markThrough': 'Marcar hasta',
  'vacay.daysSelected': '{n} días',
  'vacay.mixedValues': 'Valores múltiples…',
  ...
  'dayplan.duplicateDay': 'Duplicar día',
  'dayplan.pdfError': 'No se pudo exportar el PDF',
  'dayplan.transportWalking': 'Pie',
  'dayplan.transportCycling': 'Bici',
  'dayplan.transportDriving': 'Coche',
  ...
  'places.formPhone': 'Teléfono',
  'places.formPrice': 'Precio',
  'places.formPriceVisit': 'Precio (esta visita)',
  'places.whoIsGoing': '¿Quién va?',
  'places.everyoneGoing': 'Todos van — toca para excluir a alguien',
  'places.formDuration': 'Duración de visita (min)',
  'places.formTransportMode': 'Cómo llegar',
  'places.transportWalking': 'A pie',
  'places.transportCycling': 'Bicicleta',
  'places.transportDriving': 'Coche',
  ...
  'photos.dropHere': 'Suelta las fotos aquí',
  'photos.dropHereActive': 'Suelta las fotos aquí...',
  'photos.dropHint': 'JPG, PNG, WebP · máx. 10 MB · hasta 30 fotos',
  ...
  'memories.dateSyncLabel': 'Sincronización por fecha',
  'memories.lastSynced': 'Última sincronización',
  ...
  'notif.todo_due.title': 'Tarea vencida hoy',
  'notif.todo_due.text': '{name} vence hoy en {trip}.',
  ...
  'dashboard.settlementCurrency': 'Moneda de liquidación',
  'dashboard.settlementCurrencyHint': 'Todos los gastos en varias monedas se convertirán a esta moneda para la liquidación. No se puede cambiar una vez que existen gastos en moneda extranjera.',
  'places.importCsv': 'CSV',
  'places.csvImported': '{count} lugares importados desde CSV',
  'places.csvError': 'Error al importar CSV',
  'budget.table.members': 'Miembros',
  'budget.addExpense': 'Añadir gasto',
  'budget.editExpense': 'Editar gasto',
  'budget.modal.owes': 'Debe',
  'budget.modal.paid': 'Pagado',
  'budget.modal.tip': 'Propina',
  'budget.modal.equalSplit': 'División igualitaria',
  'budget.modal.remaining': 'restante',
  'budget.modal.balanced': 'Equilibrado',
  'budget.modal.notReconciled': 'Aún no conciliado',
  'budget.modal.originalAmount': 'Importe original',
  'budget.modal.referenceAmount': 'Importe de referencia',
  'budget.modal.exchangeRate': 'Tipo de cambio',
  'budget.modal.fetchRate': 'Obtener tipo',
  'budget.modal.currency': 'Moneda',
  'budget.modal.receipts': 'Recibos',
  'budget.modal.uploadReceipt': 'Adjuntar',
  'budget.modal.noReceipts': 'No hay recibos adjuntos',
  'budget.charged': 'Cargado',
  'budget.balance': 'Saldo',
  'planner.mayBeClosed': 'Puede estar cerrado en este momento',
  'memories.notConnectedMultipleHint': 'Conecta cualquiera de estos proveedores de fotos: {provider_names} en Configuración para poder añadir fotos a este viaje.',
  'memories.providerUrl': 'URL del servidor',
  'memories.providerApiKey': 'Clave de API',
  ...
  'undo.importCsv': 'Importación CSV',
  'budget.settle': 'Liquidar presupuesto',
  'budget.settledBadge': 'Liquidado el {date} por {name}',
  'budget.settledBanner': 'Este presupuesto ha sido liquidado. Los gastos son de solo lectura.',
  'budget.settlement.previewTitle': 'Liquidar presupuesto',
  'budget.settlement.previewSubtitle': 'Revisa quién debe pagar qué y notifica a todos.',
  'budget.settlement.flows': 'Pagos requeridos',
  'budget.settlement.noFlows': 'Todo equilibrado — no se requieren pagos.',
  'budget.settlement.unresolvedDrafts': 'Borradores sin resolver',
  'budget.settlement.unresolvedDraftsHint': 'Resuelve estos gastos planificados antes de liquidar.',
  'budget.settlement.convertDraft': 'Convertir',
  'budget.settlement.discardDraft': 'Descartar',
  'budget.settlement.settleBtn': 'Liquidar y notificar',
  'budget.settlement.confirmText': 'Esto es permanente y no se puede deshacer. Los gastos serán de solo lectura.',
  'budget.settlement.confirmBtn': 'Confirmar',
  'budget.settlement.alreadySettled': 'Este presupuesto ya ha sido liquidado.',
  'budget.settlement.hasDrafts': 'Resuelve todos los borradores antes de liquidar.',
  'notif.budget_settlement.title': 'Presupuesto liquidado',
  'notif.budget_settlement.text': '{actor} liquidó el presupuesto de {trip}',
  'notif.action.ive_paid': 'He pagado',
  'notif.action.dismiss': 'Descartar',
  'notif.action.view_budget': 'Ver presupuesto',
  'settings.notifyBudgetSettlement': 'Liquidaciones de presupuesto',
  'tripBadge.budgetUnsettled': 'Presupuesto pendiente',
  'tripBadge.budgetUnsettled.detail': 'Este viaje terminó con gastos sin liquidar.',
  'tripBadge.budgetUnsettled.action': 'Revisar presupuesto',
  'tripBadge.calendarConflict': 'Conflicto de calendario',
  'tripBadge.calendarConflict.detail': 'Tu calendario tiene eventos que se solapan con estas fechas.',
  'tripBadge.calendarConflict.action': 'Ver calendario',
  'tripBadge.missingDates': 'Fechas no definidas',
  'tripBadge.missingDates.detail': 'Añade fechas para detectar conflictos y activar recordatorios.',
  'tripBadge.missingDates.action': 'Editar viaje',
  'tripBadge.upcomingSoon': 'Comienza en {days} días',
  'tripBadge.upcomingSoon.detail': 'Tu itinerario está vacío — ¡es hora de planificar!',
  'tripBadge.upcomingSoon.action': 'Abrir planificador',
  'tripBadge.emptyItinerary': 'Sin itinerario aún',
  'tripBadge.emptyItinerary.detail': 'No hay actividades planificadas para ningún día.',
  'tripBadge.emptyItinerary.action': 'Abrir planificador',
  'tripBadge.more': '+{count} más',
  'trip.loading.budget': 'Cargando presupuesto...',
  'trip.loading.reservations': 'Cargando reservas...',
  'trip.loading.packing': 'Cargando lista de equipaje...',
  'trip.loading.files': 'Cargando archivos...',
  'trip.loading.collab': 'Cargando mensajes...',
  'trip.loading.memories': 'Cargando recuerdos...',
  'trip.myPreferences': 'Mis preferencias',
  'trip.addToCalendar': 'Añadir a mi calendario',
  'trip.addToCalendarHint': 'Bloquea estas fechas en tu calendario de vacaciones personal.',
  'trip.calendarSyncing': 'Sincronizando...',
  'settings.notifyTodoDue': 'Tarea vencida hoy',
  'collab.notes.expand': 'Expandir',
  'dayplan.dayDetail': 'Detalles del día',
  'dayplan.toast.routeError': 'Error al calcular la ruta',
  'trip.toast.loadError': 'Error al cargar el viaje',
  'trip.toast.tripUpdated': 'Viaje actualizado',
  'admin.mapsAutocompleteNominatimOnly': 'Usar Nominatim para autocompletado',
  'admin.mapsAutocompleteNominatimOnlyHint': 'Redirigir el autocompletado a OpenStreetMap aunque haya una clave de Google configurada, para reducir costes de API',
  'settings.mcp.tabs.apps': 'Apps OAuth 2.1',
  'settings.mcp.tabs.legacyTokens': 'Tokens heredados',
  'settings.mcp.tabs.sessions': 'Sesiones activas',
  'settings.mcp.apps.empty': 'No hay apps OAuth todavía. Crea una para conectar clientes de IA de forma segura.',
  'settings.mcp.apps.create': 'Crear app',
  'settings.mcp.apps.name': 'Nombre de la app',
  'settings.mcp.apps.namePlaceholder': 'ej. Claude.ai, Mi automatización',
  'settings.mcp.apps.redirectUris': 'URIs de redirección',
  'settings.mcp.apps.redirectUrisHint': 'Uno por línea. Debe usar https://, http://localhost o un esquema personalizado.',
  'settings.mcp.apps.isPublic': 'Cliente público (sin secreto, solo PKCE)',
  'settings.mcp.apps.scopes': 'Permisos permitidos',
  'settings.mcp.apps.preset': 'Preajuste:',
  ...
  'settings.mcp.apps.preset.readOnly': 'Solo lectura',
  'settings.mcp.apps.created': 'App creada',
  'settings.mcp.apps.createError': 'Error al crear la app',
  'settings.mcp.apps.deleted': 'App eliminada',
  'settings.mcp.apps.deleteError': 'Error al eliminar la app',
  'settings.mcp.apps.secretOnce': 'Secreto de cliente (mostrado una vez)',
  'settings.mcp.apps.secretWarning': 'Guarda este secreto ahora — no podrá recuperarse.',
  'settings.mcp.apps.rotated': 'Secreto renovado',
  'settings.mcp.apps.rotateError': 'Error al renovar el secreto',
  'settings.mcp.apps.rotate': 'Renovar secreto',
  'settings.mcp.apps.delete': 'Eliminar',
  'settings.mcp.apps.publicBadge': 'Público',
  'settings.mcp.apps.confidentialBadge': 'Confidencial',
  'settings.mcp.apps.legacyNotice': 'Las nuevas conexiones deben usar las Apps OAuth 2.1 de arriba.',
  'settings.mcp.apps.modal.createTitle': 'Crear app OAuth',
  'settings.mcp.apps.modal.done': 'Listo',
  'settings.mcp.apps.modal.creating': 'Creando…',
  'settings.mcp.apps.modal.deleteTitle': 'Eliminar app',
  'settings.mcp.apps.modal.deleteMessage': 'Todos los tokens y sesiones de esta app se revocarán inmediatamente.',
  'settings.mcp.sessions.empty': 'No hay sesiones OAuth activas.',
  'settings.mcp.sessions.revoke': 'Revocar',
  'settings.mcp.sessions.revoked': 'Sesión revocada',
  'settings.mcp.sessions.revokeError': 'Error al revocar la sesión',
  'settings.mcp.sessions.scopes': 'Permisos',
  'settings.mcp.sessions.expires': 'Expira',
  'settings.mcp.legacyDeprecated': 'Obsoleto',
  'settings.mcp.oauthAppsAdminNote': 'Las apps OAuth 2.1 para clientes de IA se configuran en el panel de administración.',
  'admin.tabs.oauthApps': 'Apps OAuth 2.1',
  'admin.oauthApps.title': 'Apps OAuth 2.1',
  'admin.oauthApps.subtitle': 'Registra clientes OAuth para que las herramientas de IA (Claude.ai, ChatGPT, etc.) puedan conectarse al endpoint MCP.',
  'admin.oauthApps.registered': 'Apps registradas',
}
