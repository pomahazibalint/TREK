const hu: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.showPlaceDescription': 'Hely leírásának megjelenítése',
  ...
  'forgotPassword.title': 'Jelszó visszaállítása',
  'forgotPassword.subtitle': 'Add meg az email-címedet, és küldünk egy visszaállítási linket.',
  'forgotPassword.email': 'E-mail cím',
  'forgotPassword.submit': 'Visszaállítási link küldése',
  'forgotPassword.sending': 'Küldés…',
  'forgotPassword.successTitle': 'Ellenőrizd a postaládádat',
  'forgotPassword.successMsg': 'Ha létezik fiók ezzel az email-címmel, akkor a visszaállítási linket elküldtük.',
  'forgotPassword.backToLogin': '← Vissza a bejelentkezéshez',
  'resetPassword.title': 'Új jelszó beállítása',
  'resetPassword.subtitle': 'Add meg az új jelszavadat lent.',
  'resetPassword.password': 'Új jelszó',
  'resetPassword.submit': 'Jelszó beállítása',
  'resetPassword.submitting': 'Jelszó beállítása…',
  'resetPassword.successTitle': 'Jelszó frissítve',
  'resetPassword.successMsg': 'Jelszavad megváltozott. Most már bejelentkezhetsz.',
  'resetPassword.signIn': 'Ugrás a bejelentkezéshez',
  'resetPassword.invalidToken': 'Ez a visszaállítási link érvénytelen vagy lejárt.',
  'resetPassword.mfaRequired': 'A fiókodban engedélyezve van a kétlépéses hitelesítés.',
  'resetPassword.mfaCode': 'Hitelesítő kód',
  ...
  'admin.mapsKillSwitches': 'API-letiltók',
  'admin.mapsAutocompleteDisabled': 'Helykeresés letiltása',
  'admin.mapsAutocompleteDisabledHint': 'Az összes automatikus kiegészítés/szöveges keresés blokkolása a Google és Nominatim felé',
  'admin.mapsDetailsDisabled': 'Hely részletek letiltása',
  'admin.mapsDetailsDisabledHint': 'Hely részlet lekérdezések blokkolása (értékelések, vélemények, nyitvatartás)',
  ...
  // Fájltípusok
  'admin.authMethods': 'Hitelesítési módszerek',
  'admin.passwordLogin': 'Jelszavas bejelentkezés',
  'admin.passwordLoginHint': 'Felhasználók bejelentkezésének engedélyezése email-lel és jelszóval',
  'admin.oidcLogin': 'SSO bejelentkezés',
  'admin.oidcLoginHint': 'Felhasználók bejelentkezésének engedélyezése a beállított OIDC-szolgáltatón keresztül',
  'admin.oidcRegistration': 'SSO regisztráció',
  'admin.oidcRegistrationHint': 'Új felhasználók létrehozásának engedélyezése az első SSO bejelentkezéskor',
  'admin.envOverrideHint': 'A jelszavas bejelentkezést az OIDC_ONLY környezeti változó szabályozza, és itt nem módosítható.',
  'admin.defaultLanguage': 'Alapértelmezett nyelv',
  'admin.defaultLanguageHint': 'Nem bejelentkezett felhasználóknak megjelenített nyelv. A látogatók felülírhatják.',
  'admin.defaultLanguageAuto': 'Automatikus felismerés (böngésző nyelve)',
  ...
  'admin.collab.chat': 'Élő chat',
  'admin.collab.chatHint': 'Valós idejű utazási chat minden tag számára',
  'admin.collab.notes': 'Megosztott jegyzetek',
  'admin.collab.notesHint': 'Az utazáshoz csatolt közös jegyzetek',
  'admin.collab.polls': 'Szavazások',
  'admin.collab.pollsHint': 'Csoportos döntések létrehozása és szavazás',
  'admin.bagTracking.subtitle': 'Súly- és táskahozzárendelés engedélyezése csomagolási tételeknél',
  'admin.atlas.geoTitle': 'Regionális határadatok',
  'admin.atlas.geoHint': 'Frissíti az Atlasz-térképen használt regionális határok GeoJSON-fájlját',
  'admin.atlas.geoRefresh': 'Frissítés most',
  'admin.atlas.geoRefreshing': 'Frissítés…',
  'admin.atlas.geoRefreshed': 'Regionális határadatok frissítve',
  'admin.atlas.geoRefreshError': 'A regionális határadatok frissítése sikertelen',
  ...
  'admin.addons.integrationHint': 'Háttérszolgáltatások és API-integrációk',
  ...
  'vacay.inviteCalendarName': 'Naptár:',
  'vacay.calendars': 'Naptárak',
  'vacay.myCalendar': 'Saját Naptár',
  'vacay.newCalendar': 'Új Naptár',
  'vacay.calendarName': 'Naptár neve',
  'vacay.calendarNamePlaceholder': 'pl. Munkacsapat, Család',
  'vacay.createCalendar': 'Létrehozás',
  'vacay.leaveCalendar': 'Naptár elhagyása',
  'vacay.deleteCalendar': 'Naptár törlése',
  'vacay.leaveCalendarHint': 'Eltávolítod magad ebből a megosztott naptárból. Személyes bejegyzéseid nem érintettek.',
  'vacay.deleteCalendarHint': 'Véglegesen törli ezt a naptárat és eltávolít minden tagot.',
  'vacay.leaveAction': 'Elhagyás',
  'vacay.deleteAction': 'Törlés',
  'vacay.shareDetailsDefault': 'Részletek megosztása a megosztott naptárakban',
  'vacay.shareDetailsDefaultHint': 'Az új bejegyzésekre vonatkozik. A meglévő bejegyzések nem változnak.',
  'vacay.busyOnly': 'Foglalt',
  'vacay.eventName': 'Esemény neve',
  'vacay.location': 'Helyszín',
  'vacay.note': 'Megjegyzés',
  'vacay.optional': 'Nem kötelező',
  'vacay.shareDetails': 'Részletek megosztása',
  'vacay.shareDetailsHint': 'A nevet, helyszínt és megjegyzést más naptártagok is látják',
  'vacay.removeEntry': 'Eltávolítás',
  'vacay.markThrough': 'Jelölés idáig',
  'vacay.daysSelected': '{n} nap',
  'vacay.mixedValues': 'Több érték…',
  ...
  'dayplan.duplicateDay': 'Nap másolása',
  'dayplan.pdfError': 'Nem sikerült a PDF exportálás',
  'dayplan.transportWalking': 'Gyalog',
  'dayplan.transportCycling': 'Kerékpár',
  'dayplan.transportDriving': 'Autó',
  ...
  'places.formPhone': 'Telefon',
  'places.formPrice': 'Ár',
  'places.formPriceVisit': 'Ár (ez a látogatás)',
  'places.whoIsGoing': 'Ki megy?',
  'places.everyoneGoing': 'Mindenki megy — koppintson a kizáráshoz',
  'places.formDuration': 'Látogatás időtartama (perc)',
  'places.formTransportMode': 'Közlekedési mód',
  'places.transportWalking': 'Gyalog',
  'places.transportCycling': 'Kerékpár',
  'places.transportDriving': 'Autó',
  ...
  'memories.dateSyncLabel': 'Dátum-szinkronizálás',
  'memories.lastSynced': 'Utoljára szinkronizálva',
  ...
  'notif.todo_due.title': 'Ma esedékes teendő',
  'notif.todo_due.text': '{name} ma esedékes ebben: {trip}.',
  ...
  'budget.linkedToReservation': 'Foglaláshoz kapcsolva — szerkeszd a nevet ott',
  ...
  'dashboard.settlementCurrency': 'Elszámolási pénznem',
  'dashboard.settlementCurrencyHint': 'Az összes többdevizás kiadás az elszámoláshoz erre a pénznemre lesz átváltva. Nem módosítható, ha már vannak devizás kiadások.',
  'places.importCsv': 'CSV',
  'places.csvImported': '{count} helyszín importálva CSV-ből',
  'places.csvError': 'CSV importálás sikertelen',
  'budget.table.members': 'Tagok',
  'budget.addExpense': 'Kiadás hozzáadása',
  'budget.editExpense': 'Kiadás szerkesztése',
  'budget.modal.owes': 'Tartozik',
  'budget.modal.paid': 'Fizetve',
  'budget.modal.tip': 'Borravaló',
  'budget.modal.equalSplit': 'Egyenlő elosztás',
  'budget.modal.remaining': 'maradék',
  'budget.modal.balanced': 'Kiegyensúlyozott',
  'budget.modal.notReconciled': 'Még nem egyeztetett',
  'budget.modal.originalAmount': 'Eredeti összeg',
  'budget.modal.referenceAmount': 'Ref. összeg',
  'budget.modal.exchangeRate': 'Árfolyam',
  'budget.modal.fetchRate': 'Árfolyam lekérése',
  'budget.modal.currency': 'Pénznem',
  'budget.modal.receipts': 'Nyugták',
  'budget.modal.uploadReceipt': 'Csatolás',
  'budget.modal.noReceipts': 'Nincs csatolt nyugta',
  'budget.charged': 'Felszámolt',
  'budget.balance': 'Egyenleg',
  'planner.mayBeClosed': 'Ebben az időpontban zárva lehet',
  'memories.notConnectedMultipleHint': 'Csatlakoztasd az alábbi fotószolgáltatók egyikét: {provider_names} a Beállításokban, hogy fényképeket adhass hozzá az utazáshoz.',
  ...
  'undo.importCsv': 'CSV importálás',
  'budget.settle': 'Költségvetés rendezése',
  'budget.settledBadge': 'Rendezve: {date}, {name} által',
  'budget.settledBanner': 'Ez a költségvetés rendezve lett. A kiadások csak olvashatók.',
  'budget.settlement.previewTitle': 'Költségvetés rendezése',
  'budget.settlement.previewSubtitle': 'Tekintse át, ki mennyit fizet, majd értesítse mindenkit.',
  'budget.settlement.flows': 'Szükséges kifizetések',
  'budget.settlement.noFlows': 'Minden kiegyenlített — nem szükséges kifizetés.',
  'budget.settlement.unresolvedDrafts': 'Megoldatlan vázlatok',
  'budget.settlement.unresolvedDraftsHint': 'Rendezze ezeket a tervezett kiadásokat a kiegyenlítés előtt.',
  'budget.settlement.convertDraft': 'Átalakítás',
  'budget.settlement.discardDraft': 'Elvetés',
  'budget.settlement.settleBtn': 'Rendezés és értesítés',
  'budget.settlement.confirmText': 'Ez végleges és nem vonható vissza. A kiadások csak olvashatóvá válnak.',
  'budget.settlement.confirmBtn': 'Megerősítés',
  'budget.settlement.alreadySettled': 'Ez a költségvetés már rendezve lett.',
  'budget.settlement.hasDrafts': 'Rendezze az összes vázlatot a kiegyenlítés előtt.',
  'notif.budget_settlement.title': 'Költségvetés rendezve',
  'notif.budget_settlement.text': '{actor} rendezte a(z) {trip} utazás költségvetését',
  'notif.action.ive_paid': 'Fizettem',
  'notif.action.dismiss': 'Bezárás',
  'notif.action.view_budget': 'Költségvetés megtekintése',
  'settings.notifyBudgetSettlement': 'Költségvetés-rendezések',
  'tripBadge.budgetUnsettled': 'Költségvetés rendezetlen',
  'tripBadge.budgetUnsettled.detail': 'Ez az utazás rendezetlen kiadásokkal ért véget.',
  'tripBadge.budgetUnsettled.action': 'Költségvetés ellenőrzése',
  'tripBadge.calendarConflict': 'Naptárütközés',
  'tripBadge.calendarConflict.detail': 'A naptárban vannak az utazás dátumaival ütköző események.',
  'tripBadge.calendarConflict.action': 'Naptár megtekintése',
  'tripBadge.missingDates': 'Hiányzó dátumok',
  'tripBadge.missingDates.detail': 'Adja meg az utazás dátumait az ütközések észleléséhez és emlékeztetőkhöz.',
  'tripBadge.missingDates.action': 'Utazás szerkesztése',
  'tripBadge.upcomingSoon': 'Kezdés {days} nap múlva',
  'tripBadge.upcomingSoon.detail': 'Az itinerárium üres — ideje tervezni!',
  'tripBadge.upcomingSoon.action': 'Tervező megnyitása',
  'tripBadge.emptyItinerary': 'Még nincs itinerárium',
  'tripBadge.emptyItinerary.detail': 'Egy napra sem tervezett tevékenység.',
  'tripBadge.emptyItinerary.action': 'Tervező megnyitása',
  'tripBadge.more': '+{count} további',
  'trip.loading.budget': 'Költségvetés betöltése...',
  'trip.loading.reservations': 'Foglalások betöltése...',
  'trip.loading.packing': 'Csomagolási lista betöltése...',
  'trip.loading.files': 'Fájlok betöltése...',
  'trip.loading.collab': 'Üzenetek betöltése...',
  'trip.loading.memories': 'Emlékek betöltése...',
  'trip.myPreferences': 'Saját beállítások',
  'trip.addToCalendar': 'Hozzáadás a naptáramhoz',
  'trip.addToCalendarHint': 'Blokkolja ezeket a dátumokat a személyes szabadságnaptárában.',
  'trip.calendarSyncing': 'Szinkronizálás...',
  'settings.notifyTodoDue': 'Ma esedékes feladat',
  'collab.notes.expand': 'Kibontás',
  'dayplan.dayDetail': 'Nap részletei',
  'dayplan.toast.routeError': 'Nem sikerült kiszámítani az útvonalat',
  'trip.toast.loadError': 'Nem sikerült betölteni az utazást',
  'trip.toast.tripUpdated': 'Utazás frissítve',
  'admin.mapsAutocompleteNominatimOnly': 'Nominatim használata automatikus kiegészítéshez',
  'admin.mapsAutocompleteNominatimOnlyHint': 'Az automatikus kiegészítés átirányítása OpenStreetMapre akkor is, ha Google kulcs van beállítva, az API-költségek csökkentése érdekében',
  'settings.mcp.tabs.apps': 'OAuth 2.1 alkalmazások',
  'settings.mcp.tabs.legacyTokens': 'Régi tokenek',
  'settings.mcp.tabs.sessions': 'Aktív munkamenetek',
  'settings.mcp.apps.empty': 'Még nincsenek OAuth alkalmazások. Hozz létre egyet, hogy biztonságosan csatlakozhasson AI kliens.',
  'settings.mcp.apps.create': 'Alkalmazás létrehozása',
  'settings.mcp.apps.name': 'Alkalmazás neve',
  'settings.mcp.apps.namePlaceholder': 'pl. Claude.ai, Automatizálásom',
  'settings.mcp.apps.redirectUris': 'Átirányítási URI-k',
  'settings.mcp.apps.redirectUrisHint': 'Soronként egy. Https://, http://localhost vagy egyéni sémát kell használni.',
  'settings.mcp.apps.isPublic': 'Nyilvános kliens (titkos kulcs nélkül, csak PKCE)',
  'settings.mcp.apps.scopes': 'Engedélyezett jogosultságok',
  'settings.mcp.apps.preset': 'Előbeállítás:',
  ...
  'settings.mcp.apps.preset.readOnly': 'Csak olvasás',
  'settings.mcp.apps.created': 'Alkalmazás létrehozva',
  'settings.mcp.apps.createError': 'Nem sikerült létrehozni az alkalmazást',
  'settings.mcp.apps.deleted': 'Alkalmazás törölve',
  'settings.mcp.apps.deleteError': 'Nem sikerült törölni az alkalmazást',
  'settings.mcp.apps.secretOnce': 'Kliens titok (egyszer jelenik meg)',
  'settings.mcp.apps.secretWarning': 'Mentsd el ezt a titkot most — nem lehet visszaállítani.',
  'settings.mcp.apps.rotated': 'Titok megújítva',
  'settings.mcp.apps.rotateError': 'A titok megújítása nem sikerült',
  'settings.mcp.apps.rotate': 'Titok megújítása',
  'settings.mcp.apps.delete': 'Törlés',
  'settings.mcp.apps.publicBadge': 'Nyilvános',
  'settings.mcp.apps.confidentialBadge': 'Bizalmas',
  'settings.mcp.apps.legacyNotice': 'Az új kapcsolatokhoz a fenti OAuth 2.1 alkalmazásokat kell használni.',
  'settings.mcp.apps.modal.createTitle': 'OAuth alkalmazás létrehozása',
  'settings.mcp.apps.modal.done': 'Kész',
  'settings.mcp.apps.modal.creating': 'Létrehozás…',
  'settings.mcp.apps.modal.deleteTitle': 'Alkalmazás törlése',
  'settings.mcp.apps.modal.deleteMessage': 'Az alkalmazás összes tokenjét és munkamenetét azonnal visszavonjuk.',
  'settings.mcp.sessions.empty': 'Nincsenek aktív OAuth munkamenetek.',
  'settings.mcp.sessions.revoke': 'Visszavonás',
  'settings.mcp.sessions.revoked': 'Munkamenet visszavonva',
  'settings.mcp.sessions.revokeError': 'Nem sikerült visszavonni a munkamenetet',
  'settings.mcp.sessions.scopes': 'Jogosultságok',
  'settings.mcp.sessions.expires': 'Lejár',
  'settings.mcp.legacyDeprecated': 'Elavult',
  'settings.mcp.oauthAppsAdminNote': 'Az AI kliensek OAuth 2.1 alkalmazásait az adminisztrációs panelen kell konfigurálni.',
  'admin.tabs.oauthApps': 'OAuth 2.1 alkalmazások',
  'admin.oauthApps.title': 'OAuth 2.1 alkalmazások',
  'admin.oauthApps.subtitle': 'OAuth kliensek regisztrálása, hogy az AI eszközök (Claude.ai, ChatGPT stb.) csatlakozzanak az MCP végponthoz.',
  'admin.oauthApps.registered': 'Regisztrált alkalmazások',
}
