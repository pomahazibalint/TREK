const zh: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.showPlaceDescription': '显示地点描述',
  ...
  'forgotPassword.subtitle': '输入您的邮箱，我们将发送重置链接。',
  'forgotPassword.email': '电子邮件地址',
  'forgotPassword.submit': '发送重置链接',
  'forgotPassword.sending': '发送中…',
  'forgotPassword.successTitle': '请查看您的收件箱',
  'forgotPassword.successMsg': '如果该邮箱注册了账户，重置链接已发送。',
  'forgotPassword.backToLogin': '← 返回登录',
  'resetPassword.title': '设置新密码',
  'resetPassword.subtitle': '在下方输入您的新密码。',
  'resetPassword.password': '新密码',
  'resetPassword.submit': '设置密码',
  'resetPassword.submitting': '设置密码中…',
  'resetPassword.successTitle': '密码已更新',
  'resetPassword.successMsg': '您的密码已更改。您现在可以登录了。',
  'resetPassword.signIn': '前往登录',
  'resetPassword.invalidToken': '此重置链接无效或已过期。',
  'resetPassword.mfaRequired': '您的账户已启用双因素认证。',
  'resetPassword.mfaCode': '身份验证器代码',
  ...
  'admin.mapsKillSwitches': 'API 开关',
  'admin.mapsAutocompleteDisabled': '禁用地点搜索',
  'admin.mapsAutocompleteDisabledHint': '屏蔽所有向 Google 和 Nominatim 发出的自动补全/搜索请求',
  'admin.mapsDetailsDisabled': '禁用地点详情',
  'admin.mapsDetailsDisabledHint': '屏蔽地点详情查询（评分、评论、营业时间）',
  ...
  // File Types
  'admin.authMethods': '认证方式',
  'admin.passwordLogin': '密码登录',
  'admin.passwordLoginHint': '允许用户使用邮箱和密码登录',
  'admin.oidcLogin': 'SSO 登录',
  'admin.oidcLoginHint': '允许用户通过已配置的 OIDC 提供商登录',
  'admin.oidcRegistration': 'SSO 注册',
  'admin.oidcRegistrationHint': '允许在首次 SSO 登录时创建新用户',
  'admin.envOverrideHint': '密码登录由 OIDC_ONLY 环境变量控制，无法在此更改。',
  'admin.defaultLanguage': '默认语言',
  'admin.defaultLanguageHint': '显示给未登录用户的语言。访客仍可自行更改。',
  'admin.defaultLanguageAuto': '自动检测（浏览器语言）',
  ...
  'admin.collab.chat': '实时聊天',
  'admin.collab.chatHint': '为所有成员提供实时旅行聊天',
  'admin.collab.notes': '共享笔记',
  'admin.collab.notesHint': '附加到旅行的协作笔记',
  'admin.collab.polls': '投票',
  'admin.collab.pollsHint': '创建并投票决定团队事项',
  'admin.bagTracking.subtitle': '为打包物品启用重量和行李分配',
  'admin.atlas.geoTitle': '区域边界数据',
  'admin.atlas.geoHint': '更新地图集上使用的区域边界 GeoJSON 文件',
  'admin.atlas.geoRefresh': '立即更新',
  'admin.atlas.geoRefreshing': '更新中…',
  'admin.atlas.geoRefreshed': '区域边界数据已更新',
  'admin.atlas.geoRefreshError': '区域边界数据更新失败',
  ...
  'admin.addons.integrationHint': '后端服务和 API 集成',
  ...
  'vacay.inviteCalendarName': '日历：',
  'vacay.calendars': '日历',
  'vacay.myCalendar': '我的日历',
  'vacay.newCalendar': '新建日历',
  'vacay.calendarName': '日历名称',
  'vacay.calendarNamePlaceholder': '例如 工作团队、家庭',
  'vacay.createCalendar': '创建',
  'vacay.leaveCalendar': '离开日历',
  'vacay.deleteCalendar': '删除日历',
  'vacay.leaveCalendarHint': '将自己从此共享日历中移除。你的个人条目不受影响。',
  'vacay.deleteCalendarHint': '永久删除此日历并移除所有成员。',
  'vacay.leaveAction': '离开',
  'vacay.deleteAction': '删除',
  'vacay.shareDetailsDefault': '在共享日历中共享详情',
  'vacay.shareDetailsDefaultHint': '适用于新条目。现有条目不会更改。',
  'vacay.busyOnly': '忙碌',
  'vacay.eventName': '活动名称',
  'vacay.location': '地点',
  'vacay.note': '备注',
  'vacay.optional': '可选',
  'vacay.shareDetails': '共享详情',
  'vacay.shareDetailsHint': '活动名称、地点和备注对其他日历成员可见',
  'vacay.removeEntry': '删除',
  'vacay.markThrough': '标记至',
  'vacay.daysSelected': '{n} 天',
  'vacay.mixedValues': '多个属性…',
  'vacay.fusedWith': '已合并',
  'vacay.you': '你',
  'vacay.noData': '暂无数据',
  ...
  'dayplan.duplicateDay': '复制当天',
  'dayplan.pdfError': 'PDF 导出失败',
  'dayplan.transportWalking': '步行',
  'dayplan.transportCycling': '骑行',
  'dayplan.transportDriving': '驾车',
  ...
  'places.formPhone': '电话',
  'places.formPrice': '价格',
  'places.formPriceVisit': '价格（本次游览）',
  'places.whoIsGoing': '谁去？',
  'places.everyoneGoing': '所有人都去 — 点击排除某人',
  'places.formDuration': '预计游览时长（分钟）',
  'places.formTransportMode': '前往方式',
  'places.transportWalking': '步行',
  'places.transportCycling': '骑行',
  'places.transportDriving': '驾车',
  ...
  'budget.linkedToReservation': '已关联预订 — 请在那里编辑名称',
  'packing.saveAsTemplate': '保存为模板',
  'packing.templateName': '模板名称',
  'packing.templateSaved': '打包清单已保存为模板',
  'nav.offline': '离线',
  'dashboard.settlementCurrency': '结算货币',
  'dashboard.settlementCurrencyHint': '所有多货币费用将转换为此货币进行结算。一旦存在外币费用，则无法更改。',
  'places.importCsv': 'CSV',
  'places.csvImported': '已从 CSV 导入 {count} 个地点',
  'places.csvError': 'CSV 导入失败',
  'budget.table.members': '成员',
  'budget.addExpense': '添加费用',
  'budget.editExpense': '编辑费用',
  'budget.modal.owes': '欠款',
  'budget.modal.paid': '已付',
  'budget.modal.tip': '小费',
  'budget.modal.equalSplit': '平均分摊',
  'budget.modal.remaining': '剩余',
  'budget.modal.balanced': '已平衡',
  'budget.modal.notReconciled': '尚未对账',
  'budget.modal.originalAmount': '原始金额',
  'budget.modal.referenceAmount': '参考金额',
  'budget.modal.exchangeRate': '汇率',
  'budget.modal.fetchRate': '获取汇率',
  'budget.modal.currency': '货币',
  'budget.modal.receipts': '收据',
  'budget.modal.uploadReceipt': '附件',
  'budget.modal.noReceipts': '没有附加收据',
  'budget.charged': '已收费',
  'budget.balance': '余额',
  'planner.mayBeClosed': '此时可能已关闭',
  'memories.notConnectedMultipleHint': '请在设置中连接以下任一照片提供商：{provider_names}，以便为此行程添加照片。',
  ...
  'undo.importCsv': 'CSV 导入',
  'budget.settle': '结算预算',
  'budget.settledBadge': '由 {name} 于 {date} 结算',
  'budget.settledBanner': '此预算已结算。费用为只读状态。',
  'budget.settlement.previewTitle': '结算预算',
  'budget.settlement.previewSubtitle': '查看谁需要支付多少，然后通知所有人。',
  'budget.settlement.flows': '所需付款',
  'budget.settlement.noFlows': '全部平衡——无需付款。',
  'budget.settlement.unresolvedDrafts': '未解决的草稿',
  'budget.settlement.unresolvedDraftsHint': '结算前请先处理这些计划费用。',
  'budget.settlement.convertDraft': '转换',
  'budget.settlement.discardDraft': '丢弃',
  'budget.settlement.settleBtn': '结算并通知',
  'budget.settlement.confirmText': '此操作永久且不可撤销。费用将变为只读。',
  'budget.settlement.confirmBtn': '确认',
  'budget.settlement.alreadySettled': '此预算已经结算。',
  'budget.settlement.hasDrafts': '结算前请先处理所有草稿。',
  'notif.budget_settlement.title': '预算已结算',
  'notif.budget_settlement.text': '{actor} 已结算 {trip} 的预算',
  'notif.action.ive_paid': '我已付款',
  'notif.action.dismiss': '忽略',
  'notif.action.view_budget': '查看预算',
  'settings.notifyBudgetSettlement': '预算结算',
  'tripBadge.budgetUnsettled': '预算未结算',
  'tripBadge.budgetUnsettled.detail': '此行程已结束，但预算尚未结算。',
  'tripBadge.budgetUnsettled.action': '查看预算',
  'tripBadge.calendarConflict': '日历冲突',
  'tripBadge.calendarConflict.detail': '您的日历中有与此行程日期重叠的事件。',
  'tripBadge.calendarConflict.action': '查看日历',
  'tripBadge.missingDates': '缺少日期',
  'tripBadge.missingDates.detail': '添加旅行日期以检测冲突并启用提醒。',
  'tripBadge.missingDates.action': '编辑行程',
  'tripBadge.upcomingSoon': '{days} 天后出发',
  'tripBadge.upcomingSoon.detail': '您的行程为空——是时候计划了！',
  'tripBadge.upcomingSoon.action': '打开规划器',
  'tripBadge.emptyItinerary': '暂无行程',
  'tripBadge.emptyItinerary.detail': '没有为任何一天计划活动。',
  'tripBadge.emptyItinerary.action': '打开规划器',
  'tripBadge.more': '+{count} 更多',
  'trip.loading.budget': '加载预算中...',
  'trip.loading.reservations': '加载预订中...',
  'trip.loading.packing': '加载打包清单中...',
  'trip.loading.files': '加载文件中...',
  'trip.loading.collab': '加载消息中...',
  'trip.loading.memories': '加载回忆中...',
  'trip.myPreferences': '我的偏好',
  'trip.addToCalendar': '添加到我的日历',
  'trip.addToCalendarHint': '在您的个人假期日历中阻止这些日期。',
  'trip.calendarSyncing': '同步中...',
  'settings.notifyTodoDue': '待办事项今日到期',
  'collab.notes.expand': '展开',
  'dayplan.dayDetail': '日程详情',
  'dayplan.toast.routeError': '路线计算失败',
  'trip.toast.loadError': '加载行程失败',
  'trip.toast.tripUpdated': '行程已更新',
  'admin.mapsAutocompleteNominatimOnly': '使用 Nominatim 进行自动补全',
  'admin.mapsAutocompleteNominatimOnlyHint': '即使配置了 Google 密钥，也将自动补全路由到 OpenStreetMap，以降低 API 成本',
  'settings.mcp.tabs.apps': 'OAuth 2.1 应用',
  'settings.mcp.tabs.legacyTokens': '旧版令牌',
  'settings.mcp.tabs.sessions': '活跃会话',
  'settings.mcp.apps.empty': '暂无 OAuth 应用。创建一个以安全连接 AI 客户端。',
  'settings.mcp.apps.create': '创建应用',
  'settings.mcp.apps.name': '应用名称',
  'settings.mcp.apps.namePlaceholder': '如 Claude.ai、我的自动化',
  'settings.mcp.apps.redirectUris': '重定向 URI',
  'settings.mcp.apps.redirectUrisHint': '每行一个。必须使用 https://、http://localhost 或自定义协议。',
  'settings.mcp.apps.isPublic': '公开客户端（无密钥，仅 PKCE）',
  'settings.mcp.apps.scopes': '允许的权限',
  'settings.mcp.apps.preset': '预设：',
  ...
  'settings.mcp.apps.preset.readOnly': '只读',
  'settings.mcp.apps.created': '应用已创建',
  'settings.mcp.apps.createError': '创建应用失败',
  'settings.mcp.apps.deleted': '应用已删除',
  'settings.mcp.apps.deleteError': '删除应用失败',
  'settings.mcp.apps.secretOnce': '客户端密钥（仅显示一次）',
  'settings.mcp.apps.secretWarning': '请立即保存此密钥——无法找回。',
  'settings.mcp.apps.rotated': '密钥已轮换',
  'settings.mcp.apps.rotateError': '轮换密钥失败',
  'settings.mcp.apps.rotate': '轮换密钥',
  'settings.mcp.apps.delete': '删除',
  'settings.mcp.apps.publicBadge': '公开',
  'settings.mcp.apps.confidentialBadge': '保密',
  'settings.mcp.apps.legacyNotice': '新连接应使用上方的 OAuth 2.1 应用。',
  'settings.mcp.apps.modal.createTitle': '创建 OAuth 应用',
  'settings.mcp.apps.modal.done': '完成',
  'settings.mcp.apps.modal.creating': '创建中…',
  'settings.mcp.apps.modal.deleteTitle': '删除应用',
  'settings.mcp.apps.modal.deleteMessage': '此应用的所有令牌和会话将立即吊销。',
  'settings.mcp.sessions.empty': '无活跃 OAuth 会话。',
  'settings.mcp.sessions.revoke': '吊销',
  'settings.mcp.sessions.revoked': '会话已吊销',
  'settings.mcp.sessions.revokeError': '吊销会话失败',
  'settings.mcp.sessions.scopes': '权限',
  'settings.mcp.sessions.expires': '过期',
  'settings.mcp.legacyDeprecated': '已弃用',
  'settings.mcp.oauthAppsAdminNote': 'AI 客户端的 OAuth 2.1 应用在管理面板中配置。',
  'admin.tabs.oauthApps': 'OAuth 2.1 应用',
  'admin.oauthApps.title': 'OAuth 2.1 应用',
  'admin.oauthApps.subtitle': '注册 OAuth 客户端，使 AI 工具（Claude.ai、ChatGPT 等）能够连接到 MCP 端点。',
  'admin.oauthApps.registered': '已注册的应用',
}
