const br: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.showPlaceDescription': 'Mostrar descrição do local',
  ...
  'forgotPassword.successMsg': 'Se uma conta com esse email existir, um link de redefinição foi enviado.',
  ...
  'resetPassword.submit': 'Definir senha',
  'resetPassword.submitting': 'Definindo senha\u2026',
  'resetPassword.successTitle': 'Senha atualizada',
  'resetPassword.successMsg': 'Sua senha foi alterada. Agora você pode fazer login.',
  'resetPassword.signIn': 'Ir para o login',
  'resetPassword.invalidToken': 'Este link de redefinição é inválido ou expirou.',
  'resetPassword.mfaRequired': 'Sua conta tem autenticação de dois fatores ativada.',
  'resetPassword.mfaCode': 'Código do autenticador',
  ...
  'admin.mapsAutocompleteDisabled': 'Desativar busca de locais',
  'admin.mapsAutocompleteDisabledHint': 'Bloquear todas as chamadas de autocompletar/busca ao Google e Nominatim',
  'admin.mapsDetailsDisabled': 'Desativar detalhes de locais',
  'admin.mapsDetailsDisabledHint': 'Bloquear consultas de detalhes de locais (avaliações, análises, horários)',
  ...
  // File Types
  'admin.authMethods': 'Métodos de autenticação',
  'admin.passwordLogin': 'Login com senha',
  'admin.passwordLoginHint': 'Permitir que usuários façam login com email e senha',
  'admin.oidcLogin': 'Login SSO',
  'admin.oidcLoginHint': 'Permitir que usuários façam login via provedor OIDC configurado',
  'admin.oidcRegistration': 'Registro SSO',
  'admin.oidcRegistrationHint': 'Permitir a criação de novos usuários no primeiro login SSO',
  'admin.envOverrideHint': 'O login com senha é controlado pela variável de ambiente OIDC_ONLY e não pode ser alterado aqui.',
  'admin.defaultLanguage': 'Idioma padrão',
  'admin.defaultLanguageHint': 'Idioma exibido para usuários não autenticados. Visitantes ainda podem alterá-lo.',
  'admin.defaultLanguageAuto': 'Detectar automaticamente (idioma do navegador)',
  ...
  'admin.collab.chat': 'Chat ao vivo',
  'admin.collab.chatHint': 'Chat de viagem em tempo real para todos os membros',
  'admin.collab.notes': 'Notas compartilhadas',
  'admin.collab.notesHint': 'Notas colaborativas anexadas à viagem',
  'admin.collab.polls': 'Enquetes',
  'admin.collab.pollsHint': 'Criar e votar em decisões do grupo',
  'admin.bagTracking.subtitle': 'Ativar peso e atribuição de mala para itens da lista',
  'admin.atlas.geoTitle': 'Dados de fronteiras regionais',
  'admin.atlas.geoHint': 'Atualiza o arquivo GeoJSON de fronteiras regionais usado no mapa do Atlas',
  'admin.atlas.geoRefresh': 'Atualizar agora',
  'admin.atlas.geoRefreshing': 'Atualizando…',
  'admin.atlas.geoRefreshed': 'Dados de fronteiras regionais atualizados',
  'admin.atlas.geoRefreshError': 'Falha ao atualizar os dados de fronteiras regionais',
  ...
  'admin.addons.integrationHint': 'Serviços de backend e integrações de API',
  // Weather info
  ...
  'vacay.inviteCalendarName': 'Calendário:',
  'vacay.calendars': 'Calendários',
  'vacay.myCalendar': 'Meu Calendário',
  'vacay.newCalendar': 'Novo Calendário',
  'vacay.calendarName': 'Nome do calendário',
  'vacay.calendarNamePlaceholder': 'ex. Equipe de Trabalho, Família',
  'vacay.createCalendar': 'Criar',
  'vacay.leaveCalendar': 'Sair do Calendário',
  'vacay.deleteCalendar': 'Excluir Calendário',
  'vacay.leaveCalendarHint': 'Remover-se deste calendário compartilhado. Suas entradas pessoais não serão afetadas.',
  'vacay.deleteCalendarHint': 'Excluir permanentemente este calendário e remover todos os membros.',
  'vacay.leaveAction': 'Sair',
  'vacay.deleteAction': 'Excluir',
  'vacay.shareDetailsDefault': 'Compartilhar detalhes em calendários compartilhados',
  'vacay.shareDetailsDefaultHint': 'Aplica-se a novas entradas. As entradas existentes não são alteradas.',
  'vacay.busyOnly': 'Ocupado',
  'vacay.eventName': 'Nome do evento',
  'vacay.location': 'Local',
  'vacay.note': 'Nota',
  'vacay.optional': 'Opcional',
  'vacay.shareDetails': 'Compartilhar detalhes',
  'vacay.shareDetailsHint': 'Nome, local e nota são visíveis para outros membros do calendário',
  'vacay.removeEntry': 'Remover',
  'vacay.markThrough': 'Marcar até',
  'vacay.daysSelected': '{n} dias',
  'vacay.mixedValues': 'Vários valores…',
  ...
  'dayplan.toast.routeOptimizedWithConflict': 'Rota otimizada – alguns lugares foram movidos para caber nas restrições de tempo.',
  'dayplan.toast.routeExceedsDayEnd': 'Atenção: a rota otimizada excede sua hora de término do dia configurada.',
  ...
  'dayplan.duplicateDay': 'Duplicar dia',
  'dayplan.pdfError': 'Falha ao exportar PDF',
  'dayplan.transportWalking': 'A pé',
  'dayplan.transportCycling': 'Bici',
  'dayplan.transportDriving': 'Carro',
  ...
  'places.formPhone': 'Telefone',
  'places.formPrice': 'Preço',
  'places.formPriceVisit': 'Preço (esta visita)',
  'places.whoIsGoing': 'Quem vai?',
  'places.everyoneGoing': 'Todos vão — toque para excluir alguém',
  'places.formDuration': 'Duração da visita (min)',
  'places.formTransportMode': 'Como chegar',
  'places.transportWalking': 'A pé',
  'places.transportCycling': 'Bicicleta',
  'places.transportDriving': 'Carro',
  ...
  'photos.dropHere': 'Solte as fotos aqui',
  'photos.dropHereActive': 'Solte as fotos aqui...',
  'photos.dropHint': 'JPG, PNG, WebP · máx. 10 MB · até 30 fotos',
  ...
  'day.startTime': 'Início do dia',
  'day.endTime': 'Fim do dia',
  ...
  'memories.linkDateRange': 'Vincular intervalo de datas',
  'memories.preview': 'Pré-visualização',
  'memories.enableAutoSync': 'Ativar sincronização automática',
  'memories.disableAutoSync': 'Desativar sincronização automática',
  'memories.addDateSync': 'Adicionar sincronização por data',
  'memories.dateSyncLabel': 'Sincronização por data',
  'memories.lastSynced': 'Última sincronização',
  ...
  'notif.todo_due.title': 'Tarefa para hoje',
  'notif.todo_due.text': '{name} vence hoje em {trip}.',
  ...
  'nav.offline': 'Offline',
  'dashboard.settlementCurrency': 'Moeda de acerto',
  'dashboard.settlementCurrencyHint': 'Todas as despesas em múltiplas moedas serão convertidas para esta moeda no acerto. Não pode ser alterada após existirem despesas em moeda estrangeira.',
  'places.importCsv': 'CSV',
  'places.csvImported': '{count} locais importados do CSV',
  'places.csvError': 'Falha na importação do CSV',
  'budget.table.members': 'Membros',
  'budget.addExpense': 'Adicionar despesa',
  'budget.editExpense': 'Editar despesa',
  'budget.modal.owes': 'Deve',
  'budget.modal.paid': 'Pago',
  'budget.modal.tip': 'Gorjeta',
  'budget.modal.equalSplit': 'Divisão igual',
  'budget.modal.remaining': 'restante',
  'budget.modal.balanced': 'Equilibrado',
  'budget.modal.notReconciled': 'Ainda não conciliado',
  'budget.modal.originalAmount': 'Valor original',
  'budget.modal.referenceAmount': 'Valor de referência',
  'budget.modal.exchangeRate': 'Taxa de câmbio',
  'budget.modal.fetchRate': 'Buscar taxa',
  'budget.modal.currency': 'Moeda',
  'budget.modal.receipts': 'Recibos',
  'budget.modal.uploadReceipt': 'Anexar',
  'budget.modal.noReceipts': 'Nenhum recibo anexado',
  'budget.charged': 'Cobrado',
  'budget.balance': 'Saldo',
  'planner.mayBeClosed': 'Pode estar fechado neste horário',
  ...
  'memories.saveError': 'Não foi possível salvar as configurações do {provider_name}',
  'memories.selectAlbumMultiple': 'Selecionar álbum',
  'memories.selectPhotosMultiple': 'Selecionar fotos',
  'undo.importCsv': 'Importação CSV',
  'budget.settle': 'Quitar o orçamento',
  'budget.settledBadge': 'Quitado em {date} por {name}',
  'budget.settledBanner': 'Este orçamento foi quitado. As despesas são somente leitura.',
  'budget.settlement.previewTitle': 'Quitar o orçamento',
  'budget.settlement.previewSubtitle': 'Revise quem deve pagar o quê e notifique todos.',
  'budget.settlement.flows': 'Pagamentos necessários',
  'budget.settlement.noFlows': 'Tudo equilibrado — nenhum pagamento necessário.',
  'budget.settlement.unresolvedDrafts': 'Rascunhos não resolvidos',
  'budget.settlement.unresolvedDraftsHint': 'Resolva essas despesas planejadas antes de quitar.',
  'budget.settlement.convertDraft': 'Converter',
  'budget.settlement.discardDraft': 'Descartar',
  'budget.settlement.settleBtn': 'Quitar e notificar',
  'budget.settlement.confirmText': 'Esta ação é permanente e não pode ser desfeita. As despesas tornam-se somente leitura.',
  'budget.settlement.confirmBtn': 'Confirmar',
  'budget.settlement.alreadySettled': 'Este orçamento já foi quitado.',
  'budget.settlement.hasDrafts': 'Resolva todos os rascunhos antes de quitar.',
  'notif.budget_settlement.title': 'Orçamento quitado',
  'notif.budget_settlement.text': '{actor} quitou o orçamento de {trip}',
  'notif.action.ive_paid': 'Já paguei',
  'notif.action.dismiss': 'Dispensar',
  'notif.action.view_budget': 'Ver orçamento',
  'settings.notifyBudgetSettlement': 'Quitações de orçamento',
  'tripBadge.budgetUnsettled': 'Orçamento pendente',
  'tripBadge.budgetUnsettled.detail': 'Esta viagem terminou com despesas não quitadas.',
  'tripBadge.budgetUnsettled.action': 'Revisar orçamento',
  'tripBadge.calendarConflict': 'Conflito de calendário',
  'tripBadge.calendarConflict.detail': 'Seu calendário tem eventos que se sobrepõem a essas datas.',
  'tripBadge.calendarConflict.action': 'Ver calendário',
  'tripBadge.missingDates': 'Datas não definidas',
  'tripBadge.missingDates.detail': 'Adicione datas de viagem para detectar conflitos e ativar lembretes.',
  'tripBadge.missingDates.action': 'Editar viagem',
  'tripBadge.upcomingSoon': 'Começa em {days} dias',
  'tripBadge.upcomingSoon.detail': 'Seu itinerário está vazio — hora de planejar!',
  'tripBadge.upcomingSoon.action': 'Abrir planejador',
  'tripBadge.emptyItinerary': 'Sem itinerário ainda',
  'tripBadge.emptyItinerary.detail': 'Nenhuma atividade está planejada para nenhum dia.',
  'tripBadge.emptyItinerary.action': 'Abrir planejador',
  'tripBadge.more': '+{count} mais',
  'trip.loading.budget': 'Carregando orçamento...',
  'trip.loading.reservations': 'Carregando reservas...',
  'trip.loading.packing': 'Carregando lista de bagagem...',
  'trip.loading.files': 'Carregando arquivos...',
  'trip.loading.collab': 'Carregando mensagens...',
  'trip.loading.memories': 'Carregando memórias...',
  'trip.myPreferences': 'Minhas preferências',
  'trip.addToCalendar': 'Adicionar ao meu calendário',
  'trip.addToCalendarHint': 'Bloqueie essas datas no seu calendário de férias pessoal.',
  'trip.calendarSyncing': 'Sincronizando...',
  'settings.notifyTodoDue': 'Tarefa vencida hoje',
  'collab.notes.expand': 'Expandir',
  'dayplan.dayDetail': 'Detalhes do dia',
  'dayplan.toast.routeError': 'Falha ao calcular rota',
  'trip.toast.loadError': 'Falha ao carregar viagem',
  'trip.toast.tripUpdated': 'Viagem atualizada',
  'admin.mapsAutocompleteNominatimOnly': 'Usar Nominatim para autocompletar',
  'admin.mapsAutocompleteNominatimOnlyHint': 'Redirecionar autocompletar para OpenStreetMap mesmo com uma chave Google configurada, para reduzir custos de API',
  'settings.mcp.tabs.apps': 'Apps OAuth 2.1',
  'settings.mcp.tabs.legacyTokens': 'Tokens legados',
  'settings.mcp.tabs.sessions': 'Sessões ativas',
  'settings.mcp.apps.empty': 'Nenhum app OAuth ainda. Crie um para conectar clientes de IA com segurança.',
  'settings.mcp.apps.create': 'Criar app',
  'settings.mcp.apps.name': 'Nome do app',
  'settings.mcp.apps.namePlaceholder': 'ex.: Claude.ai, Minha automação',
  'settings.mcp.apps.redirectUris': 'URIs de redirecionamento',
  'settings.mcp.apps.redirectUrisHint': 'Um por linha. Deve usar https://, http://localhost ou um esquema personalizado.',
  'settings.mcp.apps.isPublic': 'Cliente público (sem segredo, somente PKCE)',
  'settings.mcp.apps.scopes': 'Permissões permitidas',
  'settings.mcp.apps.preset': 'Predefinição:',
  ...
  'settings.mcp.apps.preset.readOnly': 'Somente leitura',
  'settings.mcp.apps.created': 'App criado',
  'settings.mcp.apps.createError': 'Falha ao criar app',
  'settings.mcp.apps.deleted': 'App excluído',
  'settings.mcp.apps.deleteError': 'Falha ao excluir app',
  'settings.mcp.apps.secretOnce': 'Segredo do cliente (exibido uma vez)',
  'settings.mcp.apps.secretWarning': 'Salve este segredo agora — ele não pode ser recuperado.',
  'settings.mcp.apps.rotated': 'Segredo renovado',
  'settings.mcp.apps.rotateError': 'Falha ao renovar segredo',
  'settings.mcp.apps.rotate': 'Renovar segredo',
  'settings.mcp.apps.delete': 'Excluir',
  'settings.mcp.apps.publicBadge': 'Público',
  'settings.mcp.apps.confidentialBadge': 'Confidencial',
  'settings.mcp.apps.legacyNotice': 'Novas conexões devem usar os Apps OAuth 2.1 acima.',
  'settings.mcp.apps.modal.createTitle': 'Criar app OAuth',
  'settings.mcp.apps.modal.done': 'Concluído',
  'settings.mcp.apps.modal.creating': 'Criando…',
  'settings.mcp.apps.modal.deleteTitle': 'Excluir app',
  'settings.mcp.apps.modal.deleteMessage': 'Todos os tokens e sessões deste app serão revogados imediatamente.',
  'settings.mcp.sessions.empty': 'Nenhuma sessão OAuth ativa.',
  'settings.mcp.sessions.revoke': 'Revogar',
  'settings.mcp.sessions.revoked': 'Sessão revogada',
  'settings.mcp.sessions.revokeError': 'Falha ao revogar sessão',
  'settings.mcp.sessions.scopes': 'Permissões',
  'settings.mcp.sessions.expires': 'Expira',
  'settings.mcp.legacyDeprecated': 'Obsoleto',
  'settings.mcp.oauthAppsAdminNote': 'Os apps OAuth 2.1 para clientes de IA são configurados no painel de administração.',
  'admin.tabs.oauthApps': 'Apps OAuth 2.1',
  'admin.oauthApps.title': 'Apps OAuth 2.1',
  'admin.oauthApps.subtitle': 'Registre clientes OAuth para que ferramentas de IA (Claude.ai, ChatGPT, etc.) possam se conectar ao endpoint MCP.',
  'admin.oauthApps.registered': 'Apps registrados',
}
