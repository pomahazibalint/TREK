const en: Record<string, string | { name: string; category: string }[]> = {
  ...
  'dashboard.settlementCurrency': 'Settlement Currency',
  'dashboard.settlementCurrencyHint': 'All multi-currency expenses will be converted to this currency for settlement. Cannot be changed once foreign-currency expenses exist.',
  ...
  'settings.showPlaceDescription': 'Show place description',
  ...
  'settings.mcp.tabs.sessions': 'Active Sessions',
  'settings.mcp.apps.empty': 'No OAuth apps yet. Create one to connect AI clients securely.',
  'settings.mcp.apps.create': 'Create App',
  'settings.mcp.apps.name': 'App Name',
  'settings.mcp.apps.namePlaceholder': 'e.g. Claude.ai, My Automation',
  'settings.mcp.apps.redirectUris': 'Redirect URIs',
  'settings.mcp.apps.redirectUrisHint': 'One per line. Must use https://, http://localhost, or a custom scheme.',
  'settings.mcp.apps.isPublic': 'Public client (no secret, PKCE only)',
  'settings.mcp.apps.scopes': 'Allowed Scopes',
  'settings.mcp.apps.preset': 'Preset:',
  ...
  'settings.mcp.apps.preset.readOnly': 'Read-only',
  'settings.mcp.apps.created': 'App created',
  'settings.mcp.apps.createError': 'Failed to create app',
  'settings.mcp.apps.deleted': 'App deleted',
  'settings.mcp.apps.deleteError': 'Failed to delete app',
  'settings.mcp.apps.secretOnce': 'Client Secret (shown once)',
  'settings.mcp.apps.secretWarning': 'Store this secret now — it cannot be recovered.',
  'settings.mcp.apps.rotated': 'Secret rotated',
  'settings.mcp.apps.rotateError': 'Failed to rotate secret',
  'settings.mcp.apps.rotate': 'Rotate Secret',
  'settings.mcp.apps.delete': 'Delete',
  'settings.mcp.apps.publicBadge': 'Public',
  'settings.mcp.apps.confidentialBadge': 'Confidential',
  'settings.mcp.apps.legacyNotice': 'New connections should use OAuth 2.1 Apps above.',
  'settings.mcp.apps.modal.createTitle': 'Create OAuth App',
  'settings.mcp.apps.modal.done': 'Done',
  'settings.mcp.apps.modal.creating': 'Creating…',
  'settings.mcp.apps.modal.deleteTitle': 'Delete App',
  'settings.mcp.apps.modal.deleteMessage': 'All tokens and sessions for this app will be revoked immediately.',
  'settings.mcp.sessions.empty': 'No active OAuth sessions.',
  'settings.mcp.sessions.revoke': 'Revoke',
  'settings.mcp.sessions.revoked': 'Session revoked',
  'settings.mcp.sessions.revokeError': 'Failed to revoke session',
  ...
  'forgotPassword.successMsg': 'If an account with that email exists, a reset link has been sent.',
  ...
  'resetPassword.submitting': 'Setting password…',
  'resetPassword.successTitle': 'Password updated',
  'resetPassword.successMsg': 'Your password has been changed. You can now sign in.',
  'resetPassword.signIn': 'Go to sign in',
  'resetPassword.invalidToken': 'This reset link is invalid or has expired.',
  'resetPassword.mfaRequired': 'Your account has two-factor authentication enabled.',
  'resetPassword.mfaCode': 'Authenticator code',
  ...
  'admin.passwordLoginHint': 'Allow users to log in with email and password',
  'admin.oidcLogin': 'SSO login',
  'admin.oidcLoginHint': 'Allow users to log in via the configured OIDC provider',
  'admin.oidcRegistration': 'SSO registration',
  'admin.oidcRegistrationHint': 'Allow new users to be created on first SSO login',
  'admin.envOverrideHint': 'Password login is controlled by the OIDC_ONLY environment variable and cannot be changed here.',
  ...
  'admin.mapsKillSwitches': 'API Kill Switches',
  'admin.mapsAutocompleteDisabled': 'Disable place search',
  ...
  'admin.defaultLanguageHint': 'Language shown to unauthenticated users. Visitors can still override it.',
  'admin.defaultLanguageAuto': 'Auto-detect (browser language)',
  ...
  'admin.collab.notesHint': 'Collaborative notes attached to the trip',
  'admin.collab.polls': 'Polls',
  'admin.collab.pollsHint': 'Create and vote on group decisions',
  ...
  'admin.addons.type.feature': 'Features',
  ...
  'admin.addons.featureHint': 'Optional features that can be disabled for policy or compliance reasons',
  'admin.addons.catalog.google_list_import.name': 'Google Maps List Import',
  'admin.addons.catalog.google_list_import.description': 'Import places from a shared Google Maps list URL. Uses an unofficial Google endpoint — disable if needed.',
  'admin.addons.catalog.link_preview.name': 'Link Previews',
  'admin.addons.catalog.link_preview.description': 'Fetch metadata for URLs shared in Collab. The server makes outbound requests to external sites.',
  ...
  'vacay.inviteTitle': 'Calendar Invite',
  'vacay.inviteWantsToFuse': 'invited you to join a shared calendar.',
  'vacay.inviteCalendarName': 'Calendar:',
  'vacay.fuseInfo1': 'You will see all members\' vacation entries in this calendar.',
  'vacay.fuseInfo2': 'You can create and edit your own entries.',
  'vacay.fuseInfo3': 'The calendar owner can edit entitlements for all members.',
  'vacay.fuseInfo4': 'Settings like public holidays are shared across the calendar.',
  'vacay.fuseInfo5': 'You can leave the calendar at any time. Your own entries are preserved.',
  'vacay.calendars': 'Calendars',
  'vacay.myCalendar': 'My Calendar',
  'vacay.newCalendar': 'New Calendar',
  'vacay.calendarName': 'Calendar name',
  'vacay.calendarNamePlaceholder': 'e.g. Work Team, Family',
  'vacay.createCalendar': 'Create',
  'vacay.leaveCalendar': 'Leave Calendar',
  'vacay.deleteCalendar': 'Delete Calendar',
  'vacay.leaveCalendarHint': 'Remove yourself from this shared calendar. Your personal entries are not affected.',
  'vacay.deleteCalendarHint': 'Permanently delete this calendar and remove all members.',
  'vacay.leaveAction': 'Leave',
  'vacay.deleteAction': 'Delete',
  ...
  'dayplan.toast.routeOptimizedWithConflict': 'Route optimized — some places were moved to fit within time constraints.',
  'dayplan.toast.routeExceedsDayEnd': 'Heads up: the optimized route exceeds your configured day end time.',
  ...
  'dayplan.duplicateDay': 'Duplicate day',
  ...
  'places.csvImported': '{count} places imported from CSV',
  'places.csvError': 'CSV import failed',
  ...
  'places.formPriceVisit': 'Price (this visit)',
  'places.whoIsGoing': "Who's going?",
  'places.everyoneGoing': 'Everyone is going — tap to exclude someone',
  'places.formDuration': 'Duration (min)',
  'places.formTransportMode': 'Getting here by',
  'places.transportWalking': 'Walking',
  'places.transportCycling': 'Cycling',
  'places.transportDriving': 'Driving',
  ...
  'budget.settlementInfo': 'Shows the minimum set of payments needed to settle all debts. Only expenses with both sides fully configured are included.',
  'budget.netBalances': 'Net Balances',
  'budget.modal.owes': 'Owes',
  'budget.modal.paid': 'Paid',
  'budget.modal.tip': 'Tip',
  'budget.modal.equalSplit': 'Equal split',
  'budget.modal.remaining': 'remaining',
  'budget.modal.balanced': 'Balanced',
  'budget.modal.notReconciled': 'Not yet reconciled',
  'budget.modal.originalAmount': 'Original amount',
  'budget.modal.referenceAmount': 'Ref. amount',
  'budget.modal.exchangeRate': 'Exchange rate',
  'budget.modal.fetchRate': 'Fetch rate',
  'budget.modal.currency': 'Currency',
  'budget.modal.receipts': 'Receipts',
  'budget.modal.uploadReceipt': 'Attach',
  'budget.modal.noReceipts': 'No receipts attached',
  'budget.charged': 'Charged',
  'budget.paid': 'Paid',
  'budget.balance': 'Balance',
  'budget.perPerson': 'Per Person',
  'budget.open': 'Open',
  'budget.settle': 'Settle Budget',
  'budget.settledBadge': 'Settled on {date} by {name}',
  'budget.settledBanner': 'This budget has been settled. Expenses are read-only.',
  'budget.settlement.previewTitle': 'Settle Budget',
  'budget.settlement.previewSubtitle': 'Review who needs to pay what, then notify everyone.',
  'budget.settlement.flows': 'Payments Required',
  'budget.settlement.noFlows': 'All balanced — no payments needed.',
  'budget.settlement.unresolvedDrafts': 'Unresolved Drafts',
  'budget.settlement.unresolvedDraftsHint': 'Resolve these planned expenses before settling.',
  'budget.settlement.convertDraft': 'Convert',
  'budget.settlement.discardDraft': 'Discard',
  'budget.settlement.settleBtn': 'Settle & notify',
  'budget.settlement.confirmText': 'This is permanent and cannot be undone. Expenses will become read-only.',
  'budget.settlement.confirmBtn': 'Confirm',
  'budget.settlement.alreadySettled': 'This budget has already been settled.',
  'budget.settlement.hasDrafts': 'Resolve all drafts before settling.',
  ...
  'memories.dateSyncLabel': 'Date sync',
  'memories.lastSynced': 'Last synced',
  ...
  'notif.todo_due.title': 'To-do Due Today',
  'notif.todo_due.text': '{name} is due today in {trip}.',
  ...
  'notif.budget_settlement.title': 'Budget Settled',
  'notif.budget_settlement.text': '{actor} settled the budget for {trip}',
  ...
  'notif.action.ive_paid': "I've paid",
  'notif.action.dismiss': 'Dismiss',
  'notif.action.view_budget': 'View Budget',
