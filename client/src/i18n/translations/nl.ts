const nl: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.showPlaceDescription': 'Plaatsbeschrijving weergeven',
  ...
  'forgotPassword.title': 'Wachtwoord opnieuw instellen',
  'forgotPassword.subtitle': 'Voer je e-mailadres in en we sturen je een resetlink.',
  'forgotPassword.email': 'E-mailadres',
  'forgotPassword.submit': 'Resetlink verzenden',
  'forgotPassword.sending': 'Verzenden\u2026',
  'forgotPassword.successTitle': 'Controleer je inbox',
  'forgotPassword.successMsg': 'Als er een account bestaat met dat e-mailadres, is er een resetlink verzonden.',
  'forgotPassword.backToLogin': '← Terug naar inloggen',
  'resetPassword.title': 'Nieuw wachtwoord instellen',
  'resetPassword.subtitle': 'Voer hieronder je nieuwe wachtwoord in.',
  'resetPassword.password': 'Nieuw wachtwoord',
  'resetPassword.submit': 'Wachtwoord instellen',
  'resetPassword.submitting': 'Wachtwoord instellen\u2026',
  'resetPassword.successTitle': 'Wachtwoord bijgewerkt',
  'resetPassword.successMsg': 'Je wachtwoord is gewijzigd. Je kunt nu inloggen.',
  'resetPassword.signIn': 'Ga naar inloggen',
  'resetPassword.invalidToken': 'Deze resetlink is ongeldig of verlopen.',
  'resetPassword.mfaRequired': 'Je account heeft tweefactorauthenticatie ingeschakeld.',
  'resetPassword.mfaCode': 'Authenticatiecode',
  ...
  'admin.mapsKillSwitches': 'API-uitschakelaars',
  'admin.mapsAutocompleteDisabled': 'Plaatsen zoeken uitschakelen',
  'admin.mapsAutocompleteDisabledHint': 'Alle automatisch aanvullen/tekstzoekopdrachten naar Google en Nominatim blokkeren',
  'admin.mapsDetailsDisabled': 'Plaatsdetails uitschakelen',
  'admin.mapsDetailsDisabledHint': 'Zoekopdrachten naar plaatsdetails blokkeren (beoordelingen, recensies, openingstijden)',
  ...
  'admin.passwordLogin': 'Wachtwoordlogin',
  'admin.passwordLoginHint': 'Gebruikers toestaan in te loggen met e-mail en wachtwoord',
  'admin.oidcLogin': 'SSO-login',
  'admin.oidcLoginHint': 'Gebruikers toestaan in te loggen via de geconfigureerde OIDC-provider',
  'admin.oidcRegistration': 'SSO-registratie',
  'admin.oidcRegistrationHint': 'Nieuwe gebruikers aanmaken bij eerste SSO-login toestaan',
  'admin.envOverrideHint': 'Wachtwoordlogin wordt beheerd door de omgevingsvariabele OIDC_ONLY en kan hier niet worden gewijzigd.',
  'admin.defaultLanguage': 'Standaardtaal',
  'admin.defaultLanguageHint': 'Taal weergegeven aan niet-ingelogde gebruikers. Bezoekers kunnen het nog steeds overschrijven.',
  'admin.defaultLanguageAuto': 'Automatisch detecteren (browsertaal)',
  ...
  'admin.collab.chatHint': 'Realtime reischat voor alle leden',
  'admin.collab.notes': 'Gedeelde notities',
  'admin.collab.notesHint': 'Collaboratieve notities bij de reis',
  'admin.collab.polls': 'Peilingen',
  'admin.collab.pollsHint': 'Groepsbeslissingen aanmaken en erover stemmen',
  'admin.bagTracking.subtitle': 'Gewicht en bagagetoewijzing inschakelen voor paklijstitems',
  'admin.atlas.geoTitle': 'Regiogrensgegevens',
  'admin.atlas.geoHint': 'Werkt het GeoJSON-bestand bij met regiosgrenzen voor de Atlaskaart',
  'admin.atlas.geoRefresh': 'Nu bijwerken',
  'admin.atlas.geoRefreshing': 'Bijwerken…',
  'admin.atlas.geoRefreshed': 'Regiogrensgegevens bijgewerkt',
  'admin.atlas.geoRefreshError': 'Bijwerken regiogrensgegevens mislukt',
  ...
  'admin.addons.integrationHint': 'Backenddiensten en API-integraties',
  ...
  'vacay.calendars': 'Kalenders',
  'vacay.myCalendar': 'Mijn Kalender',
  'vacay.newCalendar': 'Nieuwe Kalender',
  'vacay.calendarName': 'Kalendernaam',
  'vacay.calendarNamePlaceholder': 'bijv. Werkteam, Familie',
  'vacay.createCalendar': 'Aanmaken',
  'vacay.leaveCalendar': 'Kalender verlaten',
  'vacay.deleteCalendar': 'Kalender verwijderen',
  'vacay.leaveCalendarHint': 'Jezelf verwijderen uit deze gedeelde kalender. Je persoonlijke invoeren worden niet beïnvloed.',
  'vacay.deleteCalendarHint': 'Deze kalender permanent verwijderen en alle leden verwijderen.',
  'vacay.leaveAction': 'Verlaten',
  'vacay.deleteAction': 'Verwijderen',
  'vacay.shareDetailsDefault': 'Details delen in gedeelde kalenders',
  'vacay.shareDetailsDefaultHint': 'Geldt voor nieuwe invoeren. Bestaande invoeren worden niet gewijzigd.',
  'vacay.busyOnly': 'Bezet',
  'vacay.eventName': 'Naam evenement',
  'vacay.location': 'Locatie',
  'vacay.note': 'Notitie',
  'vacay.optional': 'Optioneel',
  'vacay.shareDetails': 'Details delen',
  'vacay.shareDetailsHint': 'Naam, locatie en notitie zijn zichtbaar voor andere kalenderleden',
  'vacay.removeEntry': 'Verwijderen',
  'vacay.markThrough': 'Markeren tot',
  'vacay.daysSelected': '{n} dagen',
  'vacay.mixedValues': 'Meerdere waarden…',
  ...
  'dayplan.duplicateDay': 'Dag dupliceren',
  'dayplan.pdfError': 'PDF-export mislukt',
  'dayplan.transportWalking': 'Lopen',
  'dayplan.transportCycling': 'Fiets',
  ...
  'places.formPhone': 'Telefoon',
  'places.formPrice': 'Prijs',
  'places.formPriceVisit': 'Prijs (dit bezoek)',
  'places.whoIsGoing': 'Wie gaat mee?',
  'places.everyoneGoing': 'Iedereen gaat — tik om iemand uit te sluiten',
  'places.formDuration': 'Bezoekduur (min)',
  'places.formTransportMode': 'Vervoer naar',
  'places.transportWalking': 'Lopen',
  'places.transportCycling': 'Fietsen',
  'places.transportDriving': 'Rijden',
  ...
  'memories.dateSyncLabel': 'Datumsynchronisatie',
  'memories.lastSynced': 'Laatst gesynchroniseerd',
  ...
  'notif.todo_due.title': 'Taak vandaag te doen',
  'notif.todo_due.text': '{name} is vandaag te doen in {trip}.',
  ...
  'nav.offline': 'Offline',
  'dashboard.settlementCurrency': 'Verrekeningsvaluta',
  'dashboard.settlementCurrencyHint': 'Alle uitgaven in meerdere valuta worden omgezet naar deze valuta voor verrekening. Kan niet worden gewijzigd zodra er uitgaven in vreemde valuta bestaan.',
  'places.importCsv': 'CSV',
  'places.csvImported': '{count} plaatsen geïmporteerd uit CSV',
  'places.csvError': 'CSV-import mislukt',
  'budget.table.members': 'Leden',
  'budget.addExpense': 'Uitgave toevoegen',
  'budget.editExpense': 'Uitgave bewerken',
  'budget.modal.owes': 'Verschuldigd',
  'budget.modal.paid': 'Betaald',
  'budget.modal.tip': 'Fooi',
  'budget.modal.equalSplit': 'Gelijk verdelen',
  'budget.modal.remaining': 'resterend',
  'budget.modal.balanced': 'Uitgebalanceerd',
  'budget.modal.notReconciled': 'Nog niet afgestemd',
  'budget.modal.originalAmount': 'Oorspronkelijk bedrag',
  'budget.modal.referenceAmount': 'Referentiebedrag',
  'budget.modal.exchangeRate': 'Wisselkoers',
  'budget.modal.fetchRate': 'Koers ophalen',
  'budget.modal.currency': 'Valuta',
  'budget.modal.receipts': 'Bonnen',
  'budget.modal.uploadReceipt': 'Bijvoegen',
  'budget.modal.noReceipts': 'Geen bonnen bijgevoegd',
  'budget.charged': 'In rekening gebracht',
  'budget.balance': 'Saldo',
  'planner.mayBeClosed': 'Mogelijk gesloten op dit tijdstip',
  'memories.notConnectedMultipleHint': "Verbind een van deze fotoproviders: {provider_names} in Instellingen om foto's aan deze reis te kunnen toevoegen.",
  ...
  'budget.settle': 'Budget verrekenen',
  'budget.settledBadge': 'Verrekend op {date} door {name}',
  'budget.settledBanner': 'Dit budget is verrekend. Uitgaven zijn alleen-lezen.',
  'budget.settlement.previewTitle': 'Budget verrekenen',
  'budget.settlement.previewSubtitle': 'Controleer wie wat moet betalen en stel iedereen op de hoogte.',
  'budget.settlement.flows': 'Vereiste betalingen',
  'budget.settlement.noFlows': 'Alles is vereffend — geen betalingen nodig.',
  'budget.settlement.unresolvedDrafts': 'Onopgeloste concepten',
  'budget.settlement.unresolvedDraftsHint': 'Los deze geplande uitgaven op voordat je verrekent.',
  'budget.settlement.convertDraft': 'Converteren',
  'budget.settlement.discardDraft': 'Verwijderen',
  'budget.settlement.settleBtn': 'Verrekenen & melden',
  'budget.settlement.confirmText': 'Dit is permanent en kan niet ongedaan worden gemaakt. Uitgaven worden alleen-lezen.',
  'budget.settlement.confirmBtn': 'Bevestigen',
  'budget.settlement.alreadySettled': 'Dit budget is al verrekend.',
  'budget.settlement.hasDrafts': 'Los alle concepten op voordat je verrekent.',
  'notif.budget_settlement.title': 'Budget verrekend',
  'notif.budget_settlement.text': '{actor} heeft het budget voor {trip} verrekend',
  'notif.action.ive_paid': 'Ik heb betaald',
  'notif.action.dismiss': 'Sluiten',
  'notif.action.view_budget': 'Budget bekijken',
  'settings.notifyBudgetSettlement': 'Budgetverrekeningen',
  'tripBadge.budgetUnsettled': 'Budget niet verrekend',
  'tripBadge.budgetUnsettled.detail': 'Deze reis is beëindigd met onverrekende uitgaven.',
  'tripBadge.budgetUnsettled.action': 'Budget bekijken',
  'tripBadge.calendarConflict': 'Agendaconflict',
  'tripBadge.calendarConflict.detail': 'Je agenda heeft events die overlappen met deze reisdatums.',
  'tripBadge.calendarConflict.action': 'Agenda bekijken',
  'tripBadge.missingDates': 'Datums ontbreken',
  'tripBadge.missingDates.detail': 'Voeg reisdatums toe voor conflictdetectie en herinneringen.',
  'tripBadge.missingDates.action': 'Reis bewerken',
  'tripBadge.upcomingSoon': 'Begint over {days} dagen',
  'tripBadge.upcomingSoon.detail': 'Je reisschema is leeg — tijd om te plannen!',
  'tripBadge.upcomingSoon.action': 'Planner openen',
  'tripBadge.emptyItinerary': 'Nog geen reisschema',
  'tripBadge.emptyItinerary.detail': 'Er zijn geen activiteiten gepland voor enige dag.',
  'tripBadge.emptyItinerary.action': 'Planner openen',
  'tripBadge.more': '+{count} meer',
  'trip.loading.budget': 'Budget laden...',
  'trip.loading.reservations': 'Boekingen laden...',
  'trip.loading.packing': 'Paklijst laden...',
  'trip.loading.files': 'Bestanden laden...',
  'trip.loading.collab': 'Berichten laden...',
  'trip.loading.memories': 'Herinneringen laden...',
  'trip.myPreferences': 'Mijn voorkeuren',
  'trip.addToCalendar': 'Toevoegen aan mijn agenda',
  'trip.addToCalendarHint': 'Blokkeer deze datums in je persoonlijke vakantieagenda.',
  'trip.calendarSyncing': 'Synchroniseren...',
  'settings.notifyTodoDue': 'Taak vandaag te doen',
  'collab.notes.expand': 'Uitvouwen',
  'dayplan.dayDetail': 'Dagdetails',
  'dayplan.toast.routeError': 'Route berekenen mislukt',
  'trip.toast.loadError': 'Reis laden mislukt',
  'trip.toast.tripUpdated': 'Reis bijgewerkt',
  'admin.mapsAutocompleteNominatimOnly': 'Nominatim gebruiken voor automatisch aanvullen',
  'admin.mapsAutocompleteNominatimOnlyHint': 'Automatisch aanvullen omleiden naar OpenStreetMap, ook bij geconfigureerde Google-sleutel, om API-kosten te verlagen',
  'settings.mcp.tabs.apps': 'OAuth 2.1-apps',
  'settings.mcp.tabs.legacyTokens': 'Legacy-tokens',
  'settings.mcp.tabs.sessions': 'Actieve sessies',
  'settings.mcp.apps.empty': 'Nog geen OAuth-apps. Maak er een aan om AI-clients veilig te verbinden.',
  'settings.mcp.apps.create': 'App aanmaken',
  'settings.mcp.apps.name': 'App-naam',
  'settings.mcp.apps.namePlaceholder': 'bijv. Claude.ai, Mijn automatisering',
  'settings.mcp.apps.redirectUris': 'Omleidings-URI\'s',
  'settings.mcp.apps.redirectUrisHint': 'Één per regel. Moet https://, http://localhost of een aangepast schema gebruiken.',
  'settings.mcp.apps.isPublic': 'Publieke client (geen geheim, alleen PKCE)',
  'settings.mcp.apps.scopes': 'Toegestane rechten',
  'settings.mcp.apps.preset': 'Voorinstelling:',
  ...
  'settings.mcp.apps.preset.readOnly': 'Alleen lezen',
  'settings.mcp.apps.created': 'App aangemaakt',
  'settings.mcp.apps.createError': 'Aanmaken app mislukt',
  'settings.mcp.apps.deleted': 'App verwijderd',
  'settings.mcp.apps.deleteError': 'Verwijderen app mislukt',
  'settings.mcp.apps.secretOnce': 'Clientgeheim (eenmalig getoond)',
  'settings.mcp.apps.secretWarning': 'Sla dit geheim nu op — het kan niet worden hersteld.',
  'settings.mcp.apps.rotated': 'Geheim vernieuwd',
  'settings.mcp.apps.rotateError': 'Vernieuwen geheim mislukt',
  'settings.mcp.apps.rotate': 'Geheim vernieuwen',
  'settings.mcp.apps.delete': 'Verwijderen',
  'settings.mcp.apps.publicBadge': 'Openbaar',
  'settings.mcp.apps.confidentialBadge': 'Vertrouwelijk',
  'settings.mcp.apps.legacyNotice': 'Nieuwe verbindingen moeten de OAuth 2.1-apps hierboven gebruiken.',
  'settings.mcp.apps.modal.createTitle': 'OAuth-app aanmaken',
  'settings.mcp.apps.modal.done': 'Klaar',
  'settings.mcp.apps.modal.creating': 'Aanmaken…',
  'settings.mcp.apps.modal.deleteTitle': 'App verwijderen',
  'settings.mcp.apps.modal.deleteMessage': 'Alle tokens en sessies van deze app worden onmiddellijk ingetrokken.',
  'settings.mcp.sessions.empty': 'Geen actieve OAuth-sessies.',
  'settings.mcp.sessions.revoke': 'Intrekken',
  'settings.mcp.sessions.revoked': 'Sessie ingetrokken',
  'settings.mcp.sessions.revokeError': 'Intrekken sessie mislukt',
  'settings.mcp.sessions.scopes': 'Rechten',
  'settings.mcp.sessions.expires': 'Verloopt',
  'settings.mcp.legacyDeprecated': 'Verouderd',
  'settings.mcp.oauthAppsAdminNote': 'OAuth 2.1-apps voor AI-clients worden geconfigureerd in het beheerderspaneel.',
  'admin.tabs.oauthApps': 'OAuth 2.1-apps',
  'admin.oauthApps.title': 'OAuth 2.1-apps',
  'admin.oauthApps.subtitle': 'Registreer OAuth-clients zodat AI-tools (Claude.ai, ChatGPT, enz.) verbinding kunnen maken met het MCP-eindpunt.',
  'admin.oauthApps.registered': 'Geregistreerde apps',
}
