const pl: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.showPlaceDescription': 'Pokaż opis miejsca',
  ...
  'forgotPassword.subtitle': 'Podaj swój adres email, a wyślemy Ci link do resetowania hasła.',
  'forgotPassword.email': 'Adres e-mail',
  'forgotPassword.submit': 'Wyślij link do resetowania',
  'forgotPassword.sending': 'Wysyłanie\u2026',
  'forgotPassword.successTitle': 'Sprawdź swoją skrzynkę odbiorczą',
  'forgotPassword.successMsg': 'Jeśli konto z tym adresem email istnieje, wysłano link do resetowania.',
  'forgotPassword.backToLogin': '← Powrót do logowania',
  'resetPassword.title': 'Ustaw nowe hasło',
  'resetPassword.subtitle': 'Wpisz nowe hasło poniżej.',
  'resetPassword.password': 'Nowe hasło',
  'resetPassword.submit': 'Ustaw hasło',
  'resetPassword.submitting': 'Ustawianie hasła\u2026',
  'resetPassword.successTitle': 'Hasło zaktualizowane',
  'resetPassword.successMsg': 'Twoje hasło zostało zmienione. Możesz się teraz zalogować.',
  'resetPassword.signIn': 'Przejdź do logowania',
  'resetPassword.invalidToken': 'Ten link do resetowania jest nieprawidłowy lub wygasł.',
  'resetPassword.mfaRequired': 'Twoje konto ma włączone uwierzytelnianie dwuskładnikowe.',
  'resetPassword.mfaCode': 'Kod uwierzytelniający',
  ...
  'admin.mapsKillSwitches': 'Wyłączniki API',
  'admin.mapsAutocompleteDisabled': 'Wyłącz wyszukiwanie miejsc',
  'admin.mapsAutocompleteDisabledHint': 'Blokuj wszystkie wywołania autouzupełniania/wyszukiwania do Google i Nominatim',
  'admin.mapsDetailsDisabled': 'Wyłącz szczegóły miejsc',
  'admin.mapsDetailsDisabledHint': 'Blokuj wyszukiwanie szczegółów miejsc (oceny, recenzje, godziny otwarcia)',
  ...
  // File Types
  'admin.authMethods': 'Metody uwierzytelniania',
  'admin.passwordLogin': 'Logowanie hasłem',
  'admin.passwordLoginHint': 'Pozwól użytkownikom logować się emailem i hasłem',
  'admin.oidcLogin': 'Logowanie SSO',
  'admin.oidcLoginHint': 'Pozwól użytkownikom logować się przez skonfigurowanego dostawcę OIDC',
  'admin.oidcRegistration': 'Rejestracja SSO',
  'admin.oidcRegistrationHint': 'Pozwól na tworzenie nowych użytkowników przy pierwszym logowaniu SSO',
  'admin.envOverrideHint': 'Logowanie hasłem jest kontrolowane przez zmienną środowiskową OIDC_ONLY i nie można go tu zmienić.',
  'admin.defaultLanguage': 'Domyślny język',
  'admin.defaultLanguageHint': 'Język wyświetlany niezalogowanym użytkownikom. Odwiedzający mogą go nadpisać.',
  'admin.defaultLanguageAuto': 'Automatyczne wykrywanie (język przeglądarki)',
  ...
  'admin.collab.chat': 'Czat na żywo',
  'admin.collab.chatHint': 'Czat podróży w czasie rzeczywistym dla wszystkich członków',
  'admin.collab.notes': 'Udostępnione notatki',
  'admin.collab.notesHint': 'Notatki współpracujące dołączone do podróży',
  'admin.collab.polls': 'Ankiety',
  'admin.collab.pollsHint': 'Twórz i głosuj na grupowe decyzje',
  'admin.bagTracking.subtitle': 'Włącz wagę i przypisywanie do toreb dla przedmiotów do pakowania',
  'admin.atlas.geoTitle': 'Dane granic regionalnych',
  'admin.atlas.geoHint': 'Aktualizuje plik GeoJSON granic regionalnych używany na mapie Atlasu',
  'admin.atlas.geoRefresh': 'Aktualizuj teraz',
  'admin.atlas.geoRefreshing': 'Aktualizowanie…',
  'admin.atlas.geoRefreshed': 'Dane granic regionalnych zaktualizowane',
  'admin.atlas.geoRefreshError': 'Aktualizacja danych granic regionalnych nie powiodła się',
  ...
  'admin.addons.integrationHint': 'Usługi backendowe i integracje API',
  ...
  'vacay.inviteCalendarName': 'Kalendarz:',
  'vacay.calendars': 'Kalendarze',
  'vacay.myCalendar': 'Mój Kalendarz',
  'vacay.newCalendar': 'Nowy Kalendarz',
  'vacay.calendarName': 'Nazwa kalendarza',
  'vacay.calendarNamePlaceholder': 'np. Zespół Pracy, Rodzina',
  'vacay.createCalendar': 'Utwórz',
  'vacay.leaveCalendar': 'Opuść Kalendarz',
  'vacay.deleteCalendar': 'Usuń Kalendarz',
  'vacay.leaveCalendarHint': 'Usuń siebie z tego udostępnionego kalendarza. Twoje osobiste wpisy nie zostaną zmienione.',
  'vacay.deleteCalendarHint': 'Trwale usuń ten kalendarz i usuń wszystkich członków.',
  'vacay.leaveAction': 'Opuść',
  'vacay.deleteAction': 'Usuń',
  'vacay.shareDetailsDefault': 'Udostępniaj szczegóły w udostępnionych kalendarzach',
  'vacay.shareDetailsDefaultHint': 'Dotyczy nowych wpisów. Istniejące wpisy nie zostaną zmienione.',
  'vacay.busyOnly': 'Zajęty',
  'vacay.eventName': 'Nazwa wydarzenia',
  'vacay.location': 'Miejsce',
  'vacay.note': 'Notatka',
  'vacay.optional': 'Opcjonalne',
  'vacay.shareDetails': 'Udostępnij szczegóły',
  'vacay.shareDetailsHint': 'Nazwa, miejsce i notatka są widoczne dla innych członków kalendarza',
  'vacay.removeEntry': 'Usuń',
  'vacay.markThrough': 'Zaznacz do',
  'vacay.daysSelected': '{n} dni',
  'vacay.mixedValues': 'Wiele wartości…',
  ...
  'dayplan.duplicateDay': 'Duplikuj dzień',
  'dayplan.pdfError': 'Nie udało się wyeksportować pliku PDF',
  'dayplan.transportWalking': 'Pieszo',
  'dayplan.transportCycling': 'Rower',
  ...
  'places.formPrice': 'Cena',
  'places.formPriceVisit': 'Cena (ta wizyta)',
  'places.whoIsGoing': 'Kto idzie?',
  'places.everyoneGoing': 'Wszyscy idą — dotknij, aby kogoś wykluczyć',
  'places.formDuration': 'Czas wizyty (min)',
  'places.formTransportMode': 'Jak dotrzeć',
  'places.transportWalking': 'Pieszo',
  'places.transportCycling': 'Rower',
  ...
  'photos.dropHere': 'Upuść zdjęcia tutaj',
  'photos.dropHereActive': 'Upuść zdjęcia tutaj...',
  'photos.dropHint': 'JPG, PNG, WebP · maks. 10 MB · do 30 zdjęć',
  ...
  'memories.dateSyncLabel': 'Synchronizacja dat',
  'memories.lastSynced': 'Ostatnio zsynchronizowano',
  ...
  'notif.todo_due.title': 'Zadanie na dziś',
  'notif.todo_due.text': '{name} jest dziś do zrobienia w {trip}.',
  ...
  'packing.templateSaved': 'Lista bagażu zapisana jako szablon',
  'nav.offline': 'Offline',
  'dashboard.settlementCurrency': 'Waluta rozliczeniowa',
  'dashboard.settlementCurrencyHint': 'Wszystkie wydatki w wielu walutach zostaną przeliczone na tę walutę do rozliczenia. Nie można zmienić po wprowadzeniu wydatków w walutach obcych.',
  'places.importCsv': 'CSV',
  'places.csvImported': '{count} miejsc zaimportowanych z CSV',
  'places.csvError': 'Import CSV nie powiódł się',
  'budget.table.members': 'Członkowie',
  'budget.addExpense': 'Dodaj wydatek',
  'budget.editExpense': 'Edytuj wydatek',
  'budget.modal.owes': 'Winien',
  'budget.modal.paid': 'Zapłacone',
  'budget.modal.tip': 'Napiwek',
  'budget.modal.equalSplit': 'Równy podział',
  'budget.modal.remaining': 'pozostało',
  'budget.modal.balanced': 'Zbilansowane',
  'budget.modal.notReconciled': 'Jeszcze nie uzgodnione',
  'budget.modal.originalAmount': 'Oryginalna kwota',
  'budget.modal.referenceAmount': 'Kwota ref.',
  'budget.modal.exchangeRate': 'Kurs wymiany',
  'budget.modal.fetchRate': 'Pobierz kurs',
  'budget.modal.currency': 'Waluta',
  'budget.modal.receipts': 'Paragony',
  'budget.modal.uploadReceipt': 'Załącz',
  'budget.modal.noReceipts': 'Brak załączonych paragonów',
  'budget.charged': 'Naliczone',
  'budget.balance': 'Saldo',
  'planner.mayBeClosed': 'Może być zamknięte o tej porze',
  ...
  'undo.importCsv': 'Import CSV',
  'budget.settle': 'Rozlicz budżet',
  'budget.settledBadge': 'Rozliczono {date} przez {name}',
  'budget.settledBanner': 'Ten budżet został rozliczony. Wydatki są tylko do odczytu.',
  'budget.settlement.previewTitle': 'Rozlicz budżet',
  'budget.settlement.previewSubtitle': 'Sprawdź, kto co płaci, i powiadom wszystkich.',
  'budget.settlement.flows': 'Wymagane płatności',
  'budget.settlement.noFlows': 'Wszystko wyrównane — żadnych płatności nie potrzeba.',
  'budget.settlement.unresolvedDrafts': 'Nierozwiązane szkice',
  'budget.settlement.unresolvedDraftsHint': 'Rozwiąż te planowane wydatki przed rozliczeniem.',
  'budget.settlement.convertDraft': 'Konwertuj',
  'budget.settlement.discardDraft': 'Odrzuć',
  'budget.settlement.settleBtn': 'Rozlicz i powiadom',
  'budget.settlement.confirmText': 'Ta akcja jest trwała i nie można jej cofnąć. Wydatki staną się tylko do odczytu.',
  'budget.settlement.confirmBtn': 'Potwierdź',
  'budget.settlement.alreadySettled': 'Ten budżet został już rozliczony.',
  'budget.settlement.hasDrafts': 'Rozwiąż wszystkie szkice przed rozliczeniem.',
  'notif.budget_settlement.title': 'Budżet rozliczony',
  'notif.budget_settlement.text': '{actor} rozliczył/a budżet dla {trip}',
  'notif.action.ive_paid': 'Zapłaciłem/am',
  'notif.action.dismiss': 'Zamknij',
  'notif.action.view_budget': 'Zobacz budżet',
  'settings.notifyBudgetSettlement': 'Rozliczenia budżetu',
  'tripBadge.budgetUnsettled': 'Budżet nierozliczony',
  'tripBadge.budgetUnsettled.detail': 'Ta podróż zakończyła się z nierozliczonymi wydatkami.',
  'tripBadge.budgetUnsettled.action': 'Sprawdź budżet',
  'tripBadge.calendarConflict': 'Konflikt kalendarza',
  'tripBadge.calendarConflict.detail': 'Twój kalendarz ma zdarzenia pokrywające się z datami tej podróży.',
  'tripBadge.calendarConflict.action': 'Zobacz kalendarz',
  'tripBadge.missingDates': 'Brak dat',
  'tripBadge.missingDates.detail': 'Dodaj daty podróży, aby wykrywać konflikty i aktywować przypomnienia.',
  'tripBadge.missingDates.action': 'Edytuj podróż',
  'tripBadge.upcomingSoon': 'Zaczyna się za {days} dni',
  'tripBadge.upcomingSoon.detail': 'Twój itinerar jest pusty — czas planować!',
  'tripBadge.upcomingSoon.action': 'Otwórz planistę',
  'tripBadge.emptyItinerary': 'Brak itinerarza',
  'tripBadge.emptyItinerary.detail': 'Nie zaplanowano żadnych aktywności na żaden dzień.',
  'tripBadge.emptyItinerary.action': 'Otwórz planistę',
  'tripBadge.more': '+{count} więcej',
  'trip.loading.budget': 'Ładowanie budżetu...',
  'trip.loading.reservations': 'Ładowanie rezerwacji...',
  'trip.loading.packing': 'Ładowanie listy pakowania...',
  'trip.loading.files': 'Ładowanie plików...',
  'trip.loading.collab': 'Ładowanie wiadomości...',
  'trip.loading.memories': 'Ładowanie wspomnień...',
  'trip.myPreferences': 'Moje preferencje',
  'trip.addToCalendar': 'Dodaj do mojego kalendarza',
  'trip.addToCalendarHint': 'Zablokuj te daty w swoim osobistym kalendarzu urlopowym.',
  'trip.calendarSyncing': 'Synchronizowanie...',
  'settings.notifyTodoDue': 'Zadanie do wykonania dzisiaj',
  'collab.notes.expand': 'Rozwiń',
  'dayplan.dayDetail': 'Szczegóły dnia',
  'dayplan.toast.routeError': 'Nie udało się obliczyć trasy',
  'trip.toast.loadError': 'Nie udało się załadować wycieczki',
  'trip.toast.tripUpdated': 'Wycieczka zaktualizowana',
  'admin.mapsAutocompleteNominatimOnly': 'Użyj Nominatim do autouzupełniania',
  'admin.mapsAutocompleteNominatimOnlyHint': 'Przekieruj autouzupełnianie do OpenStreetMap nawet przy skonfigurowanym kluczu Google, aby obniżyć koszty API',
  'settings.mcp.tabs.apps': 'Aplikacje OAuth 2.1',
  'settings.mcp.tabs.legacyTokens': 'Tokeny starszego typu',
  'settings.mcp.tabs.sessions': 'Aktywne sesje',
  'settings.mcp.apps.empty': 'Brak aplikacji OAuth. Utwórz jedną, aby bezpiecznie połączyć klientów AI.',
  'settings.mcp.apps.create': 'Utwórz aplikację',
  'settings.mcp.apps.name': 'Nazwa aplikacji',
  'settings.mcp.apps.namePlaceholder': 'np. Claude.ai, Moja automatyzacja',
  'settings.mcp.apps.redirectUris': 'URI przekierowania',
  'settings.mcp.apps.redirectUrisHint': 'Jeden na linię. Musi używać https://, http://localhost lub niestandardowego schematu.',
  'settings.mcp.apps.isPublic': 'Klient publiczny (bez tajemnic, tylko PKCE)',
  'settings.mcp.apps.scopes': 'Dozwolone uprawnienia',
  'settings.mcp.apps.preset': 'Ustawienie wstępne:',
  ...
  'settings.mcp.apps.preset.readOnly': 'Tylko odczyt',
  'settings.mcp.apps.created': 'Aplikacja utworzona',
  'settings.mcp.apps.createError': 'Nie udało się utworzyć aplikacji',
  'settings.mcp.apps.deleted': 'Aplikacja usunięta',
  'settings.mcp.apps.deleteError': 'Nie udało się usunąć aplikacji',
  'settings.mcp.apps.secretOnce': 'Sekret klienta (wyświetlany raz)',
  'settings.mcp.apps.secretWarning': 'Zapisz ten sekret teraz — nie można go odzyskać.',
  'settings.mcp.apps.rotated': 'Sekret odnowiony',
  'settings.mcp.apps.rotateError': 'Nie udało się odnowić sekretu',
  'settings.mcp.apps.rotate': 'Odnów sekret',
  'settings.mcp.apps.delete': 'Usuń',
  'settings.mcp.apps.publicBadge': 'Publiczny',
  'settings.mcp.apps.confidentialBadge': 'Poufny',
  'settings.mcp.apps.legacyNotice': 'Nowe połączenia powinny korzystać z aplikacji OAuth 2.1 powyżej.',
  'settings.mcp.apps.modal.createTitle': 'Utwórz aplikację OAuth',
  'settings.mcp.apps.modal.done': 'Gotowe',
  'settings.mcp.apps.modal.creating': 'Tworzenie…',
  'settings.mcp.apps.modal.deleteTitle': 'Usuń aplikację',
  'settings.mcp.apps.modal.deleteMessage': 'Wszystkie tokeny i sesje tej aplikacji zostaną natychmiast unieważnione.',
  'settings.mcp.sessions.empty': 'Brak aktywnych sesji OAuth.',
  'settings.mcp.sessions.revoke': 'Unieważnij',
  'settings.mcp.sessions.revoked': 'Sesja unieważniona',
  'settings.mcp.sessions.revokeError': 'Nie udało się unieważnić sesji',
  'settings.mcp.sessions.scopes': 'Uprawnienia',
  'settings.mcp.sessions.expires': 'Wygasa',
  'settings.mcp.legacyDeprecated': 'Przestarzały',
  'settings.mcp.oauthAppsAdminNote': 'Aplikacje OAuth 2.1 dla klientów AI są konfigurowane w panelu administracyjnym.',
  'admin.tabs.oauthApps': 'Aplikacje OAuth 2.1',
  'admin.oauthApps.title': 'Aplikacje OAuth 2.1',
  'admin.oauthApps.subtitle': 'Zarejestruj klientów OAuth, aby narzędzia AI (Claude.ai, ChatGPT itp.) mogły połączyć się z punktem końcowym MCP.',
  'admin.oauthApps.registered': 'Zarejestrowane aplikacje',
}
