...
const ar: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.showPlaceDescription': 'إظهار وصف المكان',
  ...
  'forgotPassword.successTitle': 'تحقق من صندوق الوارد',
  'forgotPassword.successMsg': 'إذا كان هناك حساب مرتبط بهذا البريد، فقد تم إرسال رابط إعادة التعيين.',
  'forgotPassword.backToLogin': '→ العودة إلى تسجيل الدخول',
  'resetPassword.title': 'تعيين كلمة مرور جديدة',
  'resetPassword.subtitle': 'أدخل كلمة مرورك الجديدة أدناه.',
  'resetPassword.password': 'كلمة المرور الجديدة',
  'resetPassword.submit': 'تعيين كلمة المرور',
  'resetPassword.submitting': 'جارٍ تعيين كلمة المرور…',
  'resetPassword.successTitle': 'تم تحديث كلمة المرور',
  'resetPassword.successMsg': 'تم تغيير كلمة مرورك. يمكنك الآن تسجيل الدخول.',
  'resetPassword.signIn': 'الانتقال إلى تسجيل الدخول',
  'resetPassword.invalidToken': 'رابط إعادة التعيين غير صالح أو منتهي الصلاحية.',
  'resetPassword.mfaRequired': 'حسابك يملك تفعيل المصادقة الثنائية.',
  'resetPassword.mfaCode': 'رمز المصادقة',
  ...
  'admin.mapsKillSwitches': 'مفاتيح إيقاف API',
  'admin.mapsAutocompleteDisabled': 'تعطيل البحث عن الأماكن',
  'admin.mapsAutocompleteDisabledHint': 'حظر جميع طلبات الإكمال التلقائي والبحث إلى Google وNominatim',
  'admin.mapsDetailsDisabled': 'تعطيل تفاصيل الأماكن',
  'admin.mapsDetailsDisabledHint': 'حظر عمليات البحث عن تفاصيل الأماكن (التقييمات، المراجعات، ساعات العمل)',
  ...
  // File Types
  'admin.authMethods': 'طرق المصادقة',
  'admin.passwordLogin': 'تسجيل الدخول بكلمة المرور',
  'admin.passwordLoginHint': 'السماح للمستخدمين بتسجيل الدخول بالبريد الإلكتروني وكلمة المرور',
  'admin.oidcLogin': 'تسجيل الدخول بـ SSO',
  'admin.oidcLoginHint': 'السماح للمستخدمين بتسجيل الدخول عبر موفر OIDC المُعد',
  'admin.oidcRegistration': 'التسجيل بـ SSO',
  'admin.oidcRegistrationHint': 'السماح بإنشاء مستخدمين جدد عند أول تسجيل دخول بـ SSO',
  'admin.envOverrideHint': 'تسجيل الدخول بكلمة المرور يتحكم فيه متغير البيئة OIDC_ONLY ولا يمكن تغييره هنا.',
  'admin.defaultLanguage': 'اللغة الافتراضية',
  'admin.defaultLanguageHint': 'اللغة المعروضة للمستخدمين غير المسجلين. يمكن للزوار تغييرها.',
  'admin.defaultLanguageAuto': 'اكتشاف تلقائي (لغة المتصفح)',
  ...
  'admin.collab.chat': 'الدردشة المباشرة',
  'admin.collab.chatHint': 'دردشة رحلة في الوقت الفعلي لجميع الأعضاء',
  'admin.collab.notes': 'ملاحظات مشتركة',
  'admin.collab.notesHint': 'ملاحظات تعاونية مرفقة بالرحلة',
  'admin.collab.polls': 'استطلاعات الرأي',
  'admin.collab.pollsHint': 'إنشاء قرارات جماعية والتصويت عليها',
  'admin.bagTracking.subtitle': 'تفعيل الوزن وتعيين الأمتعة للعناصر',
  'admin.atlas.geoTitle': 'بيانات حدود المناطق',
  'admin.atlas.geoHint': 'يحدّث ملف GeoJSON لحدود المناطق المستخدم في خريطة الأطلس',
  'admin.atlas.geoRefresh': 'تحديث الآن',
  'admin.atlas.geoRefreshing': 'جارٍ التحديث…',
  'admin.atlas.geoRefreshed': 'تم تحديث بيانات حدود المناطق',
  'admin.atlas.geoRefreshError': 'فشل تحديث بيانات حدود المناطق',
  ...
  'admin.addons.integrationHint': 'خدمات الواجهة الخلفية وتكاملات API',
  ...
  'vacay.inviteCalendarName': 'التقويم:',
  'vacay.calendars': 'التقاويم',
  'vacay.myCalendar': 'تقويمي',
  'vacay.newCalendar': 'تقويم جديد',
  'vacay.calendarName': 'اسم التقويم',
  'vacay.calendarNamePlaceholder': 'مثل: فريق العمل، العائلة',
  'vacay.createCalendar': 'إنشاء',
  'vacay.leaveCalendar': 'مغادرة التقويم',
  'vacay.deleteCalendar': 'حذف التقويم',
  'vacay.leaveCalendarHint': 'إزالة نفسك من هذا التقويم المشترك. لن تتأثر إدخالاتك الشخصية.',
  'vacay.deleteCalendarHint': 'حذف هذا التقويم نهائياً وإزالة جميع الأعضاء.',
  'vacay.leaveAction': 'مغادرة',
  'vacay.deleteAction': 'حذف',
  'vacay.shareDetailsDefault': 'مشاركة التفاصيل في التقاويم المشتركة',
  'vacay.shareDetailsDefaultHint': 'ينطبق على الإدخالات الجديدة. لن تتغير الإدخالات الموجودة.',
  'vacay.busyOnly': 'مشغول',
  'vacay.eventName': 'اسم الحدث',
  'vacay.location': 'الموقع',
  'vacay.note': 'ملاحظة',
  'vacay.optional': 'اختياري',
  'vacay.shareDetails': 'مشاركة التفاصيل',
  'vacay.shareDetailsHint': 'اسم الحدث والموقع والملاحظة مرئية لأعضاء التقويم الآخرين',
  'vacay.removeEntry': 'إزالة',
  'vacay.markThrough': 'وضع علامة حتى',
  'vacay.daysSelected': '{n} أيام',
  'vacay.mixedValues': 'قيم متعددة…',
  ...
  'dayplan.duplicateDay': 'تكرار اليوم',
  'dayplan.pdfError': 'فشل تصدير PDF',
  'dayplan.transportWalking': 'مشياً',
  'dayplan.transportCycling': 'دراجة',
  'dayplan.transportDriving': 'سيارة',
  ...
  'places.formPhone': 'الهاتف',
  'places.formPrice': 'السعر',
  'places.formPriceVisit': 'السعر (هذه الزيارة)',
  'places.whoIsGoing': 'من يذهب؟',
  'places.everyoneGoing': 'الجميع ذاهب — اضغط لاستبعاد شخص ما',
  'places.formDuration': 'مدة الزيارة (دقيقة)',
  'places.formTransportMode': 'وسيلة التنقل',
  'places.transportWalking': 'مشياً',
  'places.transportCycling': 'دراجة',
  'places.transportDriving': 'سيارة',
  ...
  'memories.dateSyncLabel': 'المزامنة بالتاريخ',
  'memories.lastSynced': 'آخر مزامنة',
  'memories.photos': 'صور',
  ...
  'notif.todo_due.title': 'مهمة تستحق اليوم',
  'notif.todo_due.text': '{name} مستحق اليوم في {trip}.',
  ...
  'packing.templateSaved': 'تم حفظ قائمة التعبئة كقالب',
  'nav.offline': 'غير متصل',
  'dashboard.settlementCurrency': 'عملة التسوية',
  'dashboard.settlementCurrencyHint': 'سيتم تحويل جميع المصاريف متعددة العملات إلى هذه العملة للتسوية. لا يمكن تغييرها بعد وجود مصاريف بعملات أجنبية.',
  'places.importCsv': 'CSV',
  'places.csvImported': 'تم استيراد {count} أماكن من CSV',
  'places.csvError': 'فشل استيراد CSV',
  'budget.table.members': 'الأعضاء',
  'budget.addExpense': 'إضافة مصروف',
  'budget.editExpense': 'تعديل مصروف',
  'budget.modal.owes': 'مدين',
  'budget.modal.paid': 'مدفوع',
  'budget.modal.tip': 'إكرامية',
  'budget.modal.equalSplit': 'تقسيم متساوٍ',
  'budget.modal.remaining': 'متبقٍ',
  'budget.modal.balanced': 'متوازن',
  'budget.modal.notReconciled': 'لم تتم التسوية بعد',
  'budget.modal.originalAmount': 'المبلغ الأصلي',
  'budget.modal.referenceAmount': 'المبلغ المرجعي',
  'budget.modal.exchangeRate': 'سعر الصرف',
  'budget.modal.fetchRate': 'جلب السعر',
  'budget.modal.currency': 'العملة',
  'budget.modal.receipts': 'الإيصالات',
  'budget.modal.uploadReceipt': 'إرفاق',
  'budget.modal.noReceipts': 'لا توجد إيصالات مرفقة',
  'budget.charged': 'محمّل',
  'budget.balance': 'الرصيد',
  'planner.mayBeClosed': 'قد يكون مغلقاً في هذا الوقت',
  'memories.notConnectedMultipleHint': 'قم بتوصيل أي من موفري الصور هؤلاء: {provider_names} في الإعدادات لتتمكن من إضافة صور لهذه الرحلة.',
  'memories.providerUrl': 'عنوان الخادم',
  ...
  'memories.selectAlbumMultiple': 'اختر ألبوم',
  'memories.selectPhotosMultiple': 'اختر صوراً',
  'undo.importCsv': 'استيراد CSV',
  'budget.settle': 'تسوية الميزانية',
  'budget.settledBadge': 'تمت التسوية في {date} بواسطة {name}',
  'budget.settledBanner': 'تمت تسوية هذه الميزانية. النفقات للقراءة فقط.',
  'budget.settlement.previewTitle': 'تسوية الميزانية',
  'budget.settlement.previewSubtitle': 'راجع من يدفع ماذا، ثم أخطر الجميع.',
  'budget.settlement.flows': 'المدفوعات المطلوبة',
  'budget.settlement.noFlows': 'كل شيء متوازن — لا حاجة لأي مدفوعات.',
  'budget.settlement.unresolvedDrafts': 'مسودات غير محلولة',
  'budget.settlement.unresolvedDraftsHint': 'أحل هذه النفقات المخططة قبل التسوية.',
  'budget.settlement.convertDraft': 'تحويل',
  'budget.settlement.discardDraft': 'تجاهل',
  'budget.settlement.settleBtn': 'تسوية وإشعار',
  'budget.settlement.confirmText': 'هذا الإجراء دائم ولا يمكن التراجع عنه. ستصبح النفقات للقراءة فقط.',
  'budget.settlement.confirmBtn': 'تأكيد',
  'budget.settlement.alreadySettled': 'تمت تسوية هذه الميزانية بالفعل.',
  'budget.settlement.hasDrafts': 'أحل جميع المسودات قبل التسوية.',
  'notif.budget_settlement.title': 'تمت تسوية الميزانية',
  'notif.budget_settlement.text': 'قام {actor} بتسوية ميزانية {trip}',
  'notif.action.ive_paid': 'لقد دفعت',
  'notif.action.dismiss': 'إغلاق',
  'notif.action.view_budget': 'عرض الميزانية',
  'settings.notifyBudgetSettlement': 'تسويات الميزانية',
  'tripBadge.budgetUnsettled': 'ميزانية غير مسواة',
  'tripBadge.budgetUnsettled.detail': 'انتهت هذه الرحلة بنفقات غير مسواة.',
  'tripBadge.budgetUnsettled.action': 'مراجعة الميزانية',
  'tripBadge.calendarConflict': 'تعارض في التقويم',
  'tripBadge.calendarConflict.detail': 'يحتوي تقويمك على أحداث تتداخل مع تواريخ هذه الرحلة.',
  'tripBadge.calendarConflict.action': 'عرض التقويم',
  'tripBadge.missingDates': 'تواريخ مفقودة',
  'tripBadge.missingDates.detail': 'أضف تواريخ السفر لاكتشاف التعارضات وتفعيل التذكيرات.',
  'tripBadge.missingDates.action': 'تعديل الرحلة',
  'tripBadge.upcomingSoon': 'يبدأ خلال {days} أيام',
  'tripBadge.upcomingSoon.detail': 'برنامجك فارغ — حان وقت التخطيط!',
  'tripBadge.upcomingSoon.action': 'فتح المخطط',
  'tripBadge.emptyItinerary': 'لا يوجد برنامج بعد',
  'tripBadge.emptyItinerary.detail': 'لم يتم تخطيط أي أنشطة لأي يوم.',
  'tripBadge.emptyItinerary.action': 'فتح المخطط',
  'tripBadge.more': '+{count} أخرى',
  'trip.loading.budget': 'جارٍ تحميل الميزانية...',
  'trip.loading.reservations': 'جارٍ تحميل الحجوزات...',
  'trip.loading.packing': 'جارٍ تحميل قائمة الحقيبة...',
  'trip.loading.files': 'جارٍ تحميل الملفات...',
  'trip.loading.collab': 'جارٍ تحميل الرسائل...',
  'trip.loading.memories': 'جارٍ تحميل الذكريات...',
  'trip.myPreferences': 'تفضيلاتي',
  'trip.addToCalendar': 'إضافة إلى تقويمي',
  'trip.addToCalendarHint': 'احجز هذه التواريخ في تقويم إجازتك الشخصي.',
  'trip.calendarSyncing': 'جارٍ المزامنة...',
  'settings.notifyTodoDue': 'مهمة مستحقة اليوم',
  'collab.notes.expand': 'توسيع',
  'dayplan.dayDetail': 'تفاصيل اليوم',
  'dayplan.toast.routeError': 'فشل حساب المسار',
  'trip.toast.loadError': 'فشل تحميل الرحلة',
  'trip.toast.tripUpdated': 'تم تحديث الرحلة',
  'admin.mapsAutocompleteNominatimOnly': 'استخدام Nominatim للإكمال التلقائي',
  'admin.mapsAutocompleteNominatimOnlyHint': 'توجيه الإكمال التلقائي إلى OpenStreetMap حتى عند تكوين مفتاح Google، لتقليل تكاليف API',
  'settings.mcp.tabs.apps': 'تطبيقات OAuth 2.1',
  'settings.mcp.tabs.legacyTokens': 'الرموز القديمة',
  'settings.mcp.tabs.sessions': 'الجلسات النشطة',
  'settings.mcp.apps.empty': 'لا توجد تطبيقات OAuth حتى الآن. أنشئ واحداً لتوصيل عملاء الذكاء الاصطناعي بأمان.',
  'settings.mcp.apps.create': 'إنشاء تطبيق',
  'settings.mcp.apps.name': 'اسم التطبيق',
  'settings.mcp.apps.namePlaceholder': 'مثال: Claude.ai، أتمتتي',
  'settings.mcp.apps.redirectUris': 'عناوين URI لإعادة التوجيه',
  'settings.mcp.apps.redirectUrisHint': 'واحد في كل سطر. يجب استخدام https:// أو http://localhost أو مخطط مخصص.',
  'settings.mcp.apps.isPublic': 'عميل عام (بلا سر، PKCE فقط)',
  'settings.mcp.apps.scopes': 'الأذونات المسموح بها',
  'settings.mcp.apps.preset': 'الإعداد المسبق:',
  ...
  'settings.mcp.apps.preset.readOnly': 'للقراءة فقط',
  'settings.mcp.apps.created': 'تم إنشاء التطبيق',
  'settings.mcp.apps.createError': 'فشل إنشاء التطبيق',
  'settings.mcp.apps.deleted': 'تم حذف التطبيق',
  'settings.mcp.apps.deleteError': 'فشل حذف التطبيق',
  'settings.mcp.apps.secretOnce': 'سر العميل (يُعرض مرة واحدة)',
  'settings.mcp.apps.secretWarning': 'احفظ هذا السر الآن — لا يمكن استعادته.',
  'settings.mcp.apps.rotated': 'تم تجديد السر',
  'settings.mcp.apps.rotateError': 'فشل تجديد السر',
  'settings.mcp.apps.rotate': 'تجديد السر',
  'settings.mcp.apps.delete': 'حذف',
  'settings.mcp.apps.publicBadge': 'عام',
  'settings.mcp.apps.confidentialBadge': 'سري',
  'settings.mcp.apps.legacyNotice': 'يجب أن تستخدم الاتصالات الجديدة تطبيقات OAuth 2.1 أعلاه.',
  'settings.mcp.apps.modal.createTitle': 'إنشاء تطبيق OAuth',
  'settings.mcp.apps.modal.done': 'تم',
  'settings.mcp.apps.modal.creating': 'جارٍ الإنشاء…',
  'settings.mcp.apps.modal.deleteTitle': 'حذف التطبيق',
  'settings.mcp.apps.modal.deleteMessage': 'سيتم إلغاء جميع الرموز والجلسات لهذا التطبيق فوراً.',
  'settings.mcp.sessions.empty': 'لا توجد جلسات OAuth نشطة.',
  'settings.mcp.sessions.revoke': 'إلغاء',
  'settings.mcp.sessions.revoked': 'تم إلغاء الجلسة',
  'settings.mcp.sessions.revokeError': 'فشل إلغاء الجلسة',
  'settings.mcp.sessions.scopes': 'الأذونات',
  'settings.mcp.sessions.expires': 'تنتهي',
  'settings.mcp.legacyDeprecated': 'قديم',
  'settings.mcp.oauthAppsAdminNote': 'يتم تكوين تطبيقات OAuth 2.1 لعملاء الذكاء الاصطناعي في لوحة الإدارة.',
  'admin.tabs.oauthApps': 'تطبيقات OAuth 2.1',
  'admin.oauthApps.title': 'تطبيقات OAuth 2.1',
  'admin.oauthApps.subtitle': 'سجّل عملاء OAuth حتى تتمكن أدوات الذكاء الاصطناعي (Claude.ai، ChatGPT، إلخ) من الاتصال بنقطة نهاية MCP.',
  'admin.oauthApps.registered': 'التطبيقات المسجلة',
}
