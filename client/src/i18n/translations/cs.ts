const cs: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.showPlaceDescription': 'Zobrazit popis místa',
  ...
  'forgotPassword.subtitle': 'Zadejte svůj e-mail a pošleme vám odkaz pro obnovení hesla.',
  'forgotPassword.email': 'E-mailová adresa',
  'forgotPassword.submit': 'Odeslat odkaz pro obnovení',
  'forgotPassword.sending': 'Odesílání\u2026',
  'forgotPassword.successTitle': 'Zkontrolujte svou doručenou poštu',
  'forgotPassword.successMsg': 'Pokud účet s tímto e-mailem existuje, byl odeslán odkaz pro obnovení.',
  'forgotPassword.backToLogin': '← Zpět na přihlášení',
  'resetPassword.title': 'Nastavit nové heslo',
  'resetPassword.subtitle': 'Zadejte níže své nové heslo.',
  'resetPassword.password': 'Nové heslo',
  'resetPassword.submit': 'Nastavit heslo',
  'resetPassword.submitting': 'Nastavování hesla\u2026',
  'resetPassword.successTitle': 'Heslo aktualizováno',
  'resetPassword.successMsg': 'Vaše heslo bylo změněno. Nyní se můžete přihlásit.',
  'resetPassword.signIn': 'Přejít na přihlášení',
  'resetPassword.invalidToken': 'Tento odkaz pro obnovení je neplatný nebo vypršel.',
  'resetPassword.mfaRequired': 'Váš účet má povoleno dvoufaktorové ověřování.',
  'resetPassword.mfaCode': 'Ověřovací kód',
  ...
  'admin.mapsKillSwitches': 'Vypínače API',
  'admin.mapsAutocompleteDisabled': 'Zakázat vyhledávání míst',
  'admin.mapsAutocompleteDisabledHint': 'Blokovat volání automatického dokončování/vyhledávání do Google a Nominatim',
  'admin.mapsDetailsDisabled': 'Zakázat detaily míst',
  'admin.mapsDetailsDisabledHint': 'Blokovat vyhledávání detailů míst (hodnocení, recenze, otevírací doby)',
  ...
  'admin.authMethods': 'Metody ověřování',
  'admin.passwordLogin': 'Přihlášení heslem',
  'admin.passwordLoginHint': 'Umožnit uživatelům přihlásit se e-mailem a heslem',
  'admin.oidcLogin': 'SSO přihlášení',
  'admin.oidcLoginHint': 'Umožnit uživatelům přihlásit se přes nakonfigurovaného OIDC poskytovatele',
  'admin.oidcRegistration': 'SSO registrace',
  'admin.oidcRegistrationHint': 'Umožnit vytvoření nových uživatelů při prvním SSO přihlášení',
  'admin.envOverrideHint': 'Přihlášení heslem je řízeno proměnnou prostředí OIDC_ONLY a nelze jej zde změnit.',
  'admin.defaultLanguage': 'Výchozí jazyk',
  'admin.defaultLanguageHint': 'Jazyk zobrazený nepřihlášeným uživatelům. Návštěvníci jej mohou přepsat.',
  'admin.defaultLanguageAuto': 'Automaticky rozpoznat (jazyk prohlížeče)',
  ...
  'admin.collab.chat': 'Živý chat',
  'admin.collab.chatHint': 'Živý chat výletu pro všechny členy',
  'admin.collab.notes': 'Sdílené poznámky',
  'admin.collab.notesHint': 'Společné poznámky přiložené k výletu',
  'admin.collab.polls': 'Hlasování',
  'admin.collab.pollsHint': 'Vytvářet skupinová rozhodnutí a hlasovat o nich',
  'admin.bagTracking.subtitle': 'Povolit váhu a přiřazení k zavazadlům u položek balení',
  'admin.atlas.geoTitle': 'Data hranic regionů',
  'admin.atlas.geoHint': 'Aktualizuje soubor GeoJSON hranic regionů používaný na mapě Atlasu',
  'admin.atlas.geoRefresh': 'Aktualizovat nyní',
  'admin.atlas.geoRefreshing': 'Aktualizace…',
  'admin.atlas.geoRefreshed': 'Data hranic regionů aktualizována',
  'admin.atlas.geoRefreshError': 'Aktualizace dat hranic regionů se nezdařila',
  ...
  'admin.addons.integrationHint': 'Backendové služby a API integrace',
  ...
  'vacay.inviteCalendarName': 'Kalendář:',
  'vacay.calendars': 'Kalendáře',
  'vacay.myCalendar': 'Můj kalendář',
  'vacay.newCalendar': 'Nový kalendář',
  'vacay.calendarName': 'Název kalendáře',
  'vacay.calendarNamePlaceholder': 'např. Pracovní tým, Rodina',
  'vacay.createCalendar': 'Vytvořit',
  'vacay.leaveCalendar': 'Opustit kalendář',
  'vacay.deleteCalendar': 'Smazat kalendář',
  'vacay.leaveCalendarHint': 'Odebrat se z tohoto sdíleného kalendáře. Vaše osobní záznamy nebudou ovlivněny.',
  'vacay.deleteCalendarHint': 'Trvale smazat tento kalendář a odebrat všechny členy.',
  'vacay.leaveAction': 'Opustit',
  'vacay.deleteAction': 'Smazat',
  'vacay.shareDetailsDefault': 'Sdílet podrobnosti ve sdílených kalendářích',
  'vacay.shareDetailsDefaultHint': 'Platí pro nové záznamy. Stávající záznamy se nezmění.',
  'vacay.busyOnly': 'Zaneprázdněn',
  'vacay.eventName': 'Název události',
  'vacay.location': 'Místo',
  'vacay.note': 'Poznámka',
  'vacay.optional': 'Volitelné',
  'vacay.shareDetails': 'Sdílet podrobnosti',
  'vacay.shareDetailsHint': 'Název, místo a poznámka jsou viditelné pro ostatní členy kalendáře',
  'vacay.removeEntry': 'Odebrat',
  'vacay.markThrough': 'Označit do',
  'vacay.daysSelected': '{n} dní',
  'vacay.mixedValues': 'Více hodnot…',
  ...
  'dayplan.duplicateDay': 'Duplikovat den',
  'dayplan.pdfError': 'Export do PDF se nezdařil',
  'dayplan.transportWalking': 'Pěšky',
  'dayplan.transportCycling': 'Kolo',
  ...
  'places.formPriceVisit': 'Cena (tato návštěva)',
  'places.whoIsGoing': 'Kdo jde?',
  'places.everyoneGoing': 'Všichni jdou — klepněte pro vyloučení někoho',
  'places.formDuration': 'Délka návštěvy (min)',
  'places.formTransportMode': 'Doprava',
  'places.transportWalking': 'Pěšky',
  'places.transportCycling': 'Kolo',
  ...
  'photos.dropHint': 'JPG, PNG, WebP · max. 10 MB · až 30 fotografií',
  ...
  'memories.dateSyncLabel': 'Synchronizace dat',
  'memories.lastSynced': 'Naposledy synchronizováno',
  ...
  'notif.todo_due.title': 'Úkol splatný dnes',
  'notif.todo_due.text': '{name} je dnes splatné v {trip}.',
  ...
  'nav.offline': 'Offline',
  'dashboard.settlementCurrency': 'Měna vyrovnání',
  'dashboard.settlementCurrencyHint': 'Všechny výdaje v různých měnách budou převedeny do této měny pro vyrovnání. Nelze změnit, jakmile existují výdaje v cizí měně.',
  'places.importCsv': 'CSV',
  'places.csvImported': '{count} míst importováno z CSV',
  'places.csvError': 'Import CSV se nezdařil',
  'budget.table.members': 'Členové',
  'budget.addExpense': 'Přidat výdaj',
  'budget.editExpense': 'Upravit výdaj',
  'budget.modal.owes': 'Dluží',
  'budget.modal.paid': 'Zaplaceno',
  'budget.modal.tip': 'Spropitné',
  'budget.modal.equalSplit': 'Rovnoměrné rozdělení',
  'budget.modal.remaining': 'zbývá',
  'budget.modal.balanced': 'Vyrovnáno',
  'budget.modal.notReconciled': 'Dosud neodsouhlaseno',
  'budget.modal.originalAmount': 'Původní částka',
  'budget.modal.referenceAmount': 'Ref. částka',
  'budget.modal.exchangeRate': 'Směnný kurz',
  'budget.modal.fetchRate': 'Načíst kurz',
  'budget.modal.currency': 'Měna',
  'budget.modal.receipts': 'Účtenky',
  'budget.modal.uploadReceipt': 'Připojit',
  'budget.modal.noReceipts': 'Žádné připojené účtenky',
  'budget.charged': 'Účtováno',
  'budget.balance': 'Zůstatek',
  'planner.mayBeClosed': 'V tuto dobu může být zavřeno',
  'memories.notConnectedMultipleHint': 'Připojte kteréhokoli z těchto poskytovatelů fotografií: {provider_names} v Nastavení, abyste mohli přidávat fotografie k tomuto výletu.',
  ...
  'memories.selectPhotosMultiple': 'Vybrat fotografie',
  'undo.importCsv': 'Import CSV',
  'budget.settle': 'Vyrovnat rozpočet',
  'budget.settledBadge': 'Vyrovnáno {date} uživatelem {name}',
  'budget.settledBanner': 'Tento rozpočet byl vyrovnán. Výdaje jsou pouze ke čtení.',
  'budget.settlement.previewTitle': 'Vyrovnat rozpočet',
  'budget.settlement.previewSubtitle': 'Zkontrolujte, kdo co platí, a upozorněte všechny.',
  'budget.settlement.flows': 'Požadované platby',
  'budget.settlement.noFlows': 'Vše vyrovnáno — žádné platby nejsou potřeba.',
  'budget.settlement.unresolvedDrafts': 'Nevyřešené návrhy',
  'budget.settlement.unresolvedDraftsHint': 'Vyřešte tyto plánované výdaje před vyrovnáním.',
  'budget.settlement.convertDraft': 'Převést',
  'budget.settlement.discardDraft': 'Zahodit',
  'budget.settlement.settleBtn': 'Vyrovnat a upozornit',
  'budget.settlement.confirmText': 'Tato akce je trvalá a nelze ji vrátit. Výdaje se stanou pouze ke čtení.',
  'budget.settlement.confirmBtn': 'Potvrdit',
  'budget.settlement.alreadySettled': 'Tento rozpočet již byl vyrovnán.',
  'budget.settlement.hasDrafts': 'Vyřešte všechny návrhy před vyrovnáním.',
  'notif.budget_settlement.title': 'Rozpočet vyrovnán',
  'notif.budget_settlement.text': '{actor} vyrovnal/a rozpočet pro {trip}',
  'notif.action.ive_paid': 'Zaplatil/a jsem',
  'notif.action.dismiss': 'Zavřít',
  'notif.action.view_budget': 'Zobrazit rozpočet',
  'settings.notifyBudgetSettlement': 'Vyrovnání rozpočtu',
  'tripBadge.budgetUnsettled': 'Rozpočet nevyrovnán',
  'tripBadge.budgetUnsettled.detail': 'Tato cesta skončila s nevyrovnanými výdaji.',
  'tripBadge.budgetUnsettled.action': 'Zkontrolovat rozpočet',
  'tripBadge.calendarConflict': 'Konflikt kalendáře',
  'tripBadge.calendarConflict.detail': 'Váš kalendář má události překrývající se s těmito daty.',
  'tripBadge.calendarConflict.action': 'Zobrazit kalendář',
  'tripBadge.missingDates': 'Chybí data',
  'tripBadge.missingDates.detail': 'Přidejte data cesty pro detekci konfliktů a připomínky.',
  'tripBadge.missingDates.action': 'Upravit cestu',
  'tripBadge.upcomingSoon': 'Začíná za {days} dní',
  'tripBadge.upcomingSoon.detail': 'Váš itinerář je prázdný — čas plánovat!',
  'tripBadge.upcomingSoon.action': 'Otevřít plánovač',
  'tripBadge.emptyItinerary': 'Zatím žádný itinerář',
  'tripBadge.emptyItinerary.detail': 'Pro žádný den nejsou naplánovány žádné aktivity.',
  'tripBadge.emptyItinerary.action': 'Otevřít plánovač',
  'tripBadge.more': '+{count} dalších',
  'trip.loading.budget': 'Načítání rozpočtu...',
  'trip.loading.reservations': 'Načítání rezervací...',
  'trip.loading.packing': 'Načítání seznamu věcí...',
  'trip.loading.files': 'Načítání souborů...',
  'trip.loading.collab': 'Načítání zpráv...',
  'trip.loading.memories': 'Načítání vzpomínek...',
  'trip.myPreferences': 'Moje předvolby',
  'trip.addToCalendar': 'Přidat do mého kalendáře',
  'trip.addToCalendarHint': 'Zablokujte tato data ve svém osobním kalendáři dovolené.',
  'trip.calendarSyncing': 'Synchronizace...',
  'settings.notifyTodoDue': 'Úkol splatný dnes',
  'collab.notes.expand': 'Rozbalit',
  'dayplan.dayDetail': 'Detail dne',
  'dayplan.toast.routeError': 'Výpočet trasy selhal',
  'trip.toast.loadError': 'Načtení výletu selhalo',
  'trip.toast.tripUpdated': 'Výlet aktualizován',
  'admin.mapsAutocompleteNominatimOnly': 'Použít Nominatim pro automatické doplňování',
  'admin.mapsAutocompleteNominatimOnlyHint': 'Přesměrovat automatické doplňování na OpenStreetMap i při nakonfigurovaném klíči Google, pro snížení nákladů API',
  'settings.mcp.tabs.apps': 'OAuth 2.1 aplikace',
  'settings.mcp.tabs.legacyTokens': 'Starší tokeny',
  'settings.mcp.tabs.sessions': 'Aktivní relace',
  'settings.mcp.apps.empty': 'Zatím žádné OAuth aplikace. Vytvořte jednu pro bezpečné připojení AI klientů.',
  'settings.mcp.apps.create': 'Vytvořit aplikaci',
  'settings.mcp.apps.name': 'Název aplikace',
  'settings.mcp.apps.namePlaceholder': 'např. Claude.ai, Moje automatizace',
  'settings.mcp.apps.redirectUris': 'URI přesměrování',
  'settings.mcp.apps.redirectUrisHint': 'Jedna na řádek. Musí použít https://, http://localhost nebo vlastní schéma.',
  'settings.mcp.apps.isPublic': 'Veřejný klient (bez tajemství, pouze PKCE)',
  'settings.mcp.apps.scopes': 'Povolená oprávnění',
  'settings.mcp.apps.preset': 'Předvolba:',
  ...
  'settings.mcp.apps.preset.readOnly': 'Jen pro čtení',
  'settings.mcp.apps.created': 'Aplikace vytvořena',
  'settings.mcp.apps.createError': 'Vytvoření aplikace selhalo',
  'settings.mcp.apps.deleted': 'Aplikace smazána',
  'settings.mcp.apps.deleteError': 'Smazání aplikace selhalo',
  'settings.mcp.apps.secretOnce': 'Tajný klíč klienta (zobrazeno jednou)',
  'settings.mcp.apps.secretWarning': 'Uložte si tento klíč nyní — nelze jej obnovit.',
  'settings.mcp.apps.rotated': 'Tajný klíč obnoven',
  'settings.mcp.apps.rotateError': 'Obnovení tajného klíče selhalo',
  'settings.mcp.apps.rotate': 'Obnovit klíč',
  'settings.mcp.apps.delete': 'Smazat',
  'settings.mcp.apps.publicBadge': 'Veřejný',
  'settings.mcp.apps.confidentialBadge': 'Důvěrný',
  'settings.mcp.apps.legacyNotice': 'Nová připojení by měla používat OAuth 2.1 aplikace výše.',
  'settings.mcp.apps.modal.createTitle': 'Vytvořit OAuth aplikaci',
  'settings.mcp.apps.modal.done': 'Hotovo',
  'settings.mcp.apps.modal.creating': 'Vytváření…',
  'settings.mcp.apps.modal.deleteTitle': 'Smazat aplikaci',
  'settings.mcp.apps.modal.deleteMessage': 'Všechny tokeny a relace této aplikace budou okamžitě odvolány.',
  'settings.mcp.sessions.empty': 'Žádné aktivní OAuth relace.',
  'settings.mcp.sessions.revoke': 'Odvolat',
  'settings.mcp.sessions.revoked': 'Relace odvolána',
  'settings.mcp.sessions.revokeError': 'Odvolání relace selhalo',
  'settings.mcp.sessions.scopes': 'Oprávnění',
  'settings.mcp.sessions.expires': 'Vyprší',
  'settings.mcp.legacyDeprecated': 'Zastaralé',
  'settings.mcp.oauthAppsAdminNote': 'OAuth 2.1 aplikace pro AI klienty jsou konfigurovány v administraci.',
  'admin.tabs.oauthApps': 'OAuth 2.1 aplikace',
  'admin.oauthApps.title': 'OAuth 2.1 aplikace',
  'admin.oauthApps.subtitle': 'Registrujte OAuth klienty, aby se AI nástroje (Claude.ai, ChatGPT atd.) mohly připojit k MCP endpointu.',
  'admin.oauthApps.registered': 'Registrované aplikace',
}
