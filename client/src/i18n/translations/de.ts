const de: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.showPlaceDescription': 'Ortsbeschreibung anzeigen',
  ...
  'forgotPassword.subtitle': 'Gib deine E-Mail-Adresse ein und wir schicken dir einen Link zum Zurücksetzen.',
  ...
  'forgotPassword.successTitle': 'Prüfe dein Postfach',
  'forgotPassword.successMsg': 'Wenn ein Konto mit dieser E-Mail existiert, wurde ein Link zum Zurücksetzen gesendet.',
  'forgotPassword.backToLogin': '← Zurück zur Anmeldung',
  'resetPassword.title': 'Neues Passwort festlegen',
  'resetPassword.subtitle': 'Gib unten dein neues Passwort ein.',
  'resetPassword.password': 'Neues Passwort',
  'resetPassword.submit': 'Passwort festlegen',
  'resetPassword.submitting': 'Passwort wird gesetzt\u2026',
  'resetPassword.successTitle': 'Passwort aktualisiert',
  'resetPassword.successMsg': 'Dein Passwort wurde geändert. Du kannst dich jetzt anmelden.',
  'resetPassword.signIn': 'Zur Anmeldung',
  'resetPassword.invalidToken': 'Dieser Zurücksetz-Link ist ungültig oder abgelaufen.',
  'resetPassword.mfaRequired': 'Dein Konto hat die Zwei-Faktor-Authentifizierung aktiviert.',
  'resetPassword.mfaCode': 'Authentifizierungs-Code',
  ...
  'admin.mapsKillSwitches': 'API-Sperren',
  'admin.mapsAutocompleteDisabled': 'Ortssuche deaktivieren',
  'admin.mapsAutocompleteDisabledHint': 'Alle Autovervollständigungs- und Textsuchanfragen an Google und Nominatim sperren',
  'admin.mapsDetailsDisabled': 'Ortsdetails deaktivieren',
  'admin.mapsDetailsDisabledHint': 'Ortsdetailabfragen sperren (Bewertungen, Rezensionen, Öffnungszeiten)',
  ...
  // File Types
  'admin.authMethods': 'Authentifizierungsmethoden',
  'admin.passwordLogin': 'Passwort-Anmeldung',
  'admin.passwordLoginHint': 'Benutzern erlauben, sich mit E-Mail und Passwort anzumelden',
  'admin.oidcLogin': 'SSO-Anmeldung',
  'admin.oidcLoginHint': 'Benutzern erlauben, sich über den konfigurierten OIDC-Anbieter anzumelden',
  'admin.oidcRegistration': 'SSO-Registrierung',
  'admin.oidcRegistrationHint': 'Neue Benutzer bei der ersten SSO-Anmeldung erstellen erlauben',
  'admin.envOverrideHint': 'Die Passwort-Anmeldung wird durch die Umgebungsvariable OIDC_ONLY gesteuert und kann hier nicht geändert werden.',
  'admin.defaultLanguage': 'Standardsprache',
  'admin.defaultLanguageHint': 'Sprache für nicht angemeldete Benutzer. Besucher können diese noch überschreiben.',
  'admin.defaultLanguageAuto': 'Automatisch erkennen (Browsersprache)',
  ...
  'admin.collab.chatHint': 'Echtzeit-Reise-Chat für alle Mitglieder',
  'admin.collab.notes': 'Geteilte Notizen',
  'admin.collab.notesHint': 'Kollaborative Notizen zur Reise',
  'admin.collab.polls': 'Abstimmungen',
  'admin.collab.pollsHint': 'Gruppenentscheidungen erstellen und abstimmen',
  'admin.bagTracking.subtitle': 'Gewicht und Gepäckstück-Zuordnung für Packlisteneinträge aktivieren',
  'admin.atlas.geoTitle': 'Regionsgrenzen-Daten',
  'admin.atlas.geoHint': 'Aktualisiert die GeoJSON-Datei für Regionsgrenzen auf der Atlaskarte',
  'admin.atlas.geoRefresh': 'Jetzt aktualisieren',
  'admin.atlas.geoRefreshing': 'Wird aktualisiert…',
  'admin.atlas.geoRefreshed': 'Regionsgrenzen-Daten aktualisiert',
  'admin.atlas.geoRefreshError': 'Aktualisierung der Regionsgrenzen-Daten fehlgeschlagen',
  ...
  'admin.addons.integrationHint': 'Backend-Dienste und API-Integrationen',
  ...
  'vacay.inviteCalendarName': 'Kalender:',
  'vacay.calendars': 'Kalender',
  'vacay.myCalendar': 'Mein Kalender',
  'vacay.newCalendar': 'Neuer Kalender',
  'vacay.calendarName': 'Kalendername',
  'vacay.calendarNamePlaceholder': 'z.B. Arbeitsteam, Familie',
  'vacay.createCalendar': 'Erstellen',
  'vacay.leaveCalendar': 'Kalender verlassen',
  'vacay.deleteCalendar': 'Kalender löschen',
  'vacay.leaveCalendarHint': 'Dich aus diesem geteilten Kalender entfernen. Deine persönlichen Einträge bleiben erhalten.',
  'vacay.deleteCalendarHint': 'Diesen Kalender dauerhaft löschen und alle Mitglieder entfernen.',
  'vacay.leaveAction': 'Verlassen',
  'vacay.deleteAction': 'Löschen',
  'vacay.shareDetailsDefault': 'Details in geteilten Kalendern teilen',
  'vacay.shareDetailsDefaultHint': 'Gilt für neue Einträge. Bestehende Einträge werden nicht geändert.',
  'vacay.busyOnly': 'Beschäftigt',
  'vacay.eventName': 'Veranstaltungsname',
  'vacay.location': 'Ort',
  'vacay.note': 'Notiz',
  'vacay.optional': 'Optional',
  'vacay.shareDetails': 'Details teilen',
  'vacay.shareDetailsHint': 'Name, Ort und Notiz sind für andere Kalendermitglieder sichtbar',
  'vacay.removeEntry': 'Entfernen',
  'vacay.markThrough': 'Markieren bis',
  'vacay.daysSelected': '{n} Tage',
  'vacay.mixedValues': 'Mehrere Werte…',
  ...
  'dayplan.toast.routeOptimizedWithConflict': 'Route optimiert – einige Orte wurden verschoben, um in den Zeitrahmen zu passen.',
  'dayplan.toast.routeExceedsDayEnd': 'Achtung: Die optimierte Route überschreitet Ihre konfigurierte Tagesendzeit.',
  ...
  'dayplan.duplicateDay': 'Tag duplizieren',
  'dayplan.pdfError': 'Fehler beim PDF-Export',
  'dayplan.transportWalking': 'Fuß',
  'dayplan.transportCycling': 'Rad',
  'dayplan.transportDriving': 'Auto',
  ...
  'places.formPrice': 'Preis',
  'places.formPriceVisit': 'Preis (dieser Besuch)',
  'places.whoIsGoing': 'Wer kommt mit?',
  'places.everyoneGoing': 'Alle kommen — tippen zum Ausschließen',
  'places.formDuration': 'Besuchsdauer (Min.)',
  'places.formTransportMode': 'Anreise mit',
  'places.transportWalking': 'Zu Fuß',
  'places.transportCycling': 'Fahrrad',
  'places.transportDriving': 'Auto',
  ...
  'photos.dropHint': 'JPG, PNG, WebP · max. 10 MB · bis zu 30 Fotos',
  ...
  'day.startTime': 'Tagesstart',
  'day.endTime': 'Tagesende',
  ...
  'memories.dateSyncLabel': 'Datumssync',
  'memories.lastSynced': 'Zuletzt synchronisiert',
  ...
  'notif.todo_due.title': 'Aufgabe heute fällig',
  'notif.todo_due.text': '{name} ist heute in {trip} fällig.',
  ...
  'nav.offline': 'Offline',
  'dashboard.settlementCurrency': 'Abrechnungswährung',
  'dashboard.settlementCurrencyHint': 'Alle Ausgaben in mehreren Währungen werden für die Abrechnung in diese Währung umgerechnet. Kann nicht geändert werden, sobald Ausgaben in Fremdwährung vorhanden sind.',
  'places.importCsv': 'CSV',
  'places.csvImported': '{count} Orte aus CSV importiert',
  'places.csvError': 'CSV-Import fehlgeschlagen',
  'budget.table.members': 'Mitglieder',
  'budget.addExpense': 'Ausgabe hinzufügen',
  'budget.editExpense': 'Ausgabe bearbeiten',
  'budget.modal.owes': 'Schuldet',
  'budget.modal.paid': 'Bezahlt',
  'budget.modal.tip': 'Trinkgeld',
  'budget.modal.equalSplit': 'Gleiche Aufteilung',
  'budget.modal.remaining': 'verbleibend',
  'budget.modal.balanced': 'Ausgeglichen',
  'budget.modal.notReconciled': 'Noch nicht abgestimmt',
  'budget.modal.originalAmount': 'Originalbetrag',
  'budget.modal.referenceAmount': 'Ref.-Betrag',
  'budget.modal.exchangeRate': 'Wechselkurs',
  'budget.modal.fetchRate': 'Kurs abrufen',
  'budget.modal.currency': 'Währung',
  'budget.modal.receipts': 'Belege',
  'budget.modal.uploadReceipt': 'Anhängen',
  'budget.modal.noReceipts': 'Keine Belege angehängt',
  'budget.charged': 'Abgerechnet',
  'budget.balance': 'Saldo',
  'planner.mayBeClosed': 'Könnte zu dieser Zeit geschlossen sein',
  'memories.notConnectedMultipleHint': 'Verbinde einen der folgenden Fotoanbieter: {provider_names} in den Einstellungen, um Fotos zu dieser Reise hinzufügen zu können.',
  ...
  'memories.saveError': 'Einstellungen für {provider_name} konnten nicht gespeichert werden',
  'memories.selectAlbumMultiple': 'Album auswählen',
  'memories.selectPhotosMultiple': 'Fotos auswählen',
  'undo.importCsv': 'CSV-Import',

  // Budget settlement
  'budget.settle': 'Budget abrechnen',
  'budget.settledBadge': 'Abgerechnet am {date} von {name}',
  'budget.settledBanner': 'Dieses Budget wurde abgerechnet. Ausgaben sind schreibgeschützt.',
  'budget.settlement.previewTitle': 'Budget abrechnen',
  'budget.settlement.previewSubtitle': 'Überprüfe, wer was bezahlen muss, und benachrichtige alle.',
  'budget.settlement.flows': 'Erforderliche Zahlungen',
  'budget.settlement.noFlows': 'Alles ausgeglichen — keine Zahlungen erforderlich.',
  'budget.settlement.unresolvedDrafts': 'Ungelöste Entwürfe',
  'budget.settlement.unresolvedDraftsHint': 'Diese geplanten Ausgaben müssen vor der Abrechnung geklärt werden.',
  'budget.settlement.convertDraft': 'Umwandeln',
  'budget.settlement.discardDraft': 'Verwerfen',
  'budget.settlement.settleBtn': 'Abrechnen & benachrichtigen',
  'budget.settlement.confirmText': 'Dies ist dauerhaft und kann nicht rückgängig gemacht werden. Ausgaben werden schreibgeschützt.',
  'budget.settlement.confirmBtn': 'Bestätigen',
  'budget.settlement.alreadySettled': 'Dieses Budget wurde bereits abgerechnet.',
  'budget.settlement.hasDrafts': 'Alle Entwürfe müssen vor der Abrechnung geklärt werden.',
  'notif.budget_settlement.title': 'Budget abgerechnet',
  'notif.budget_settlement.text': '{actor} hat das Budget für {trip} abgerechnet',
  'notif.action.ive_paid': 'Ich habe bezahlt',
  'notif.action.dismiss': 'Schließen',
  'notif.action.view_budget': 'Budget anzeigen',
  'settings.notifyBudgetSettlement': 'Budget-Abrechnungen',

  // Trip badge system
  'tripBadge.budgetUnsettled': 'Budget offen',
  'tripBadge.budgetUnsettled.detail': 'Diese Reise ist beendet, aber das Budget wurde nicht abgerechnet.',
  'tripBadge.budgetUnsettled.action': 'Budget überprüfen',
  'tripBadge.calendarConflict': 'Kalenderkonflikt',
  'tripBadge.calendarConflict.detail': 'Dein Kalender hat Einträge, die sich mit diesen Reisedaten überschneiden.',
  'tripBadge.calendarConflict.action': 'Kalender anzeigen',
  'tripBadge.missingDates': 'Keine Daten',
  'tripBadge.missingDates.detail': 'Füge Reisedaten hinzu, um Konflikte zu erkennen und Erinnerungen zu aktivieren.',
  'tripBadge.missingDates.action': 'Reise bearbeiten',
  'tripBadge.upcomingSoon': 'In {days} Tagen',
  'tripBadge.upcomingSoon.detail': 'Dein Reiseplan ist leer — Zeit zu planen!',
  'tripBadge.upcomingSoon.action': 'Planer öffnen',
  'tripBadge.emptyItinerary': 'Noch kein Reiseplan',
  'tripBadge.emptyItinerary.detail': 'Für keinen Tag sind Aktivitäten geplant.',
  'tripBadge.emptyItinerary.action': 'Planer öffnen',
  'tripBadge.more': '+{count} weitere',
  'trip.loading.budget': 'Budget wird geladen...',
  'trip.loading.reservations': 'Buchungen werden geladen...',
  'trip.loading.packing': 'Packliste wird geladen...',
  'trip.loading.files': 'Dateien werden geladen...',
  'trip.loading.collab': 'Nachrichten werden geladen...',
  'trip.loading.memories': 'Erinnerungen werden geladen...',
  'trip.myPreferences': 'Meine Einstellungen',
  'trip.addToCalendar': 'Zum Kalender hinzufügen',
  'trip.addToCalendarHint': 'Blockiere diese Daten in deinem persönlichen Urlaubskalender.',
  'trip.calendarSyncing': 'Wird synchronisiert...',
  'settings.notifyTodoDue': 'Aufgabe heute fällig',
  'collab.notes.expand': 'Erweitern',
  'dayplan.dayDetail': 'Tagesdetails',
  'dayplan.toast.routeError': 'Route konnte nicht berechnet werden',
  'trip.toast.loadError': 'Reise konnte nicht geladen werden',
  'trip.toast.tripUpdated': 'Reise aktualisiert',
  'admin.mapsAutocompleteNominatimOnly': 'Nominatim für Autovervollständigung verwenden',
  'admin.mapsAutocompleteNominatimOnlyHint': 'Autovervollständigung zu OpenStreetMap weiterleiten, auch wenn ein Google-Schlüssel konfiguriert ist, um API-Kosten zu senken',
  'settings.mcp.tabs.apps': 'OAuth 2.1-Apps',
  'settings.mcp.tabs.legacyTokens': 'Legacy-Token',
  'settings.mcp.tabs.sessions': 'Aktive Sitzungen',
  'settings.mcp.apps.empty': 'Noch keine OAuth-Apps. Erstelle eine, um KI-Clients sicher zu verbinden.',
  'settings.mcp.apps.create': 'App erstellen',
  'settings.mcp.apps.name': 'App-Name',
  'settings.mcp.apps.namePlaceholder': 'z. B. Claude.ai, Meine Automatisierung',
  'settings.mcp.apps.redirectUris': 'Weiterleitungs-URIs',
  'settings.mcp.apps.redirectUrisHint': 'Eine pro Zeile. Muss https://, http://localhost oder ein benutzerdefiniertes Schema verwenden.',
  'settings.mcp.apps.isPublic': 'Öffentlicher Client (kein Secret, nur PKCE)',
  'settings.mcp.apps.scopes': 'Erlaubte Berechtigungen',
  'settings.mcp.apps.preset': 'Voreinstellung:',
  ...
  'settings.mcp.apps.preset.readOnly': 'Nur lesen',
  'settings.mcp.apps.created': 'App erstellt',
  'settings.mcp.apps.createError': 'App konnte nicht erstellt werden',
  'settings.mcp.apps.deleted': 'App gelöscht',
  'settings.mcp.apps.deleteError': 'App konnte nicht gelöscht werden',
  'settings.mcp.apps.secretOnce': 'Client-Secret (wird einmalig angezeigt)',
  'settings.mcp.apps.secretWarning': 'Speichere dieses Secret jetzt – es kann nicht wiederhergestellt werden.',
  'settings.mcp.apps.rotated': 'Secret erneuert',
  'settings.mcp.apps.rotateError': 'Secret konnte nicht erneuert werden',
  'settings.mcp.apps.rotate': 'Secret erneuern',
  'settings.mcp.apps.delete': 'Löschen',
  'settings.mcp.apps.publicBadge': 'Öffentlich',
  'settings.mcp.apps.confidentialBadge': 'Vertraulich',
  'settings.mcp.apps.legacyNotice': 'Neue Verbindungen sollten OAuth 2.1-Apps verwenden.',
  'settings.mcp.apps.modal.createTitle': 'OAuth-App erstellen',
  'settings.mcp.apps.modal.done': 'Fertig',
  'settings.mcp.apps.modal.creating': 'Wird erstellt…',
  'settings.mcp.apps.modal.deleteTitle': 'App löschen',
  'settings.mcp.apps.modal.deleteMessage': 'Alle Token und Sitzungen dieser App werden sofort widerrufen.',
  'settings.mcp.sessions.empty': 'Keine aktiven OAuth-Sitzungen.',
  'settings.mcp.sessions.revoke': 'Widerrufen',
  'settings.mcp.sessions.revoked': 'Sitzung widerrufen',
  'settings.mcp.sessions.revokeError': 'Sitzung konnte nicht widerrufen werden',
  'settings.mcp.sessions.scopes': 'Berechtigungen',
  'settings.mcp.sessions.expires': 'Läuft ab',
  'settings.mcp.legacyDeprecated': 'Veraltet',
  'settings.mcp.oauthAppsAdminNote': 'OAuth 2.1-Apps für KI-Clients werden im Adminbereich konfiguriert.',
  'admin.tabs.oauthApps': 'OAuth 2.1-Apps',
  'admin.oauthApps.title': 'OAuth 2.1-Apps',
  'admin.oauthApps.subtitle': 'OAuth-Clients registrieren, damit KI-Tools (Claude.ai, ChatGPT usw.) den MCP-Endpunkt nutzen können.',
  'admin.oauthApps.registered': 'Registrierte Apps',
}
