const fr: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.showPlaceDescription': 'Afficher la description du lieu',
  ...
  'forgotPassword.subtitle': 'Entrez votre adresse e-mail et nous vous enverrons un lien de réinitialisation.',
  ...
  'forgotPassword.successTitle': 'Vérifiez votre boîte de réception',
  'forgotPassword.successMsg': 'Si un compte avec cet e-mail existe, un lien de réinitialisation a été envoyé.',
  ...
  'resetPassword.submitting': 'Définition du mot de passe\u2026',
  'resetPassword.successTitle': 'Mot de passe mis à jour',
  'resetPassword.successMsg': 'Votre mot de passe a été modifié. Vous pouvez maintenant vous connecter.',
  'resetPassword.signIn': 'Aller à la connexion',
  'resetPassword.invalidToken': 'Ce lien de réinitialisation est invalide ou a expiré.',
  'resetPassword.mfaRequired': 'Votre compte a l\'authentification à deux facteurs activée.',
  'resetPassword.mfaCode': 'Code d\'authentification',
  ...
  'admin.mapsKillSwitches': 'Coupures API',
  'admin.mapsAutocompleteDisabled': 'Désactiver la recherche de lieux',
  'admin.mapsAutocompleteDisabledHint': 'Bloquer tous les appels d\'autocomplétion/recherche vers Google et Nominatim',
  'admin.mapsDetailsDisabled': 'Désactiver les détails de lieu',
  'admin.mapsDetailsDisabledHint': 'Bloquer les consultations de détails (notes, avis, horaires d\'ouverture)',
  ...
  // File Types
  'admin.authMethods': 'Méthodes d\'authentification',
  'admin.passwordLogin': 'Connexion par mot de passe',
  'admin.passwordLoginHint': 'Permettre aux utilisateurs de se connecter avec email et mot de passe',
  'admin.oidcLogin': 'Connexion SSO',
  'admin.oidcLoginHint': 'Permettre aux utilisateurs de se connecter via le fournisseur OIDC configuré',
  'admin.oidcRegistration': 'Inscription SSO',
  'admin.oidcRegistrationHint': 'Permettre la création de nouveaux utilisateurs lors du premier login SSO',
  'admin.envOverrideHint': 'La connexion par mot de passe est contrôlée par la variable d\'environnement OIDC_ONLY et ne peut pas être modifiée ici.',
  'admin.defaultLanguage': 'Langue par défaut',
  'admin.defaultLanguageHint': 'Langue affichée aux utilisateurs non connectés. Les visiteurs peuvent toujours la modifier.',
  'admin.defaultLanguageAuto': 'Détection automatique (langue du navigateur)',
  ...
  'admin.collab.chat': 'Messagerie instantanée',
  'admin.collab.chatHint': 'Messagerie de voyage en temps réel pour tous les membres',
  'admin.collab.notes': 'Notes partagées',
  'admin.collab.notesHint': 'Notes collaboratives attachées au voyage',
  'admin.collab.polls': 'Sondages',
  'admin.collab.pollsHint': 'Créer des décisions de groupe et voter',
  'admin.bagTracking.subtitle': 'Activer le poids et l\'attribution de bagages pour les articles',
  'admin.atlas.geoTitle': 'Données des frontières régionales',
  'admin.atlas.geoHint': 'Met à jour le fichier GeoJSON des frontières régionales utilisé sur la carte Atlas',
  'admin.atlas.geoRefresh': 'Mettre à jour maintenant',
  'admin.atlas.geoRefreshing': 'Mise à jour…',
  'admin.atlas.geoRefreshed': 'Données des frontières régionales mises à jour',
  'admin.atlas.geoRefreshError': 'Échec de la mise à jour des données des frontières régionales',
  ...
  'admin.addons.integrationHint': 'Services backend et intégrations d\'API',
  ...
  'vacay.inviteCalendarName': 'Calendrier :',
  'vacay.calendars': 'Calendriers',
  'vacay.myCalendar': 'Mon Calendrier',
  'vacay.newCalendar': 'Nouveau Calendrier',
  'vacay.calendarName': 'Nom du calendrier',
  'vacay.calendarNamePlaceholder': 'ex. Équipe de Travail, Famille',
  'vacay.createCalendar': 'Créer',
  'vacay.leaveCalendar': 'Quitter le Calendrier',
  'vacay.deleteCalendar': 'Supprimer le Calendrier',
  'vacay.leaveCalendarHint': 'Vous retirer de ce calendrier partagé. Vos entrées personnelles ne sont pas affectées.',
  'vacay.deleteCalendarHint': 'Supprimer définitivement ce calendrier et retirer tous les membres.',
  'vacay.leaveAction': 'Quitter',
  'vacay.deleteAction': 'Supprimer',
  'vacay.shareDetailsDefault': 'Partager les détails dans les calendriers partagés',
  'vacay.shareDetailsDefaultHint': "S'applique aux nouvelles entrées. Les entrées existantes ne sont pas modifiées.",
  'vacay.busyOnly': 'Occupé',
  'vacay.eventName': "Nom de l'événement",
  'vacay.location': 'Lieu',
  'vacay.note': 'Note',
  'vacay.optional': 'Optionnel',
  'vacay.shareDetails': 'Partager les détails',
  'vacay.shareDetailsHint': 'Le nom, lieu et note sont visibles par les autres membres du calendrier',
  'vacay.removeEntry': 'Supprimer',
  'vacay.markThrough': "Marquer jusqu'au",
  'vacay.daysSelected': '{n} jours',
  'vacay.mixedValues': 'Valeurs multiples…',
  ...
  'dayplan.toast.routeOptimizedWithConflict': 'Itinéraire optimisé – certains lieux ont été déplacés pour respecter les contraintes de temps.',
  'dayplan.toast.routeExceedsDayEnd': 'Attention : l\'itinéraire optimisé dépasse votre heure de fin de journée configurée.',
  ...
  'dayplan.duplicateDay': 'Dupliquer le jour',
  'dayplan.pdfError': 'Échec de l\'export PDF',
  'dayplan.transportWalking': 'Pied',
  'dayplan.transportCycling': 'Vélo',
  'dayplan.transportDriving': 'Voiture',
  ...
  'places.formPhone': 'Téléphone',
  'places.formPrice': 'Prix',
  'places.formPriceVisit': 'Prix (cette visite)',
  'places.whoIsGoing': 'Qui vient ?',
  'places.everyoneGoing': 'Tout le monde y va — appuyez pour exclure quelqu’un',
  'places.formDuration': 'Durée de visite (min)',
  'places.formTransportMode': 'Se rendre par',
  'places.transportWalking': 'À pied',
  'places.transportCycling': 'Vélo',
  'places.transportDriving': 'Voiture',
  ...
  'photos.dropHere': 'Déposez les photos ici',
  'photos.dropHereActive': 'Déposez les photos ici...',
  'photos.dropHint': 'JPG, PNG, WebP · max. 10 Mo · jusqu\'à 30 photos',
  ...
  'planner.addPrice': 'Add price',
  'planner.addVisitPrice': 'Set a price for this visit — creates a draft budget entry',
  'planner.budgetDraftTooltip': 'Draft expense — click to reconcile',
  'planner.budgetConfirmedTooltip': 'Confirmed expense — click to edit',
  ...
  'day.startTime': 'Début de la journée',
  'day.endTime': 'Fin de la journée',
  ...
  'memories.linkDateRange': 'Lier une plage de dates',
  'memories.preview': 'Aperçu',
  'memories.enableAutoSync': 'Activer la synchronisation automatique',
  'memories.disableAutoSync': 'Désactiver la synchronisation automatique',
  'memories.addDateSync': 'Ajouter une synchronisation par date',
  'memories.dateSyncLabel': 'Synchronisation par date',
  'memories.lastSynced': 'Dernière synchronisation',
  ...
  'notif.todo_due.title': 'Tâche due aujourd\'hui',
  'notif.todo_due.text': '{name} est dû aujourd\'hui dans {trip}.',
  ...
  'dashboard.settlementCurrency': 'Devise de règlement',
  'dashboard.settlementCurrencyHint': "Toutes les dépenses en devises multiples seront converties dans cette devise pour le règlement. Ne peut pas être modifiée une fois que des dépenses en devises étrangères existent.",
  'places.importCsv': 'CSV',
  'places.csvImported': '{count} lieux importés depuis CSV',
  'places.csvError': "Échec de l'importation CSV",
  'budget.table.members': 'Membres',
  'budget.addExpense': 'Ajouter une dépense',
  'budget.editExpense': 'Modifier la dépense',
  'budget.modal.owes': 'Doit',
  'budget.modal.paid': 'Payé',
  'budget.modal.tip': 'Pourboire',
  'budget.modal.equalSplit': 'Partage égal',
  'budget.modal.remaining': 'restant',
  'budget.modal.balanced': 'Équilibré',
  'budget.modal.notReconciled': 'Pas encore réconcilié',
  'budget.modal.originalAmount': 'Montant original',
  'budget.modal.referenceAmount': 'Montant de réf.',
  'budget.modal.exchangeRate': 'Taux de change',
  'budget.modal.fetchRate': 'Récupérer le taux',
  'budget.modal.currency': 'Devise',
  'budget.modal.receipts': 'Reçus',
  'budget.modal.uploadReceipt': 'Joindre',
  'budget.modal.noReceipts': 'Aucun reçu joint',
  'budget.charged': 'Facturé',
  'budget.balance': 'Solde',
  'planner.mayBeClosed': 'Peut être fermé à cette heure',
  ...
  'undo.importCsv': 'Importation CSV',
  'budget.settle': 'Solder le budget',
  'budget.settledBadge': 'Soldé le {date} par {name}',
  'budget.settledBanner': 'Ce budget a été soldé. Les dépenses sont en lecture seule.',
  'budget.settlement.previewTitle': 'Solder le budget',
  'budget.settlement.previewSubtitle': 'Vérifiez qui doit payer quoi, puis notifiez tout le monde.',
  'budget.settlement.flows': 'Paiements requis',
  'budget.settlement.noFlows': 'Tout est équilibré — aucun paiement nécessaire.',
  'budget.settlement.unresolvedDrafts': 'Brouillons non résolus',
  'budget.settlement.unresolvedDraftsHint': 'Résolvez ces dépenses planifiées avant de solder.',
  'budget.settlement.convertDraft': 'Convertir',
  'budget.settlement.discardDraft': 'Rejeter',
  'budget.settlement.settleBtn': 'Solder & notifier',
  'budget.settlement.confirmText': 'Cette action est définitive. Les dépenses deviendront en lecture seule.',
  'budget.settlement.confirmBtn': 'Confirmer',
  'budget.settlement.alreadySettled': 'Ce budget a déjà été soldé.',
  'budget.settlement.hasDrafts': 'Résolvez tous les brouillons avant de solder.',
  'notif.budget_settlement.title': 'Budget soldé',
  'notif.budget_settlement.text': '{actor} a soldé le budget pour {trip}',
  'notif.action.ive_paid': "J'ai payé",
  'notif.action.dismiss': 'Ignorer',
  'notif.action.view_budget': 'Voir le budget',
  'settings.notifyBudgetSettlement': 'Règlements de budget',
  'tripBadge.budgetUnsettled': 'Budget non soldé',
  'tripBadge.budgetUnsettled.detail': 'Ce voyage est terminé avec des dépenses non soldées.',
  'tripBadge.budgetUnsettled.action': 'Revoir le budget',
  'tripBadge.calendarConflict': 'Conflit de calendrier',
  'tripBadge.calendarConflict.detail': 'Votre calendrier a des événements qui chevauchent ces dates.',
  'tripBadge.calendarConflict.action': 'Voir le calendrier',
  'tripBadge.missingDates': 'Dates manquantes',
  'tripBadge.missingDates.detail': 'Ajoutez des dates pour détecter les conflits et activer les rappels.',
  'tripBadge.missingDates.action': 'Modifier le voyage',
  'tripBadge.upcomingSoon': 'Dans {days} jours',
  'tripBadge.upcomingSoon.detail': "Votre itinéraire est vide — c'est le moment de planifier !",
  'tripBadge.upcomingSoon.action': 'Ouvrir le planificateur',
  'tripBadge.emptyItinerary': "Pas encore d'itinéraire",
  'tripBadge.emptyItinerary.detail': "Aucune activité n'est planifiée.",
  'tripBadge.emptyItinerary.action': 'Ouvrir le planificateur',
  'tripBadge.more': '+{count} autres',
  'trip.loading.budget': 'Chargement du budget...',
  'trip.loading.reservations': 'Chargement des réservations...',
  'trip.loading.packing': 'Chargement de la liste de bagages...',
  'trip.loading.files': 'Chargement des fichiers...',
  'trip.loading.collab': 'Chargement des messages...',
  'trip.loading.memories': 'Chargement des souvenirs...',
  'trip.myPreferences': 'Mes préférences',
  'trip.addToCalendar': 'Ajouter à mon calendrier',
  'trip.addToCalendarHint': 'Bloquer ces dates dans votre calendrier de vacances personnel.',
  'trip.calendarSyncing': 'Synchronisation...',
  'settings.notifyTodoDue': 'Tâche due aujourd\'hui',
  'collab.notes.expand': 'Développer',
  'dayplan.dayDetail': 'Détails du jour',
  'dayplan.toast.routeError': 'Impossible de calculer l\'itinéraire',
  'trip.toast.loadError': 'Impossible de charger le voyage',
  'trip.toast.tripUpdated': 'Voyage mis à jour',
  'admin.mapsAutocompleteNominatimOnly': 'Utiliser Nominatim pour la saisie automatique',
  'admin.mapsAutocompleteNominatimOnlyHint': 'Rediriger la saisie automatique vers OpenStreetMap même si une clé Google est configurée, pour réduire les coûts API',
  'settings.mcp.tabs.apps': 'Apps OAuth 2.1',
  'settings.mcp.tabs.legacyTokens': 'Tokens hérités',
  'settings.mcp.tabs.sessions': 'Sessions actives',
  'settings.mcp.apps.empty': 'Aucune app OAuth pour l\'instant. Créez-en une pour connecter des clients IA de manière sécurisée.',
  'settings.mcp.apps.create': 'Créer une app',
  'settings.mcp.apps.name': 'Nom de l\'app',
  'settings.mcp.apps.namePlaceholder': 'ex. Claude.ai, Mon automatisation',
  'settings.mcp.apps.redirectUris': 'URIs de redirection',
  'settings.mcp.apps.redirectUrisHint': 'Un par ligne. Doit utiliser https://, http://localhost ou un schéma personnalisé.',
  'settings.mcp.apps.isPublic': 'Client public (sans secret, PKCE uniquement)',
  'settings.mcp.apps.scopes': 'Permissions autorisées',
  'settings.mcp.apps.preset': 'Préréglage :',
  'settings.mcp.apps.preset.claude': 'Claude.ai',
  'settings.mcp.apps.preset.claudeDesktop': 'Claude Desktop',
  'settings.mcp.apps.preset.chatgpt': 'ChatGPT',
  'settings.mcp.apps.preset.readOnly': 'Lecture seule',
  'settings.mcp.apps.created': 'App créée',
  'settings.mcp.apps.createError': 'Échec de la création de l\'app',
  'settings.mcp.apps.deleted': 'App supprimée',
  'settings.mcp.apps.deleteError': 'Échec de la suppression de l\'app',
  'settings.mcp.apps.secretOnce': 'Secret client (affiché une seule fois)',
  'settings.mcp.apps.secretWarning': 'Sauvegardez ce secret maintenant — il ne pourra pas être récupéré.',
  'settings.mcp.apps.rotated': 'Secret renouvelé',
  'settings.mcp.apps.rotateError': 'Échec du renouvellement du secret',
  'settings.mcp.apps.rotate': 'Renouveler le secret',
  'settings.mcp.apps.delete': 'Supprimer',
  'settings.mcp.apps.publicBadge': 'Public',
  'settings.mcp.apps.confidentialBadge': 'Confidentiel',
  'settings.mcp.apps.legacyNotice': 'Les nouvelles connexions doivent utiliser les Apps OAuth 2.1 ci-dessus.',
  'settings.mcp.apps.modal.createTitle': 'Créer une app OAuth',
  'settings.mcp.apps.modal.done': 'Terminé',
  'settings.mcp.apps.modal.creating': 'Création…',
  'settings.mcp.apps.modal.deleteTitle': 'Supprimer l\'app',
  'settings.mcp.apps.modal.deleteMessage': 'Tous les tokens et sessions de cette app seront révoqués immédiatement.',
  'settings.mcp.sessions.empty': 'Aucune session OAuth active.',
  'settings.mcp.sessions.revoke': 'Révoquer',
  'settings.mcp.sessions.revoked': 'Session révoquée',
  'settings.mcp.sessions.revokeError': 'Échec de la révocation de la session',
  'settings.mcp.sessions.scopes': 'Permissions',
  'settings.mcp.sessions.expires': 'Expire',
  'settings.mcp.legacyDeprecated': 'Déprécié',
  'settings.mcp.oauthAppsAdminNote': 'Les apps OAuth 2.1 pour clients IA sont configurées dans le panneau d\'administration.',
  'admin.tabs.oauthApps': 'Apps OAuth 2.1',
  'admin.oauthApps.title': 'Apps OAuth 2.1',
  'admin.oauthApps.subtitle': 'Enregistrez des clients OAuth pour que les outils IA (Claude.ai, ChatGPT, etc.) puissent se connecter au point d\'accès MCP.',
  'admin.oauthApps.registered': 'Apps enregistrées',
}
